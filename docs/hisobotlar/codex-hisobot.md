...
`npm.cmd test`: 246/246 yashil. `npm.cmd run check:chemistry`: 238 reaksiya, 12 birikma, 0 xato. O'zgargan fayllar ESLint: 0 xato, avvaldan mavjud 2 ta `<img>` ogohlantirishi. Mahalliy sandbox buildi Google Fontsga tarmoq ruxsati yo'qligi sabab to'xtadi; tarmoq bilan qayta tekshirish va deploy holati quyida yakuniy natija sifatida qayd etiladi.
