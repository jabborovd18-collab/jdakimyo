...
export function doimiyKlaviatura() {
  return {
    // JOYLASHUV `bot/keyboards/reply.py` DAGI BILAN BIR XIL BO'LISHI
    // SHART. Ikkala servis ham o'z klaviaturasini yuboradi va Telegram
    // bir chatda oxirgisini tutadi — tartib farq qilsa tugmalar
    // javobdan javobga sakrab turadi.
    //
    // Yuqorida YASASH amallari, pastda HISOB amallari. Ilgari tartib
    // 2-1-2-1 edi: ikkita juft va ikkita yolg'iz tugma, guruhlari
    // aralash.
    keyboard: [
