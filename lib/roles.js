...
const HUQUQLAR = {
  superadmin: {
    ...
    bot: true, aiKorish: true, aiSinash: true, aiSozlash: true, aiFavqulodda: true,
  },
  admin: {
    kontent: true, moderatsiya: true, gamifikatsiya: true,
    foydalanuvchilar: true, sertifikatlar: true, pul: true,
    // Kanal ochish va qaydnoma — faqat superadminda
    // Telegram bot butun sayt uchun bitta: uning sozlamasi, ulangan
    // foydalanuvchilari va guruhlari — faqat superadminda
    kanallar: false, qaydnoma: false, sozlamalar: true, statistika: true,
    bot: false, aiKorish: true, aiSinash: true, aiSozlash: false, aiFavqulodda: false,
  },
  moderator: {
    ...
    bot: false, aiKorish: false, aiSinash: false, aiSozlash: false, aiFavqulodda: false,
  },
}
