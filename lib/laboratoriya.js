...
export class LabXatosi extends Error {
  /**
   * @param {string} message — foydalanuvchi ko'radigan matn
   * @param {string|null} kod — mashina o'qiydigan tur ('sovuq' — idish
   *        hali qizimagan). Client xatoning MATNIGA qarab qaror qilmasin
   *        deb qo'shildi: matn o'zgarsa mantiq buzilmaydi.
   */
  constructor(message, kod = null) {
    super(message)
    this.name = 'LabXatosi'
    this.kod = kod
  }
