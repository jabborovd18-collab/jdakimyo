// Moddalar YAGONA jadvali — rang, agregat holat va shaffoflik.
//
// Nega `lib/` da, 3D papkasida emas: bu jadvalni uch tomon o'qiydi —
// 3D laboratoriya (rang va shakl), server (`lib/lab-birlik.js` orqali
// moddaning o'lchov birligi) va `scripts/gen-lab-reagentlar.js` (katalogni
// yasashda). Uchtasi uchun uchta nusxa bo'lsa, ular vaqt o'tishi bilan
// bir-biridan uzilib qoladi — `lib/lab-tenglama.js` aynan shu sababdan
// shu yerda turibdi.
//
...
export function jadvaldanOl(kalit) {
  ...
  return {
    ...
    // Rangning NOMI ham qaytadi: son (`0xf5b301`) sahnaga yaraydi,
    // lekin matnda ishlatib bo'lmaydi. Ochiq lug'at generatori
    // (`scripts/gen-ochiq-lugat.js`) aynan shu nomni oladi.
    rangNomi: palitraKaliti,
