...
class OvozPleyeri {
  ...
  _keyingiGapniOyna() {
    ...
    if (this.faolIndeks >= this.navbat.length) {
      this.ijroEtilmoqda = false;
      if (this._pingInterval) clearInterval(this._pingInterval);
      if (this._muvaffaqiyatliGaplar === 0 && this._xatolarSoni > 0) {
        if (typeof this.tinglovchilar.xato === "function") {
          this.tinglovchilar.xato("Brauzer ovoz xizmatini ishga tushira olmadi.");
        }
      } else if (typeof this.tinglovchilar.tugadi === "function") {
