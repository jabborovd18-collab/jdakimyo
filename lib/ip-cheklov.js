...
const QOIDALAR = {
  ...
  // Botdan olingan ulanish kodini kiritish. Kod olti belgi va ikki
  // daqiqa yashaydi — taxmin qilish deyarli imkonsiz, LEKIN himoya
  // shu yerda bo'lishi kerak: kodning o'zida urinishlarni sanab
  // bo'lmaydi, chunki noto'g'ri kod bo'yicha hech qanday yozuv
  // topilmaydi va sanaydigan joy yo'q.
  tgkod: [
    { nom: 'chorak', oyna: 15 * 60, chegara: 20 },
  ],
}
