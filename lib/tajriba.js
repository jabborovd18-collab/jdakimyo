...
import { eritmaErituvchisi, erituvchiBahosi } from './lab-erituvchi'
import { idishmi, idishSigimi, idishXavfi } from './lab-idish'
 ...
 */
export async function tajribaniOtkaz(userId, kalitlar, reactionId = null, miqdorlar = null, idish = null) {
  ...
  const nomzodlar = toplamBoyicha.get(toplamKaliti([...xarita.keys()])) || []
