...
function yonalishChegaralari(yonalish) {
  const { urinishChegarasi, urinishVaqtiMs, umumiyVaqtMs, tokenChegarasi } = AI_YONALISH_SOZLAMALARI[yonalish];
  return Object.freeze({ urinishChegarasi, urinishVaqtiMs, umumiyVaqtMs, tokenChegarasi });
}
...
export const AI_DEFAULT_CONFIG = Object.freeze({
  ...
  routing: Object.freeze({
    tezkor: Object.freeze(["groqTezkor", "geminiAsosiy", "openrouterMatn"]),
    oddiy: Object.freeze(["groqAsosiy", "geminiAsosiy"]),
    murakkab: Object.freeze(["deepseekMurakkab", "groqAsosiy"]),
    rasm: Object.freeze(["geminiAsosiy", "geminiZaxira", "openrouterRasm"]),
  }),
  directions: Object.freeze({
    tezkor: yonalishChegaralari("tezkor"),
    oddiy: yonalishChegaralari("oddiy"),
    murakkab: yonalishChegaralari("murakkab"),
  }),
