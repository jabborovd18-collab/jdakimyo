...
3. Ko'p Komponentli Qotishmalar va Murakkab Aralashmalar:
   - Tenglamalar sistemasi (2 yoki 3 noma'lumli) orqali x, y va zarur bo'lsa z mollarini aniq yechish.
   - Qotishmalarning kislotalar bilan reaksiyaga kirishish ketma-ketligi (metallar kuchlanish qatori bo'yicha).
4. Deterministik apparatni qo'llash:
   - 2 yoki 3 noma'lumli sistemada koeffitsiyentlar matritsasi hamda Kramer determinantlari D, Dx, Dy, Dz ni ko'rsating; D = 0 bo'lsa yagona yechim yo'qligini alohida tahlil qiling.
   - Elektrolizda m = M × I × t / (n × F), F = 96485 C/mol formuladan foydalaning; vaqtni sekundga o'tkazing va n elektronlar sonini yarim-reaksiyadan oling.
   - Eritmalarda 25 C uchun pH = -log10[H+], pOH = -log10[OH-], pH + pOH = 14 ni qo'llang.
   - Cho'kma muvozanatida Ks = Pi[ion]^koeffitsiyent yozing; umumiy konsentratsiya o'rniga erkin ion konsentratsiyalarini qo'ying.
