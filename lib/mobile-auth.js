...
// bir xil NEXTAUTH_SECRET bilan. Ya'ni yangi kutubxona ham, ikkinchi maxfiy
// kalit ham kerak emas.
...
function getSecret() {
  ...
  if (!secret) {
    throw new Error('NEXTAUTH_SECRET sozlanmagan — mobil token yaratib bo\'lmaydi')
  }
  return secret
}
