...
// ═══════════════════════════════════════════════════════════════════════════════
// [CrCl₂(H₂O)₄]Cl·2H₂O — TERMIK TAHLIL MAHSUS SAHIFASI (PREMIUM)
// Manbalar: Vogel's Quantitative Chemical Analysis, Wendlandt (Thermal Analysis)
// Xususiyat: Gidrat izomeriya (to'q yashil), 2 ta ichki Cl⁻ + 4 ta ichki H₂O + 1 ta tashqi Cl⁻ + 2 ta tashqi H₂O
// O'ziga xoslik: Werner nazariyasi — faqat 1 ta tashqi Cl⁻ (AgNO₃ bilan cho'kadi)
...
const COMPOUND = {
  formulaHTML: "[CrCl<sub>2</sub>(H<sub>2</sub>O)<sub>4</sub>]Cl·2H<sub>2</sub>O",
  formulaPlain: "[CrCl2(H2O)4]Cl·2H2O",
  iupac: "Tetrakvaadixloroxrom(III) xlorid digidrat",
  formulaExpanded: "CrH₁₂O₆Cl₃",
  commonName: "To'q yashil xrom xlorid (gidrat izomer)",
  molarMass: 266.45,
  casNumber: "10025-73-7",
  color: "to'q yashil",
  stability: "havoda barqaror, Cr³⁺ inert (d³), 100°C da tashqi H₂O ajraladi",
  crystalStructure: "Oktaedr — Cr³⁺ markazida 2 ta Cl⁻ + 4 ta H₂O ligand (ichki sfera), 1 ta Cl⁻ + 2 ta H₂O tashqi sferada",
  ...
  historicalFact: {
    ...
    text: "[CrCl₂(H₂O)₄]Cl·2H₂O — to'q yashil tuzi, CrCl₃·6H₂O ning uchta gidrat izomeridan uchinchisi. Alfred Werner (1893) bu uchta izomerni o'rganib, koordinatsion nazariyasini isbotladi.",
  ...
  thermalFeature: {
    title: "[CrCl₂(H₂O)₄]Cl·2H₂O — ichki/tashqi sfera farqi",
    description: "Bu kompleks Cr³⁺ (d³, yuqori spin) va 2 ta Cl⁻ + 4 ta H₂O (ichki sfera) + 1 ta Cl⁻ + 2 ta H₂O (tashqi sfera) dan iborat. Tashqi H₂O past T da, ichki H₂O va ichki Cl⁻ yuqori T da ajraladi.",
    reaction: {
      step1: "[CrCl₂(H₂O)₄]Cl·2H₂O → [CrCl₂(H₂O)₄]⁺ + Cl⁻ + 2H₂O↑ (100-150°C, tashqi)",
      step2: "[CrCl₂(H₂O)₄]⁺ → Cr³⁺ + 2Cl⁻ + 4H₂O↑ (200-250°C, ichki)",
    ...
    problem: {
      ...
      impact: "TGA da 2 ta bosqich kuzatiladi: past T da tashqi H₂O (13.5%), yuqori T da ichki H₂O + ichki Cl⁻ (29.5%)."
    },
    solution: {
  ...
  thermochromism: {
    ...
    description: "[CrCl₂(H₂O)₄]Cl·2H₂O termoxromik xususiyatlarga ega — harorat ko'tarilishi bilan rang va holat o'zgaradi.",
    colorChanges: [
      { temp: "25°C", color: "to'q yashil", geometry: "Oktaedr (Cr³⁺ d³, yuqori spin)", explanation: "To'q yashil rang — 2 ta ichki Cl⁻ + 4 ta ichki H₂O" },
      { temp: "100-150°C", color: "yashil", geometry: "[CrCl₂(H₂O)₄]⁺ (tashqi H₂O ajralgan)", explanation: "2 ta tashqi H₂O ajraladi" },
      { temp: "200-250°C", color: "jigar", geometry: "Cr³⁺ + 2Cl⁻ (ichki H₂O ajralgan)", explanation: "Ichki H₂O ajraladi" },
  ...
  theoretical: {
    ...
    H_inner: { mass: 8.064,  percent: 3.03,  source: "4×H₂O (8×H, ichki sfera)", thermalSignal: "H₂O yuqori T da ajraladi" },
    H_outer: { mass: 4.032,  percent: 1.51,  source: "2×H₂O (tashqi sfera)", thermalSignal: "H₂O past T da ajraladi (13.5%)" },
    O_inner: { mass: 63.996, percent: 24.02, source: "4×H₂O (4×O, ichki sfera)", thermalSignal: "H₂O yuqori T da ajraladi" },
    O_outer: { mass: 31.998, percent: 12.01, source: "2×H₂O (tashqi sfera)", thermalSignal: "H₂O past T da ajraladi" },
    Cl_inner: { mass: 70.900, percent: 26.61, source: "2×Cl⁻ (ichki sfera, Cr³⁺ ga bog'langan)", thermalSignal: "Cl⁻ yuqori T da ajraladi" },
    Cl_outer: { mass: 35.450, percent: 13.31, source: "1×Cl⁻ (tashqi sfera, ion)", thermalSignal: "Cl⁻ past T da ajraladi" }
  },

  tgaData: [
    { temp: 25, mass: 100.0, event: "Boshlang'ich — [CrCl₂(H₂O)₄]Cl·2H₂O barqaror (to'q yashil)", theoryNote: "Oktaedr struktura, Cr³⁺ d³ yuqori spin, 2 ta ichki Cl⁻ + 4 ta ichki H₂O + 1 ta tashqi Cl⁻ + 2 ta tashqi H₂O" },
    { temp: 50, mass: 100.0, event: "Boshlang'ich — barqaror", theoryNote: "Termik barqarorlik" },
    { temp: 100, mass: 86.5, event: "1-bosqich: 2 ta tashqi H₂O yo'qolishi (13.5%)", theoryNote: "Tashqi H₂O ajraladi, [CrCl₂(H₂O)₄]Cl qoladi" },
    { temp: 150, mass: 86.5, event: "[CrCl₂(H₂O)₄]Cl barqaror", theoryNote: "[CrCl₂(H₂O)₄]Cl barqaror" },
    { temp: 200, mass: 70.5, event: "2-bosqich: 4 ta ichki H₂O yo'qolishi (16.0%)", theoryNote: "Ichki H₂O ajraladi, CrCl₃ qoladi" },
    { temp: 250, mass: 57.0, event: "3-bosqich: ichki Cl⁻ yo'qolishi (13.5%)", theoryNote: "Ichki Cl⁻ ajraladi, CrCl₃ qoladi" },
    { temp: 300, mass: 57.0, event: "CrCl₃ barqaror", theoryNote: "CrCl₃ barqaror" },
    { temp: 400, mass: 57.0, event: "CrCl₃ barqaror", theoryNote: "CrCl₃ barqaror" },
    { temp: 500, mass: 50.0, event: "Cl₂ yo'qolishi boshlanadi (7.0%)", theoryNote: "CrCl₃ parchalanadi, Cl₂ ajraladi" },
    { temp: 600, mass: 50.0, event: "CrCl₃ (yoki Cr₂O₃) barqaror", theoryNote: "CrCl₃ yoki Cr₂O₃ barqaror" },
    { temp: 700, mass: 50.0, event: "CrCl₃ (yoki Cr₂O₃) barqaror", theoryNote: "CrCl₃ yoki Cr₂O₃ barqaror" },
    { temp: 800, mass: 50.0, event: "CrCl₃ (yoki Cr₂O₃) barqaror", theoryNote: "CrCl₃ yoki Cr₂O₃ barqaror" }
  ],

  dtaData: [
    { temp: 25, signal: 0, event: "Boshlang'ich", theoryNote: "Termik muvozanat" },
    { temp: 100, signal: -20, event: "Endotermik (2 ta tashqi H₂O)", theoryNote: "2 ta tashqi H₂O ajraladi (ΔH ≈ +100 kJ/mol)" },
    { temp: 125, signal: -25, event: "Pik (100-150°C)", theoryNote: "Maksimal parchalanish tezligi" },
    { temp: 150, signal: -15, event: "Endotermik tugashi", theoryNote: "Tashqi H₂O to'liq ajraldi" },
    { temp: 200, signal: -30, event: "Endotermik (4 ta ichki H₂O)", theoryNote: "Ichki H₂O ajraladi" },
    { temp: 250, signal: -25, event: "Endotermik (ichki Cl⁻)", theoryNote: "Ichki Cl⁻ ajraladi" },
  ...
  decompositionSteps: [
    {
      temp: "100-150°C",
      event: "1-bosqich: 2 ta tashqi H₂O yo'qolishi",
      massLoss: "13.5%",
      product: "[CrCl₂(H₂O)₄]Cl",
      type: "Endotermik",
      explanation: "Tashqi sferadagi 2 ta H₂O ajraladi. Bu H₂O Cr³⁺ ga bog'lanmagan, shuning uchun past haroratda ajraladi. Bu Verner nazariyasining termik isboti.",
      enthalpy: "ΔH ≈ +100 kJ/mol",
      colorChange: "to'q yashil → yashil",
      gasReleased: "H₂O (suv bug'i)"
    },
    {
      temp: "200-250°C",
      event: "2-bosqich: 4 ta ichki H₂O yo'qolishi",
      massLoss: "16.0%",
      product: "CrCl₃",
      type: "Endotermik",
      explanation: "Ichki sferadagi 4 ta H₂O ajraladi. Bu H₂O ligandlari Cr³⁺ ga bog'langan, shuning uchun yuqori harorat talab qilinadi.",
      enthalpy: "ΔH ≈ +160 kJ/mol",
    ...
    },
    {
      ...
      enthalpy: "ΔH ≈ +140 kJ/mol (parchalanish), ΔH ≈ -90 kJ/mol (Cr₂O₃)",
  ...
  experimentalRuns: [
    { 
      ...
      massLoss3: "7.0%", 
      residue: "CrCl₃ (57.0%)", 
      note: "Toza [CrCl₂(H₂O)₄]Cl·2H₂O — inert atmosfera",
      theoryNote: "Tashqi H₂O 100-150°C da ajraladi (13.5%), ichki H₂O + ichki Cl⁻ 200-300°C da ajraladi. CrCl₃ qoldiq qoladi."
    },
    { 
      id: "TGA-24-002", 
      date: "2026-06-15", 
  ...
  samplePrepSteps: [
    { step: 1, title: "⚠ Xavfsizlik choralari", desc: "[CrCl₂(H₂O)₄]Cl·2H₂O zaharli emas, lekin Cr³⁺ zaharli. Qo'lqop, himoya ko'zoynaklari va laboratoriya xalati majburiy. Ventilyatsiya zarur!", time: "doimiy", critical: true },
    { step: 2, title: "Namuna tayyorlash", desc: "10-20 mg [CrCl₂(H₂O)₄]Cl·2H₂O Al₂O₃ yoki Pt tigelga solinadi. Namuna mayda kukun bo'lishi kerak. To'q yashil rang — Cr³⁺ belgisi.", time: "5 daq", critical: true },
    ...
    { step: 6, title: "Natijalarni tahlil qilish", desc: "Har bir bosqichda massa yo'qotish foizi hisoblanadi. Tashqi H₂O (13.5%) va ichki H₂O + Cl⁻ (29.5%) ajralishi aniqlanadi.", time: "10 daq", critical: false }
  ],
  ...
  decompositionTable: [
    {
      ...
      step2_product: "4 ta ichki H₂O + 2 ta ichki Cl⁻",
...
export default function CrCl2H2O4Cl2H2OThermalPage() {
    ...
    <main className="min-h-screen bg-gradient-to-b from-purple-950 via-emerald-950/20 to-blue-950 text-white">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4">
          <div className="bg-gradient-to-br from-emerald-950 to-purple-950 border-2 border-emerald-500 rounded-2xl p-6 max-w-2xl w-full animate-pulse">
            <h3 className="text-xl font-bold text-emerald-400 mb-4 flex items-center gap-2">
              <span className="text-3xl">⚠️</span> GIDRAT IZOMERIYA — 2 TA ICHKI Cl⁻ + 4 TA ICHKI H₂O!
            </h3>
            <p className="text-purple-200 text-sm mb-4">
              <strong className="text-emerald-300">[CrCl₂(H₂O)₄]Cl·2H₂O</strong> — to'q yashil tuzi, gidrat izomeriyaning klassik namunasi. 2 ta ichki Cl⁻ + 4 ta ichki H₂O!
            </p>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <div className="text-purple-200">
                    <strong>2 ta Cl⁻ + 4 ta H₂O</strong> — Cr³⁺ ga bog'langan, yuqori T da ajraladi.
                  </div>
                  <div className="text-purple-200 mt-2">
                    <strong>To'q yashil rang</strong> — 2 ta ichki Cl⁻ tufayli.
                  </div>
                </div>
                <div>
                  <div className="text-emerald-400 font-bold mb-2">✅ Tashqi sfera:</div>
                  <div className="text-purple-200">
                    <strong>1 ta Cl⁻ + 2 ta H₂O</strong> — ion, past T da ajraladi.
                  </div>
                  <div className="text-purple-200 mt-2">
                    <strong>AgNO₃</strong> qo'shilganda faqat 1 ta Cl⁻ cho'kadi.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-emerald-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-emerald-300">Gidrat izomeriya (1893):</strong> CrCl₃·6H₂O ning uchta izomeri: (1) binafsha — barcha 6 ta H₂O ichki; (2) och yashil — 1 ta ichki Cl⁻, 1 ta tashqi H₂O; (3) to'q yashil — 2 ta ichki Cl⁻, 2 ta tashqi H₂O.
              </p>
            </div>
        ...
        <header className="border-b border-purple-800/50 sticky top-0 z-40 bg-purple-950/95 backdrop-blur-md">
          <div className="max-w-6xl mx-auto px-4 py-4">
            <nav className="flex items-center gap-2 text-xs mb-2 text-purple-400 flex-wrap">
              ...
              <span className="text-purple-600">›</span>
              <span className="text-emerald-400 font-semibold">[CrCl₂(H₂O)₄]Cl·2H₂O</span>
            </nav>
      ...
      <section className="max-w-6xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-purple-200">
            <div className="space-y-3">
              <p className="leading-relaxed">
                <strong className="text-white">[CrCl₂(H₂O)₄]Cl·2H₂O</strong> — to'q yashil tuzi, gidrat izomeriyaning klassik namunasi. Termik tahlilda <strong className="text-emerald-300">ichki/tashqi sfera farqi</strong> kuzatiladi.
              </p>
              <ul className="list-disc list-inside space-y-2 marker:text-emerald-500 text-xs md:text-sm">
                ...
                <li><strong className="text-white">2 ta Cl⁻ + 4 ta H₂O</strong> ichki sferada</li>
                <li><strong className="text-emerald-300">1 ta Cl⁻ + 2 ta H₂O</strong> tashqi sferada</li>
                <li><strong className="text-emerald-300">Tashqi H₂O</strong> — past T da ajraladi (100-150°C)</li>
                <li><strong className="text-emerald-300">Ichki H₂O + ichki Cl⁻</strong> — yuqori T da ajraladi (200-300°C)</li>
                <li><strong className="text-emerald-300">CrCl₃</strong> qoldiq qoladi (57.0%)</li>
              </ul>
            </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-4">
            [CrCl₂(H₂O)₄]Cl·2H₂O uchun nazariy tarkib. Cr³⁺ markaziy atom, 2 ta ichki Cl⁻ + 4 ta ichki H₂O, 1 ta tashqi Cl⁻ + 2 ta tashqi H₂O.
          </p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-purple-200">
                {Object.entries(COMPOUND.theoretical).map(([el, d]) => {
                  const elColor = el === "Cr" ? "text-emerald-400" : el.includes("inner") ? "text-yellow-400" : el.includes("outer") ? "text-orange-400" : "text-purple-400"
                ...
                <tr className="bg-emerald-900/20 font-bold border-t border-emerald-500/30">
                  ...
                  <td colSpan={2} className="py-3 text-[10px] text-emerald-300">TGA: tashqi H₂O (13.5%) + ichki H₂O + Cl⁻ (29.5%) + CrCl₃ (57.0%)</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-sm text-purple-200 mb-5 leading-relaxed">
            [CrCl₂(H₂O)₄]Cl·2H₂O uchun standart termik tahlil sharoitlari. Ichki/tashqi sfera farqini aniq ajratish uchun sekin qizdirish kerak.
          </p>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-8">
          ...
          <p className="text-purple-200 mb-4 leading-relaxed">
            ...
            <strong className="text-emerald-400"> Endotermik</strong> piklar tashqi H₂O, ichki H₂O va Cl₂ ajralishini ko'rsatadi.
          </p>
          ...
          <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-4 mb-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-xs">
              <div className="bg-red-900/20 rounded-lg p-3">
                ...
                <div className="text-purple-200">2 ta tashqi H₂O ajraladi (ΔH ≈ +100 kJ/mol).</div>
              </div>
              <div className="bg-red-900/20 rounded-lg p-3">
                <div className="text-red-400 font-bold mb-1">200-250°C — ichki H₂O</div>
                <div className="text-purple-200">4 ta ichki H₂O ajraladi (ΔH ≈ +160 kJ/mol).</div>
              </div>
              <div className="bg-red-900/20 rounded-lg p-3">
                <div className="text-red-400 font-bold mb-1">250-300°C — ichki Cl⁻</div>
                <div className="text-purple-200">Ichki Cl⁻ ajraladi (ΔH ≈ +90 kJ/mol).</div>
              </div>
              <div className="bg-red-900/20 rounded-lg p-3">
        ...
        <div className="bg-emerald-900/20 border border-emerald-500/30 rounded-2xl p-8">
          ...
          <p className="text-xs text-purple-300 mb-5">
            Massa yo'qotish foizidan <strong className="text-emerald-300">qancha [CrCl₂(H₂O)₄]Cl·2H₂O molekulasi</strong> ajralganini hisoblang.
          </p>
        ...
        <div className="bg-gradient-to-r from-emerald-900/40 to-purple-900/40 border border-emerald-700/50 rounded-2xl p-8">
          ...
          <div className="mt-5 bg-emerald-900/20 border border-emerald-700/30 rounded-xl p-4">
            ...
            <p className="text-xs text-purple-200 leading-relaxed">
              <strong className="text-white">TGA (massa) + DTA (H₂O/Cl₂) + IQ (H₂O) + XRD (gidrat izomerlar) + DSC (ΔH)</strong> — beshta metod birgalikda [CrCl₂(H₂O)₄]Cl·2H₂O ni to'liq tavsiflaydi va gidrat izomerlarni tasdiqlaydi.
            </p>
          </div>
        </div>
      ...
      <footer className="border-t border-purple-800/30 py-6 mt-6">
        <div className="max-w-6xl mx-auto px-4 text-center text-xs text-purple-500">
          <p>© 2026 Koordinatsion kimyo tahlil portali • [CrCl₂(H₂O)₄]Cl·2H₂O • Termik tahlil moduli</p>
