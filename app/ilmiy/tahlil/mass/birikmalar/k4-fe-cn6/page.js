...
const ION_SPECIES = {
  "k2-fe-cn6-2": {
    ...
    formula: "K₂FeC₆N₆",
    exactMass: 290.0806,
    description: "Ikkita K⁺ bilan juftlashgan — 2− zaryadli. m/z ≈ 145 da asosiy pik. K₄[Fe(CN)₆] uchun eng informativ ion.",
  ...
  "k3-fe-cn6-1": {
    ...
    formula: "K₃FeC₆N₆",
    exactMass: 329.1444,
    description: "Uchta K⁺ bilan juftlashgan — 1− zaryadli. m/z ≈ 329 da dominant pik. K₃[Fe(CN)₆] bilan bir xil m/z beradi! LC-MS da saqlanish vaqti bilan farqlanadi.",
    species: { Fe: 1, C: 6, N: 6, K: 3 },
    mzDivider: 1,
    isotopicStep: 1.0,
  },
  "k-fe-cn6-3": {
    ...
    formula: "KFeC₆N₆",
    exactMass: 251.0168,
    description: "Bitta K⁺ bilan juftlashgan — 3− zaryadli. ESI-MS da kuchsiz signal (m/z ≈ 83.7).",
...
// ═══════════════════════════════════════════════════════════════════════════════
function MassSpektrGrafik({ speciesKey = "k3-fe-cn6-1", lineColor = "#fbbf24" }) {
  ...
  const mzMax = distribution[distribution.length - 1]?.mass / species.mzDivider + 1 || 350
...
function IzotopKalkulyator() {
  ...
  const calculate = () => {
    const species = { Fe: 1, C: 6, N: 6, K: kCount }
  ...
  useEffect(() => { calculate() }, [feIso, kCount])
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div>
          ...
          <select value={kCount} onChange={(e) => setKCount(+e.target.value)} className="w-full bg-purple-800/50 border border-purple-600 rounded-lg px-3 py-2 text-white text-sm">
            ...
            <option value={3}>3 ta K⁺</option>
            <option value={4}>4 ta K⁺</option>
          </select>
        </div>
      </div>
      {result && (
...
// ═══════════════════════════════════════════════════════════════════════════════
// MS/MS FRAGMENTATSIYA DARAXTI — K₄[Fe(CN)₆]
// ═══════════════════════════════════════════════════════════════════════════════
const MSMS_TREE = {
  ...
  fragments: [
    {
      ...
      energy: "5 eV",
      children: [
        { mz: 251.0, label: "[KFe(CN)₆]³⁻·2K⁺", intensity: 28, energy: "10 eV" },
        { mz: 211.9, label: "[Fe(CN)₆]⁴⁻·3K⁺", intensity: 10, energy: "15 eV" },
      ]
    },
    {
      mz: 251.0,
      ...
      energy: "8 eV",
      children: [
        { mz: 211.9, label: "[Fe(CN)₆]⁴⁻·3K⁺", intensity: 15, energy: "12 eV" },
        { mz: 186.0, label: "[Fe(CN)₅]⁴⁻·3K⁺", intensity: 8, energy: "18 eV" },
      ]
    },
    {
      mz: 211.9,
      ...
      energy: "10 eV",
      children: [
        { mz: 186.0, label: "[Fe(CN)₅]⁴⁻·3K⁺", intensity: 12, energy: "15 eV" },
        { mz: 160.0, label: "[Fe(CN)₄]⁴⁻·3K⁺", intensity: 5, energy: "20 eV" },
      ]
    },
    {
      mz: 145.0,
      ...
      energy: "12 eV",
      children: [
        { mz: 117.0, label: "[KFe(CN)₅]²⁻", intensity: 10, energy: "18 eV" },
        { mz: 83.7, label: "[KFe(CN)₆]³⁻", intensity: 5, energy: "22 eV" },
      ]
    },
  ]
}
...
// ═══════════════════════════════════════════════════════════════════════════════
// ADDUKT IONLAR JADVALI — K₄[Fe(CN)₆]
// ═══════════════════════════════════════════════════════════════════════════════
const ADDUCT_TABLE = [
  { adduct: "[M]⁴⁻", mz: 53.0, formula: "[Fe(CN)₆]⁴⁻", mode: "ESI−", abundance: "Juda past" },
  { adduct: "[M+K]³⁻", mz: 83.7, formula: "[KFe(CN)₆]³⁻", mode: "ESI−", abundance: "Past" },
  { adduct: "[M+2K]²⁻", mz: 145.0, formula: "[K₂Fe(CN)₆]²⁻", mode: "ESI−", abundance: "Yuqori" },
  { adduct: "[M+3K]⁻", mz: 329.0, formula: "[K₃Fe(CN)₆]⁻", mode: "ESI−", abundance: "Eng yuqori" },
  { adduct: "[M+4K]", mz: 368.0, formula: "K₄[Fe(CN)₆]", mode: "ESI+", abundance: "Kuzatiladi" },
  { adduct: "[M+4K+K]⁺", mz: 407.0, formula: "[K₄Fe(CN)₆+K]⁺", mode: "ESI+", abundance: "O&apos;rta" },
  { adduct: "[M+3K+Na]⁻", mz: 352.0, formula: "[NaK₂Fe(CN)₆]⁻", mode: "ESI−", abundance: "Past" },
]
...
const EXPERIMENTAL_PARAMS = {
  ...
  concentration: "10 μM (K₄[Fe(CN)₆]·3H₂O)",
  flowRate: "0.3 mL/min",
  internalStandard: "K₃[Co(CN)₆] — m/z 332.0 [M+2K]²⁻",
  lod: "0.05 μM (S/N &gt; 3)",
  loq: "0.15 μM (S/N &gt; 10)",
}
...
const IONIZATION_COMPARISON = [
  {
    method: "ESI (−)",
    observed: "[K₃Fe(CN)₆]⁻, [K₂Fe(CN)₆]²⁻",
    mz: "145, 329",
    sensitivity: "Yuqori",
    fragmentation: "Minimal",
    notes: "Soft ionization. m/z=329 dominant. K₃[Fe(CN)₆] bilan bir xil!",
  },
  {
    method: "ESI (+)",
    observed: "[K₄Fe(CN)₆+K]⁺, [K₃Fe(CN)₆+Na]⁺",
    mz: "407, 352",
    sensitivity: "O&apos;rta",
    fragmentation: "Minimal",
    notes: "Musbat rejim K₄ ni K₃ dan farqlash uchun eng yaxshi usul",
  },
  {
    method: "MALDI−TOF",
    ...
    notes: "DHB matritsasi. K⁺ yo&apos;qolishi mumkin",
  },
  {
    method: "EI (70 eV)",
    observed: "Fe(CN)₂⁺, Fe⁺",
...
const INTERNAL_STANDARD = {
  ...
  advantage: "Co analogi — Fe kompleksidan 3 Da og&apos;ir. Spektrda aniq ajralib turadi",
}

// ═══════════════════════════════════════════════════════════════════════════════
// K₃ vs K₄ FARQI — MAXSUS BLOK
// ═══════════════════════════════════════════════════════════════════════════════
const K3VS_K4_INFO = {
  title: "K₃[Fe(CN)₆] va K₄[Fe(CN)₆] — Mass-spektrda farqlash",
  problem: "Ikkala tuz ham ESI− da bir xil m/z = 329 [K₃Fe(CN)₆]⁻ pikini beradi!",
  explanation: "K₄[Fe(CN)₆] uchta K⁺ bilan [K₃Fe(CN)₆]⁻ hosil qiladi. K₃[Fe(CN)₆] esa o&apos;zidan shu ionni beradi. Bundan tashqari, ESI manbasida Fe²⁺ oksidlanib Fe³⁺ ga o&apos;tishi ham mumkin.",
  differentiation: [
    { method: "LC-MS saqlanish vaqti", k4: "tR ≈ 2.1 min", k3: "tR ≈ 3.5 min" },
    { method: "ESI (+) rejim", k4: "[K₄Fe(CN)₆+K]⁺ m/z=407", k3: "Signal juda kuchsiz" },
    { method: "Rang", k4: "Sariq kristall", k3: "Qizil kristall" },
    { method: "Fe oksidlanish darajasi", k4: "Fe²⁺ (d⁶)", k3: "Fe³⁺ (d⁵)" },
  ]
}
    ...
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-yellow-950 via-amber-900 to-blue-950 border border-yellow-700/50 p-8 md:p-12 mb-10">
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end gap-4 mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            <span className="bg-yellow-600/20 text-yellow-400 border border-yellow-600/30 rounded-full px-3 py-1 text-xs font-semibold">
              Sariq qon tuzi
            </span>
            <span className="bg-amber-600/20 text-amber-400 border border-amber-600/30 rounded-full px-3 py-1 text-xs">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {[
            { label: "Molekulyar massa", value: "368.35 g/mol (suvsiz)" },
            { label: "Aniq massa", value: "367.8449 Da" },
        ...
        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 inline-block">
          ...
          <p className="text-purple-400 text-xs mt-1">
            Diqqat! K₃[Fe(CN)₆] bilan bir xil m/z. ESI(+) yoki LC-MS ajratish kerak.
          </p>
        </div>
      </div>
    </div>
...
const TABS = [
  ...
  { id: "k3vsk4", label: "K₃ vs K₄ farqi", icon: "⚖️" },
...
function MSMSFragmentTree() {
  ...
  return (
    <div className="space-y-4">
      ...
      {selectedNode && (
        <div className="bg-yellow-600/10 border border-yellow-500/30 rounded-xl p-4 mt-4">
  ...
  return (
    <div className="overflow-x-auto">
      ...
      <p className="text-purple-500 text-xs mt-3 italic">
        * m/z = 329 [K₃Fe(CN)₆]⁻ eng dominant pik. m/z = 145 [K₂Fe(CN)₆]²⁻ K₄[Fe(CN)₆] uchun xarakterli.
      </p>
    </div>
  )
}
...
// K₃ vs K₄ FARQI BLOKI
// ═══════════════════════════════════════════════════════════════════════════════
function K3vsK4Difference() {
  return (
    <div className="space-y-4">
      <div className="bg-red-600/10 border border-red-500/30 rounded-xl p-4">
        <h3 className="text-red-400 font-semibold flex items-center gap-2">
          <span>⚠️</span> {K3VS_K4_INFO.title}
        </h3>
        <p className="text-purple-200 mt-2 text-sm">
          <strong className="text-yellow-400">{K3VS_K4_INFO.problem}</strong>
        </p>
        <p className="text-purple-300 text-sm mt-1">{K3VS_K4_INFO.explanation}</p>
      </div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-purple-700/50">
              <th className="text-left py-3 px-4 text-purple-400 font-semibold">Farqlash usuli</th>
              <th className="text-left py-3 px-4 text-yellow-400 font-semibold">K₄[Fe(CN)₆]</th>
              <th className="text-left py-3 px-4 text-red-400 font-semibold">K₃[Fe(CN)₆]</th>
            </tr>
          </thead>
          <tbody>
            {K3VS_K4_INFO.differentiation.map((row, i) => (
              <tr key={i} className="border-b border-purple-800/30 hover:bg-purple-800/20 transition-colors">
                <td className="py-3 px-4 text-purple-200">{row.method}</td>
                <td className="py-3 px-4 text-yellow-300 font-semibold">{row.k4}</td>
                <td className="py-3 px-4 text-red-300 font-semibold">{row.k3}</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-yellow-600/10 border border-yellow-500/30 rounded-xl p-4">
          <h3 className="text-yellow-400 font-semibold text-sm mb-2">K₄[Fe(CN)₆] — Sariq qon tuzi</h3>
          <ul className="text-purple-200 text-xs space-y-1">
            <li>• Fe²⁺ (d⁶), past spinli, diamagnit</li>
            <li>• Sariq kristall modda</li>
            <li>• Suvda yaxshi eriydi</li>
            <li>• Qaytaruvchi xossaga ega</li>
            <li>• Zaharli emas (E535 ozuqa qo&apos;shimchasi)</li>
            <li>• Fe³⁺ bilan Berlin ko&apos;ki hosil qiladi</li>
          </ul>
        </div>
        <div className="bg-red-600/10 border border-red-500/30 rounded-xl p-4">
          <h3 className="text-red-400 font-semibold text-sm mb-2">K₃[Fe(CN)₆] — Qizil qon tuzi</h3>
          <ul className="text-purple-200 text-xs space-y-1">
            <li>• Fe³⁺ (d⁵), past spinli, paramagnit</li>
            <li>• Qizil kristall modda</li>
            <li>• Suvda yaxshi eriydi</li>
            <li>• Oksidlovchi xossaga ega</li>
            <li>• Zaharli (siyanid ajratmaydi, lekin zaharli)</li>
            <li>• Fe²⁺ bilan Turnbull ko&apos;ki hosil qiladi</li>
          </ul>
        </div>
      </div>
    </div>
...
export default function K4FeCN6Page() {
  ...
  const [selectedSpecies, setSelectedSpecies] = useState("k3-fe-cn6-1")
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-950 to-blue-950 text-white">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6 md:p-8">
          ...
          {activeTab === "ms" && (
            <div className="space-y-6">
              ...
              <MassSpektrGrafik 
                ...
                lineColor={selectedSpecies === "k3-fe-cn6-1" ? "#fbbf24" : selectedSpecies === "k2-fe-cn6-2" ? "#f59e0b" : "#34d399"} 
              />
              <div className="bg-purple-800/30 border border-purple-700/30 rounded-xl p-4">
                <h3 className="text-white font-semibold mb-2">Izotopik pattern tushuntirish</h3>
                <p className="text-purple-200 text-sm">
                  Fe²⁺ (d⁶) — past spinli, diamagnit. Fe ning izotoplari (⁵⁴Fe 5.8%, ⁵⁶Fe 91.7%) va 
                  K ning izotoplari (³⁹K 93.3%, ⁴¹K 6.7%) hisobiga piklar klasteri hosil bo&apos;ladi.
          ...
          {activeTab === "msms" && (
            <div className="space-y-4">
              ...
              <p className="text-purple-400 text-sm">
                Prekursor: m/z = 329 [K₃Fe(CN)₆]⁻. CID orqali fragmentatsiya. K⁺ ionlari ketma-ket yo&apos;qoladi.
              </p>
              <MSMSFragmentTree />
            </div>
          )}
          ...
          {activeTab === "adducts" && (
            <div className="space-y-4">
              ...
              <p className="text-purple-400 text-sm">
                K₄[Fe(CN)₆] ESI+/ESI− sharoitida hosil qiladigan barcha ion turlari.
              </p>
              <AdductTable />
            </div>
          )}
          ...
          {activeTab === "k3vsk4" && (
            <div className="space-y-4">
              <h2 className="text-xl font-bold text-yellow-400">K₃[Fe(CN)₆] va K₄[Fe(CN)₆] farqi</h2>
              <p className="text-purple-400 text-sm">
                Ikkala tuzning mass-spektrda farqlash usullari. Eng ishonchli usul — LC-MS yoki ESI(+).
              </p>
              <K3vsK4Difference />
            </div>
          )}
          ...
          {activeTab === "calculator" && (
            <div className="space-y-4">
              ...
              <p className="text-purple-400 text-sm">
                K₄[Fe(CN)₆] izotopik taqsimotini hisoblang. K⁺ sonini o&apos;zgartirib ko&apos;ring.
              </p>
              <IzotopKalkulyator />
            </div>
          )}
        ...
        <div className="flex justify-between mt-8 pt-6 border-t border-purple-800/50">
          ...
          >
            <span>←</span> K₃[Fe(CN)₆] (Qizil qon tuzi)
          </Link>
          <Link 
