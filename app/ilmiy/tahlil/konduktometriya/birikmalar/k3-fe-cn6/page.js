...
// Xususiyat: Qizil qon tuzi, 3:1 elektrolit, 4 ion, Prussian Blue
// O'ziga xoslik: Fe³⁺ (d⁵, past spin), Prussian Blue sintezi, tarixiy ahamiyat
...
const COMPOUND = {
  ...
  color: "qizil (to'q qizil kristallar)",
  stability: "havoda barqaror, Fe³⁺ inert (d⁵, past spin)",
  crystalStructure: "Oktaedr — Fe³⁺ markazida 6 ta CN⁻ ligand (ichki sfera), 3 ta K⁺ tashqi sferada",
  coordinationNumber: "6 (oktaedr)",
  spinState: "Past spin (t₂g⁵) — paramagnit (1 toq elektron)",
  magneticMoment: "μ ≈ 2.3 BM (1 toq elektron)",
  ...
  wernerInfo: {
    ...
    wernerProof: "Verner va keyingi kimyogarlar konduktometrik o'lchashlar orqali 3 ta K⁺ ionining tashqi sferada ekanligini isbotladi. Λm ≈ 440 S·cm²/mol — bu 4 ta ion borligini ko'rsatadi (3:1 elektrolit). 6 ta CN⁻ ichki sferada, 3 ta K⁺ tashqi sferada."
  },

  historicalFact: {
    title: "Qizil qon tuzi — Prussian Blue sintezi (1704-yil)",
    text: "K₃[Fe(CN)₆] — kaliy ferritsianid, 'qizil qon tuzi' nomi bilan mashhur. 1704-yilda Diesbach (Berlin) tomonidan tasodifan kashf etilgan — hayvon qoni va temir tuzlarini qizdirish orqali.",
    textExtended: "K₃[Fe(CN)₆] — Prussian Blue (Berlin ko'ki, Fe₄[Fe(CN)₆]₃) sintezining asosiy komponenti. Bu birikma Fe³⁺ ni o'z ichiga oladi va Fe²⁺ tuzlari bilan reaksiyaga kirishib, Prussian Blue cho'kmasini hosil qiladi. Bu reaksiya analitik kimyoda Fe²⁺ ni sifat aniqlash uchun ishlatiladi. K₃[Fe(CN)₆] ning Λm ≈ 440 S·cm²/mol — bu [Co(NH₃)₆]Cl₃ (Λm ≈ 432) ga deyarli teng, chunki ikkalasi ham 4 ta ion hosil qiladi."
  },
  ...
  interestingFacts: [
    ...
    {
      title: "Qizil qon tuzi nomi",
      fact: "'Qizil qon tuzi' nomi 1704-yilda hayvon qoni va temir tuzlarini qizdirish orqali kashf etilganligidan kelib chiqqan."
    },
    {
    ...
    },
    {
      ...
      fact: "Fe³⁺ (d⁵, past spin) 1 ta toq elektronga ega — paramagnit (μ ≈ 2.3 BM). Bu [Co(NH₃)₆]³⁺ (diamagnit) dan farq qiladi."
    },
    {
      title: "Kuchli oksidlovchi",
      fact: "K₃[Fe(CN)₆] kuchli oksidlovchi — Fe³⁺ ni Fe²⁺ ga qaytarish mumkin. Bu xususiyat analitik kimyoda ishlatiladi."
    }
  ],

  conductometricFeature: {
    title: "K₃[Fe(CN)₆] — 3:1 elektrolit, Λm ≈ 440 S·cm²/mol",
    description: "Bu kompleks konduktometriyada klassik namuna hisoblanadi. 3 ta K⁺ tashqi sferada — eritmada erkin harakatlanadi. 6 ta CN⁻ ichki sferada — Fe³⁺ ga bog'langan, erkin harakatlanmaydi.",
    reaction: {
      dissociation: "K₃[Fe(CN)₆] → 3K⁺ + [Fe(CN)₆]³⁻",
      ions: "4 ion: 3 ta K⁺ + 1 ta [Fe(CN)₆]³⁻",
      electrolyteType: "3:1 elektrolit",
      lm_theoretical: "Λm ≈ 440 S·cm²/mol (25°C, 10⁻³ M)"
    },
    problem: {
      title: "3:1 elektrolit — yuqori o'tkazuvchanlik",
      description: "3 ta K⁺ tashqi sferada — eritmada erkin harakatlanadi. 6 ta CN⁻ ichki sferada — Fe³⁺ ga mustahkam bog'langan.",
      impact: "Λm ≈ 440 S·cm²/mol — bu 3:1 elektrolit uchun tipik qiymat. [Co(NH₃)₆]Cl₃ (Λm ≈ 432) ga deyarli teng."
    },
    solution: {
      title: "Kohlrausch qonuni",
      description: "Kohlrausch qonuni bo'yicha: Λm° = λ₊ + λ₋. Bu yerda λ₊ = 3×λ(K⁺), λ₋ = λ([Fe(CN)₆]³⁻).",
      mechanism: "Λm° ≈ 440 S·cm²/mol = 3×λ(K⁺) + λ([Fe(CN)₆]³⁻). λ(K⁺) ≈ 73 S·cm²/mol bo'lsa, λ([Fe(CN)₆]³⁻) ≈ 440 - 3×73 = 221 S·cm²/mol."
    }
  },
  ...
  theoretical: {
    Fe:  { mass: 55.845,  percent: 16.96, source: "Fe³⁺ markaziy atom (ichki sfera)", conductSignal: "[Fe(CN)₆]³⁻ anioni — o'tkazuvchanlikka hissa qo'shadi" },
    C:   { mass: 72.066,  percent: 21.89, source: "6×CN⁻ (6×C, ichki sfera)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" },
    N:   { mass: 84.042,  percent: 25.53, source: "6×CN⁻ (6×N, ichki sfera)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" },
    K:   { mass: 117.294, percent: 35.62, source: "3×K⁺ (tashqi sfera, ion)", conductSignal: "3 ta K⁺ kationi — o'tkazuvchanlikka hissa qo'shadi" }
  },

  conductometricData: [
    { conc: 0.0001, lm: 450, kappa: 0.00450, event: "Juda suyultirilgan", theoryNote: "Cheksiz suyultirishga yaqin — Λm° ga yaqin" },
    { conc: 0.0005, lm: 445, kappa: 0.0223, event: "Juda suyultirilgan", theoryNote: "Λm hali ham Λm° ga yaqin" },
    { conc: 0.001, lm: 440, kappa: 0.0440, event: "Standart konsentratsiya", theoryNote: "Standart konsentratsiya (10⁻³ M) — Λm ≈ 440 S·cm²/mol" },
    { conc: 0.005, lm: 425, kappa: 0.213, event: "O'rta konsentratsiya", theoryNote: "Λm kamayadi — ion-ion o'zaro ta'siri" },
    { conc: 0.01, lm: 415, kappa: 0.415, event: "O'rta konsentratsiya", theoryNote: "Ion-ion o'zaro ta'siri kuchayadi" },
    { conc: 0.05, lm: 395, kappa: 1.98, event: "Yuqori konsentratsiya", theoryNote: "Ion atmosferasi kuchli — Λm sezilarli kamayadi" },
    { conc: 0.1, lm: 380, kappa: 3.80, event: "Yuqori konsentratsiya", theoryNote: "Ion juftlari hosil bo'ladi" },
    { conc: 0.5, lm: 355, kappa: 17.8, event: "Juda yuqori konsentratsiya", theoryNote: "Kuchli ion-ion o'zaro ta'siri" },
    { conc: 1.0, lm: 335, kappa: 33.5, event: "Juda yuqori konsentratsiya", theoryNote: "Λm sezilarli kamaydi — ion juftlari ko'p" }
  ],

  solventData: [
    { solvent: "Suv (H₂O)", dielectric: 78.5, lm: 440, kappa: 0.0440, color: "qizil", note: "Standart erituvchi — eng yuqori o'tkazuvchanlik" },
    { solvent: "Metanol (CH₃OH)", dielectric: 32.7, lm: 385, kappa: 0.0385, color: "qizil", note: "Kamroq dielektrik — kamroq dissotsiatsiya" },
    { solvent: "Etanol (C₂H₅OH)", dielectric: 24.3, lm: 325, kappa: 0.0325, color: "qizil", note: "Yanada kamroq dielektrik" },
    ...
    { solvent: "Aseton ((CH₃)₂CO)", dielectric: 20.7, lm: 285, kappa: 0.0285, color: "qizil", note: "Kam qutbli — kam dissotsiatsiya" }
  ],

  temperatureData: [
    { temp: 15, lm: 420, kappa: 0.0420, note: "Past temperatura — kamroq o'tkazuvchanlik" },
    { temp: 20, lm: 430, kappa: 0.0430, note: "Xona temperaturasi" },
    { temp: 25, lm: 440, kappa: 0.0440, note: "Standart temperatura (25°C)" },
    { temp: 30, lm: 452, kappa: 0.0452, note: "Yuqori temperatura — ko'proq o'tkazuvchanlik" },
    { temp: 40, lm: 478, kappa: 0.0478, note: "Yuqori temperatura" },
    { temp: 50, lm: 505, kappa: 0.0505, note: "Juda yuqori temperatura" }
  ],
  ...
  experimentalRuns: [
    { 
      ...
      theoryNote: "Standart sharoitda Λm ≈ 440 S·cm²/mol — bu 3:1 elektrolit uchun tipik qiymat."
    },
    { 
      id: "COND-24-002", 
      date: "2026-07-15", 
      ...
      theoryNote: "Takrorlanish — natijalar bir xil (Λm ≈ 441 S·cm²/mol)."
    },
    { 
      id: "COND-24-003", 
      date: "2026-07-16", 
    ...
    { 
      ...
      theoryNote: "Ion-ion o'zaro ta'siri kuchayadi — Λm ≈ 415 S·cm²/mol."
    },
    { 
      id: "COND-24-005", 
      date: "2026-07-17", 
    ...
    { 
      ...
      theoryNote: "Juda suyultirilgan eritma — Λm ≈ 450 S·cm²/mol (Λm° ga yaqin)."
    }
  ],
  ...
  samplePrepSteps: [
    ...
    { step: 4, title: "Eritma tayyorlash (10⁻³ M)", desc: "Analitik tarozida 32.92 mg K₃[Fe(CN)₆] tortilib, 100 mL o'lchov kolbasiga solinadi. 50 mL deionizatsiyalangan suv qo'shib, eritiladi.", time: "5 daq", critical: true },
    ...
    { step: 8, title: "Λm hisoblash", desc: "Λm = (κ × 1000) / c hisoblanadi. Natija ≈ 440 S·cm²/mol bo'lishi kerak.", time: "2 daq", critical: false },
...
export default function K3FeCN6ConductometricPage() {
  ...
  const [calcKappa, setCalcKappa] = useState(0.0440)
  const [calcConc, setCalcConc] = useState(0.001)
  
  const [calcLambdaPlus, setCalcLambdaPlus] = useState(73)
  const [calcLambdaMinus, setCalcLambdaMinus] = useState(221)
  ...
  const kohlrauschResult = useMemo(() => {
    const lm0 = 3 * calcLambdaPlus + calcLambdaMinus
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4">
          <div className="bg-gradient-to-br from-red-950 to-purple-950 border-2 border-red-500 rounded-2xl p-6 max-w-3xl w-full animate-pulse">
            <h3 className="text-xl font-bold text-red-400 mb-4 flex items-center gap-2">
              <span className="text-3xl">⚠️</span> QIZIL QON TUZI — 3:1 ELEKTROLIT!
            </h3>
            <p className="text-purple-200 text-sm mb-4">
              <strong className="text-red-300">K₃[Fe(CN)₆]</strong> — qizil qon tuzi, Prussian Blue sintezining asosiy komponenti. 
              3 ta K⁺ tashqi sferada, 6 ta CN⁻ ichki sferada!
            </p>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <div className="text-purple-200 mt-2">
                    <strong>Qizil rang</strong> — qizil qon tuzi.
                  </div>
                </div>
                <div>
                  <div className="text-red-400 font-bold mb-2">🔌 Tashqi sfera:</div>
                  <div className="text-purple-200">
                    <strong>3 ta K⁺</strong> — erkin ionlar.
                  </div>
                  <div className="text-purple-200 mt-2">
                    <strong>Λm ≈ 440 S·cm²/mol</strong> — 3:1 elektrolit!
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-red-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-red-300">Prussian Blue:</strong> K₃[Fe(CN)₆] + Fe²⁺ → Fe₄[Fe(CN)₆]₃ (Prussian Blue, Berlin ko'ki). Bu cho'kma analitik kimyoda Fe²⁺ ni sifat aniqlash uchun ishlatiladi.
              </p>
            </div>

            <div className="bg-red-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-red-300">XAVF:</strong> Kislota qo'shilganda CN⁻ gazi ajralishi mumkin — <strong>JUDA ZAHARLI!</strong> Kislota qo'shmang!
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-4">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  <span className="px-2 py-1 rounded bg-red-900/30 border border-red-700/50 text-red-400 text-[10px] uppercase tracking-wide">3:1 elektrolit</span>
                  ...
                  <span className="px-2 py-1 rounded bg-yellow-900/30 border border-yellow-700/50 text-yellow-400 text-[10px] uppercase tracking-wide">Λm ≈ 440</span>
      ...
      <section className="max-w-6xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-purple-200">
            <div className="space-y-3">
              <p className="leading-relaxed">
                <strong className="text-white">K₃[Fe(CN)₆]</strong> — qizil qon tuzi, Prussian Blue sintezining asosiy komponenti. Termik tahlilda <strong className="text-red-300">3:1 elektrolit</strong> — 4 ta ion borligini ko'rsatadi.
              </p>
              <ul className="list-disc list-inside space-y-2 marker:text-red-500 text-xs md:text-sm">
                ...
                <li><strong className="text-red-300">3 ta K⁺</strong> tashqi sferada (erkin ionlar)</li>
                <li><strong className="text-red-300">Λm ≈ 440 S·cm²/mol</strong> — 3:1 elektrolit</li>
                <li><strong className="text-red-300">4 ta ion</strong> — 3 ta K⁺ + 1 ta [Fe(CN)₆]³⁻</li>
                <li><strong className="text-red-300">Paramagnit</strong> — μ ≈ 2.3 BM (1 toq elektron)</li>
                <li><strong className="text-red-300">Prussian Blue</strong> sintezi</li>
              </ul>
            </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-purple-200">
                ...
                <tr className="bg-red-900/20 font-bold border-t border-red-500/30">
                  ...
                  <td colSpan={2} className="py-3 text-[10px] text-red-300">Konduktometriya: 3 ta K⁺ + 1 ta [Fe(CN)₆]³⁻ = 4 ion</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="bg-purple-950/50 rounded-lg p-5 border border-purple-700/30">
            <div className="grid grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <div className="text-xl font-mono font-bold text-blue-400">Λm° = 3×λ₊ + λ₋</div>
              </div>
            </div>
            <p className="text-xs text-purple-300 font-mono">
              Λm° = 3×{calcLambdaPlus} + {calcLambdaMinus} = {kohlrauschResult.lm0} S·cm²/mol
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-900/30 via-indigo-900/30 to-purple-900/30 border border-green-700/30 rounded-2xl p-6">
          ...
          <ol className="space-y-2 text-purple-200 list-decimal list-inside">
            ...
            <li>Prussian Blue sintezi — <strong className="text-red-300">analitik kimyoda Fe²⁺ ni sifat aniqlash</strong></li>
            <li>Fe³⁺ (d⁵, past spin) — <strong className="text-red-300">paramagnit (1 toq elektron)</strong></li>
          </ol>
        </div>
