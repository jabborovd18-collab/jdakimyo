...
// ═══════════════════════════════════════════════════════════════════════════════
// K₄[Fe(CN)₆] — KONDUKTOMETRIK TAHLIL MAHSUS SAHIFASI (PREMIUM)
// Manbalar: Vogel's Quantitative Chemical Analysis, Bard & Faulkner
// Xususiyat: Sariq qon tuzi, 4:1 elektrolit, 5 ion, Prussian Blue
// O'ziga xoslik: Fe²⁺ (d⁶, past spin, diamagnit), Prussian Blue sintezi
...
const COMPOUND = {
  ...
  stability: "havoda barqaror, Fe²⁺ inert (d⁶, past spin)",
  crystalStructure: "Oktaedr — Fe²⁺ markazida 6 ta CN⁻ ligand (ichki sfera), 4 ta K⁺ tashqi sferada",
  ...
  wernerInfo: {
    ...
    wernerProof: "Verner va keyingi kimyogarlar konduktometrik o'lchashlar orqali 4 ta K⁺ ionining tashqi sferada ekanligini isbotladi. Λm ≈ 540 S·cm²/mol — bu 5 ta ion borligini ko'rsatadi (4:1 elektrolit). 6 ta CN⁻ ichki sferada, 4 ta K⁺ tashqi sferada."
  },

  historicalFact: {
    title: "Sariq qon tuzi — Prussian Blue sintezi (1704-yil)",
    text: "K₄[Fe(CN)₆] — kaliy ferrotsianid, 'sariq qon tuzi' nomi bilan mashhur. 1704-yilda Diesbach (Berlin) tomonidan tasodifan kashf etilgan — hayvon qoni va temir tuzlarini qizdirish orqali.",
    textExtended: "K₄[Fe(CN)₆] — Prussian Blue (Berlin ko'ki, Fe₄[Fe(CN)₆]₃) sintezining asosiy komponenti. Bu birikma Fe²⁺ ni o'z ichiga oladi va Fe³⁺ tuzlari bilan reaksiyaga kirishib, Prussian Blue cho'kmasini hosil qiladi. Bu reaksiya analitik kimyoda Fe³⁺ ni sifat aniqlash uchun ishlatiladi. K₄[Fe(CN)₆] ning Λm ≈ 540 S·cm²/mol — bu [Co(NH₃)₆]Cl₃ (Λm ≈ 432) dan yuqori, chunki 5 ta ion hosil qiladi (4:1 elektrolit). K₄[Fe(CN)₆] diamagnit (Fe²⁺, d⁶, past spin) — barcha 6 elektron t₂g orbitallarini to'ldiradi."
  },

  interestingFacts: [
    {
      title: "Prussian Blue (Berlin ko'ki)",
      fact: "K₄[Fe(CN)₆] + Fe³⁺ → Fe₄[Fe(CN)₆]₃ (Prussian Blue). Bu cho'kma analitik kimyoda Fe³⁺ ni sifat aniqlash uchun ishlatiladi."
    },
    {
      title: "Sariq qon tuzi nomi",
      fact: "'Sariq qon tuzi' nomi 1704-yilda hayvon qoni va temir tuzlarini qizdirish orqali kashf etilganligidan kelib chiqqan."
    },
    {
      title: "Fe²⁺ inert kompleks",
      fact: "Fe²⁺ (d⁶, past spin, t₂g⁶) inert — ligand almashinishi juda sekin. CN⁻ kuchli maydon ligand bo'lgani uchun Fe²⁺ barqaror."
    },
    {
      title: "Diamagnit kompleks",
      fact: "Fe²⁺ (d⁶, past spin) barcha 6 elektron juftlangan — diamagnit (μ = 0 BM). Bu [Co(NH₃)₆]³⁺ (diamagnit) ga o'xshash."
    },
    {
      title: "4:1 elektrolit",
      fact: "K₄[Fe(CN)₆] 5 ta ion hosil qiladi (4 ta K⁺ + 1 ta [Fe(CN)₆]⁴⁻). Bu eng yuqori ion soni — Λm ≈ 540 S·cm²/mol."
    }
  ],

  conductometricFeature: {
    title: "K₄[Fe(CN)₆] — 4:1 elektrolit, Λm ≈ 540 S·cm²/mol",
    description: "Bu kompleks konduktometriyada klassik namuna hisoblanadi. 4 ta K⁺ tashqi sferada — eritmada erkin harakatlanadi. 6 ta CN⁻ ichki sferada — Fe²⁺ ga bog'langan, erkin harakatlanmaydi.",
    reaction: {
      dissociation: "K₄[Fe(CN)₆] → 4K⁺ + [Fe(CN)₆]⁴⁻",
      ions: "5 ion: 4 ta K⁺ + 1 ta [Fe(CN)₆]⁴⁻",
      electrolyteType: "4:1 elektrolit",
      lm_theoretical: "Λm ≈ 540 S·cm²/mol (25°C, 10⁻³ M)"
    },
    problem: {
      title: "4:1 elektrolit — eng yuqori o'tkazuvchanlik",
      description: "4 ta K⁺ tashqi sferada — eritmada erkin harakatlanadi. 6 ta CN⁻ ichki sferada — Fe²⁺ ga mustahkam bog'langan.",
      impact: "Λm ≈ 540 S·cm²/mol — bu 4:1 elektrolit uchun tipik qiymat. Eng yuqori ion soni — eng yuqori o'tkazuvchanlik."
    },
    solution: {
      title: "Kohlrausch qonuni",
      description: "Kohlrausch qonuni bo'yicha: Λm° = λ₊ + λ₋. Bu yerda λ₊ = 4×λ(K⁺), λ₋ = λ([Fe(CN)₆]⁴⁻).",
      mechanism: "Λm° ≈ 540 S·cm²/mol = 4×λ(K⁺) + λ([Fe(CN)₆]⁴⁻). λ(K⁺) ≈ 73 S·cm²/mol bo'lsa, λ([Fe(CN)₆]⁴⁻) ≈ 540 - 4×73 = 248 S·cm²/mol."
    }
  },
  ...
  theoretical: {
    Fe:  { mass: 55.845,  percent: 13.22, source: "Fe²⁺ markaziy atom (ichki sfera)", conductSignal: "[Fe(CN)₆]⁴⁻ anioni — o'tkazuvchanlikka hissa qo'shadi" },
    C:   { mass: 72.066,  percent: 17.06, source: "6×CN⁻ (6×C, ichki sfera)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" },
    N:   { mass: 84.042,  percent: 19.90, source: "6×CN⁻ (6×N, ichki sfera)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" },
    K:   { mass: 156.392, percent: 37.03, source: "4×K⁺ (tashqi sfera, ion)", conductSignal: "4 ta K⁺ kationi — o'tkazuvchanlikka hissa qo'shadi" }
  },
  ...
  conductometricData: [
    ...
    { conc: 0.005, lm: 520, kappa: 0.260, event: "O'rta konsentratsiya", theoryNote: "Λm kamayadi — ion-ion o'zaro ta'siri" },
    { conc: 0.01, lm: 505, kappa: 0.505, event: "O'rta konsentratsiya", theoryNote: "Ion-ion o'zaro ta'siri kuchayadi" },
    { conc: 0.05, lm: 480, kappa: 2.40, event: "Yuqori konsentratsiya", theoryNote: "Ion atmosferasi kuchli — Λm sezilarli kamayadi" },
    { conc: 0.1, lm: 460, kappa: 4.60, event: "Yuqori konsentratsiya", theoryNote: "Ion juftlari hosil bo'ladi" },
    { conc: 0.5, lm: 430, kappa: 21.5, event: "Juda yuqori konsentratsiya", theoryNote: "Kuchli ion-ion o'zaro ta'siri" },
    { conc: 1.0, lm: 405, kappa: 40.5, event: "Juda yuqori konsentratsiya", theoryNote: "Λm sezilarli kamaydi — ion juftlari ko'p" }
  ],

  solventData: [
    { solvent: "Suv (H₂O)", dielectric: 78.5, lm: 540, kappa: 0.0540, color: "sariq", note: "Standart erituvchi — eng yuqori o'tkazuvchanlik" },
    { solvent: "Metanol (CH₃OH)", dielectric: 32.7, lm: 475, kappa: 0.0475, color: "sariq", note: "Kamroq dielektrik — kamroq dissotsiatsiya" },
    { solvent: "Etanol (C₂H₅OH)", dielectric: 24.3, lm: 400, kappa: 0.0400, color: "sariq", note: "Yanada kamroq dielektrik" },
    { solvent: "DMF (Dimetilformamid)", dielectric: 36.7, lm: 440, kappa: 0.0440, color: "sariq", note: "Qutbli organik erituvchi" },
    { solvent: "CH₃CN (Asetonitril)", dielectric: 37.5, lm: 450, kappa: 0.0450, color: "sariq", note: "Qutbli organik erituvchi" },
    { solvent: "Aseton ((CH₃)₂CO)", dielectric: 20.7, lm: 350, kappa: 0.0350, color: "sariq", note: "Kam qutbli — kam dissotsiatsiya" }
  ],

  temperatureData: [
    { temp: 15, lm: 515, kappa: 0.0515, note: "Past temperatura — kamroq o'tkazuvchanlik" },
    { temp: 20, lm: 527, kappa: 0.0527, note: "Xona temperaturasi" },
    { temp: 25, lm: 540, kappa: 0.0540, note: "Standart temperatura (25°C)" },
    { temp: 30, lm: 555, kappa: 0.0555, note: "Yuqori temperatura — ko'proq o'tkazuvchanlik" },
    { temp: 40, lm: 585, kappa: 0.0585, note: "Yuqori temperatura" },
    { temp: 50, lm: 618, kappa: 0.0618, note: "Juda yuqori temperatura" }
  ],
  ...
  experimentalRuns: [
    { 
      ...
      theoryNote: "Standart sharoitda Λm ≈ 540 S·cm²/mol — bu 4:1 elektrolit uchun tipik qiymat."
    },
    { 
      id: "COND-24-002", 
      date: "2026-08-15", 
      ...
      theoryNote: "Takrorlanish — natijalar bir xil (Λm ≈ 541 S·cm²/mol)."
    },
    { 
      id: "COND-24-003", 
      date: "2026-08-16", 
    ...
    { 
      ...
      theoryNote: "Ion-ion o'zaro ta'siri kuchayadi — Λm ≈ 505 S·cm²/mol."
    },
    { 
      id: "COND-24-005", 
      date: "2026-08-17", 
      ...
      ions: 5, 
      type: "4:1 elektrolit",
      note: "Fe³⁺ qo'shilganda — Prussian Blue hosil bo'ladi",
      theoryNote: "Fe³⁺ qo'shilganda Fe₄[Fe(CN)₆]₃ (Prussian Blue) cho'kma hosil bo'ladi."
    },
    { 
      id: "COND-24-006", 
      date: "2026-08-17", 
      ...
      theoryNote: "Juda suyultirilgan eritma — Λm ≈ 550 S·cm²/mol (Λm° ga yaqin)."
    }
  ],

  samplePrepSteps: [
    { step: 1, title: "⚠ Xavfsizlik choralari", desc: "K₄[Fe(CN)₆] zaharli emas, lekin kislota qo'shilganda CN⁻ gazi ajralishi mumkin (JUDA ZAHARLI!). Qo'lqop, himoya ko'zoynaklari va laboratoriya xalati majburiy. Ventilyatsiya zarur!", time: "doimiy", critical: true },
    ...
    { step: 4, title: "Eritma tayyorlash (10⁻³ M)", desc: "Analitik tarozida 42.24 mg K₄[Fe(CN)₆] tortilib, 100 mL o'lchov kolbasiga solinadi. 50 mL deionizatsiyalangan suv qo'shib, eritiladi.", time: "5 daq", critical: true },
    ...
    { step: 8, title: "Λm hisoblash", desc: "Λm = (κ × 1000) / c hisoblanadi. Natija ≈ 540 S·cm²/mol bo'lishi kerak.", time: "2 daq", critical: false },
    ...
    { step: 10, title: "Tozalash va saqlash", desc: "Elektrodlar distillangan suv bilan yuviladi. Eritma saqlanadi (qorong'i, 4°C). KISLOTA QO'SHMANG!", time: "5 daq", critical: false }
  ],

  relatedMethods: [
    {
      name: "ICP-OES/ICP-MS",
      role: "Fe va K miqdorini aniqlaydi",
    ...
    },
    {
      ...
      role: "Kompleks rangini va konsentratsiyani aniqlaydi (420 nm)",
    ...
    },
    {
      ...
      role: "Fe³⁺ ni sifat aniqlash (Fe³⁺ qo'shilganda ko'k cho'kma)",
      condAdvantage: "Prussian Blue testi Fe³⁺ ni, konduktometriya ionlar sonini aniqlaydi",
      condDisadvantage: "Birgalikda to'liq tahlil",
      complementarity: "90%"
    }
  ]
...
export default function K4FeCN6ConductometricPage() {
  const [showHeader, setShowHeader] = useState(true)
  const [showWarningModal, setShowWarningModal] = useState(true)
  const [activeStep, setActiveStep] = useState(0)
  const [activeRun, setActiveRun] = useState("COND-24-001")
  const [activeWerner, setActiveWerner] = useState(2)
  ...
  const [calcKappa, setCalcKappa] = useState(0.0540)
  const [calcConc, setCalcConc] = useState(0.001)
  
  const [calcLambdaPlus, setCalcLambdaPlus] = useState(73)
  const [calcLambdaMinus, setCalcLambdaMinus] = useState(248)
  ...
  const calcResult = useMemo(() => {
    ...
    let ions = 0
    if (lm >= 500 && lm <= 600) { type = "4:1 yoki 1:4 elektrolit"; color = "text-red-400"; ions = 5 }
    else if (lm >= 400 && lm < 500) { type = "3:1 yoki 1:3 elektrolit"; color = "text-red-400"; ions = 4 }
  ...
  const kohlrauschResult = useMemo(() => {
    const lm0 = 4 * calcLambdaPlus + calcLambdaMinus
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-purple-950 via-yellow-950/20 to-blue-950 text-white">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4">
          <div className="bg-gradient-to-br from-yellow-950 to-purple-950 border-2 border-yellow-500 rounded-2xl p-6 max-w-3xl w-full animate-pulse">
            <h3 className="text-xl font-bold text-yellow-400 mb-4 flex items-center gap-2">
              <span className="text-3xl">⚠️</span> SARIQ QON TUZI — 4:1 ELEKTROLIT!
            </h3>
            <p className="text-purple-200 text-sm mb-4">
              <strong className="text-yellow-300">K₄[Fe(CN)₆]</strong> — sariq qon tuzi, Prussian Blue sintezining asosiy komponenti. 
              4 ta K⁺ tashqi sferada, 6 ta CN⁻ ichki sferada!
            </p>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <div className="text-purple-200">
                    <strong>6 ta CN⁻</strong> — Fe²⁺ ga mustahkam bog'langan.
                  </div>
                  <div className="text-purple-200 mt-2">
                    <strong>Sariq rang</strong> — sariq qon tuzi.
                  </div>
                </div>
                <div>
                  <div className="text-yellow-400 font-bold mb-2">🔌 Tashqi sfera:</div>
                  <div className="text-purple-200">
                    <strong>4 ta K⁺</strong> — erkin ionlar.
                  </div>
                  <div className="text-purple-200 mt-2">
                    <strong>Λm ≈ 540 S·cm²/mol</strong> — 4:1 elektrolit!
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-yellow-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-yellow-300">Prussian Blue:</strong> K₄[Fe(CN)₆] + Fe³⁺ → Fe₄[Fe(CN)₆]₃ (Prussian Blue, Berlin ko'ki). Bu cho'kma analitik kimyoda Fe³⁺ ni sifat aniqlash uchun ishlatiladi.
              </p>
            </div>

            <div className="bg-yellow-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-yellow-300">XAVF:</strong> Kislota qo'shilganda CN⁻ gazi ajralishi mumkin — <strong>JUDA ZAHARLI!</strong> Kislota qo'shmang!
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-4">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  ...
                  <span className="px-2 py-1 rounded bg-yellow-900/30 border border-yellow-700/50 text-yellow-400 text-[10px] uppercase tracking-wide">5 ion</span>
                  <span className="px-2 py-1 rounded bg-yellow-900/30 border border-yellow-700/50 text-yellow-400 text-[10px] uppercase tracking-wide">Λm ≈ 540</span>
      ...
      <section className="max-w-6xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-purple-200">
            <div className="space-y-3">
              <p className="leading-relaxed">
                <strong className="text-white">K₄[Fe(CN)₆]</strong> — sariq qon tuzi, Prussian Blue sintezining asosiy komponenti. Termik tahlilda <strong className="text-yellow-300">4:1 elektrolit</strong> — 5 ta ion borligini ko'rsatadi.
              </p>
              <ul className="list-disc list-inside space-y-2 marker:text-yellow-500 text-xs md:text-sm">
                ...
                <li><strong className="text-yellow-300">4 ta K⁺</strong> tashqi sferada (erkin ionlar)</li>
                <li><strong className="text-yellow-300">Λm ≈ 540 S·cm²/mol</strong> — 4:1 elektrolit</li>
                <li><strong className="text-yellow-300">5 ta ion</strong> — 4 ta K⁺ + 1 ta [Fe(CN)₆]⁴⁻</li>
                <li><strong className="text-yellow-300">Diamagnit</strong> — μ = 0 BM (0 toq elektron)</li>
                <li><strong className="text-yellow-300">Prussian Blue</strong> sintezi</li>
              </ul>
            </div>
        ...
        <div className="bg-gradient-to-r from-yellow-900/40 to-yellow-900/40 border-2 border-yellow-700/70 rounded-2xl p-6">
          ...
          <div className="bg-purple-950/60 rounded-lg p-4 mb-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
              ...
              <div className="bg-yellow-900/30 rounded p-3">
                <p className="text-yellow-400 font-bold text-lg">{COMPOUND.conductometricFeature.reaction.lm_theoretical.split("≈")[1]}</p>
                <p className="text-purple-300 text-xs mt-1">Λm (25°C, 10⁻³ M)</p>
              </div>
              <div className="bg-yellow-900/30 rounded p-3">
                <p className="text-yellow-400 font-bold text-lg">5 ion</p>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-4">
            K₄[Fe(CN)₆] uchun nazariy tarkib. Fe²⁺ markaziy atom, 6 ta CN⁻ ichki sferada, 4 ta K⁺ tashqi sferada.
          </p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-purple-200">
                {Object.entries(COMPOUND.theoretical).map(([el, d]) => {
                  const elColor = el === "Fe" ? "text-yellow-400" : el === "K" ? "text-yellow-400" : "text-purple-400"
                  return (
                ...
                <tr className="bg-yellow-900/20 font-bold border-t border-yellow-500/30">
                  ...
                  <td colSpan={2} className="py-3 text-[10px] text-yellow-300">Konduktometriya: 4 ta K⁺ + 1 ta [Fe(CN)₆]⁴⁻ = 5 ion</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-sm text-purple-200 mb-5 leading-relaxed">
            K₄[Fe(CN)₆] uchun standart konduktometrik tahlil sharoitlari.
          </p>
          ...
          <div className="bg-purple-800/30 rounded-xl p-5 border border-purple-700/30 mb-4">
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-purple-700">
                    ...
                    <th className="py-3 px-4 text-yellow-300">Formulasi (Verner)</th>
                    <th className="py-3 px-4 text-yellow-300">Ionlar soni</th>
                    <th className="py-3 px-4 text-yellow-300">Λm (S·cm²/mol)</th>
                    <th className="py-3 px-4 text-yellow-300">Elektrolit turi</th>
                  </tr>
                </thead>
                <tbody className="text-purple-200">
                  {COMPOUND.wernerComparison.map((exp, i) => (
                    ...
                    >
                      ...
                      <td className="py-2 px-3 font-mono text-yellow-400">{exp.lm}</td>
            ...
            <p className="text-purple-400 text-xs mt-3">
              * Verner bu ma'lumotlar asosida K⁺ ionlarining tashqi sferada (erkin), 
              CN⁻ ichki sferada (kompleks bilan bog'langan) ekanligini ko'rsatgan.
            </p>
          </div>
        </div>
        ...
        <div className="bg-blue-900/20 border border-blue-500/30 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div>
              <label className="block text-xs text-purple-400 mb-1">λ₋ = λ([Fe(CN)₆]⁴⁻) (S·cm²/mol):</label>
              <input
                type="number"
                step="1"
          ...
          <div className="bg-purple-950/50 rounded-lg p-5 border border-purple-700/30">
            <div className="grid grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <div className="text-xl font-mono font-bold text-blue-400">Λm° = 4×λ₊ + λ₋</div>
              </div>
            </div>
            <p className="text-xs text-purple-300 font-mono">
              Λm° = 4×{calcLambdaPlus} + {calcLambdaMinus} = {kohlrauschResult.lm0} S·cm²/mol
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-yellow-900/40 to-purple-900/40 border border-yellow-700/50 rounded-2xl p-8">
          ...
          <div className="mt-5 bg-yellow-900/20 border border-yellow-700/30 rounded-xl p-4">
            ...
            <p className="text-xs text-purple-200 leading-relaxed">
              <strong className="text-white">Konduktometriya (Λm, ionlar soni) + ICP (Fe, K miqdori) + UV-Vis (420 nm) + XRD (struktura) + EA (C, H, N) + Prussian Blue testi (Fe³⁺)</strong> — oltita metod birgalikda K₄[Fe(CN)₆] ni to'liq tavsiflaydi va Prussian Blue sintezini tasdiqlaydi.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-900/30 via-indigo-900/30 to-purple-900/30 border border-green-700/30 rounded-2xl p-6">
          ...
          <ol className="space-y-2 text-purple-200 list-decimal list-inside">
            ...
            <li>Prussian Blue sintezi — <strong className="text-yellow-300">analitik kimyoda Fe³⁺ ni sifat aniqlash</strong></li>
            <li>Fe²⁺ (d⁶, past spin) — <strong className="text-yellow-300">diamagnit (0 toq elektron)</strong></li>
          </ol>
        </div>
      ...
      <footer className="border-t border-purple-800/30 py-6 mt-6">
        <div className="max-w-6xl mx-auto px-4 text-center text-xs text-purple-500">
          <p>© 2026 Koordinatsion kimyo tahlil portali • K₄[Fe(CN)₆] • Konduktometrik tahlil moduli</p>
          <p className="mt-1">Manbalar: Vogel's Quantitative Chemical Analysis, Bard & Faulkner, Diesbach (1704)</p>
        </div>
      </footer>
    </main>
  )
