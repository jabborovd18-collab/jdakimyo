...
// ═══════════════════════════════════════════════════════════════════════════════
// [Co(en)₃]Cl₃ — KONDUKTOMETRIK TAHLIL MAHSUS SAHIFASI (PREMIUM)
// Manbalar: Vogel's Quantitative Chemical Analysis, Bard & Faulkner
// Xususiyat: Xelat effekti, 1:3 elektrolit, 4 ion, optik izomerlar (Λ/Δ)
// O'ziga xoslik: Kstab juda yuqori (log β₃ ≈ 49), inert kompleks, xelat effekti
...
const COMPOUND = {
  ...
  commonName: "Tris(etilendiamin)kobalt(III) xlorid (sariq-to'q sariq)",
  molarMass: 345.28,
  casNumber: "14878-43-8",
  color: "sariq-to'q sariq (luteo-ga o'xshash)",
  stability: "havoda barqaror, Co³⁺ inert (d⁶, past spin)",
  crystalStructure: "Oktaedr — Co³⁺ markazida 3 ta en ligand (6 ta N donor, ichki sfera), 3 ta Cl⁻ tashqi sferada",
  ...
  wernerInfo: {
    ...
    wernerProof: "Verner va keyingi kimyogarlar konduktometrik o'lchashlar orqali 3 ta Cl⁻ ionining tashqi sferada ekanligini isbotladi. Λm ≈ 435 S·cm²/mol — bu 4 ta ion borligini ko'rsatadi (1:3 elektrolit). Xelat effekti tufayli [Co(en)₃]³⁺ [Co(NH₃)₆]³⁺ dan 10¹⁴ marta barqaror!"
  },

  historicalFact: {
    title: "Xelat effekti — Schwarzenbach kashfiyoti (1950-yillar)",
    text: "[Co(en)₃]Cl₃ — tris(etilendiamin)kobalt(III) kompleksi, xelat effektining klassik namunasi. Etilendiamin (en = H₂N-CH₂-CH₂-NH₂) bidentat ligand bo'lib, 2 ta N atomi orqali Co³⁺ ga bog'lanadi. 3 ta en ligandi 3 ta 5 a'zoli xelat halqa hosil qiladi.",
    textExtended: "Xelat effekti — bidentat ligandlar monodentat ligandlarga qaraganda 10¹⁴ marta barqarroq kompleks hosil qiladi. Sababi: entropiya ortishi. [Co(en)₃]³⁺ ning log β₃ ≈ 49, [Co(NH₃)₆]³⁺ ning log β₆ ≈ 35. Schwarzenbach bu effektni 1950-yillarda o'rgandi va kompleksometrik titrlashni rivojlantirdi. Bu kompleks Λ (lambda) va Δ (delta) optik izomerlariga ega — ular bir-birining ko'zgudagi aksi.",
    year: "1950-yillar (Schwarzenbach)"
  },

  interestingFacts: [
    {
      title: "Xelat effekti — 10¹⁴ marta barqarorlik",
      fact: "[Co(en)₃]³⁺ (log β₃ ≈ 49) [Co(NH₃)₆]³⁺ (log β₆ ≈ 35) dan 10¹⁴ marta barqaror. Sababi: entropiya ortishi — 3 ta en ligandi 6 ta NH₃ o'rnini egallaydi."
    },
    {
      title: "Λ va Δ enantiomerlar",
      fact: "[Co(en)₃]³⁺ ning ikkita optik izomeri mavjud: Λ (lambda) — chap qo'l spirali va Δ (delta) — o'ng qo'l spirali. Ular bir-birining ko'zgudagi aksi."
    },
    {
    ...
    },
    {
      ...
      fact: "Co³⁺ (d⁶, past spin) inert — ligand almashinishi juda sekin (kunlar-oylar). Bu [Co(en)₃]³⁺ ni kinetik inert qiladi."
    },
    {
      title: "Optik faollik",
      fact: "Λ-[Co(en)₃]³⁺ va Δ-[Co(en)₃]³⁺ optik faol — ular qutblangan yorug'likni turli yo'nalishda aylantiradi. Bu xelat komplekslarining muhim xususiyati."
    }
  ],

  conductometricFeature: {
    title: "[Co(en)₃]Cl₃ — 1:3 elektrolit, Λm ≈ 435 S·cm²/mol",
    description: "Bu kompleks konduktometriyada klassik namuna hisoblanadi. 3 ta Cl⁻ tashqi sferada — eritmada erkin harakatlanadi. 3 ta en ichki sferada — Co³⁺ ga bog'langan, erkin harakatlanmaydi.",
    reaction: {
      dissociation: "[Co(en)₃]Cl₃ → [Co(en)₃]³⁺ + 3Cl⁻",
      ions: "4 ion: 1 ta [Co(en)₃]³⁺ + 3 ta Cl⁻",
      electrolyteType: "1:3 elektrolit",
      lm_theoretical: "Λm ≈ 435 S·cm²/mol (25°C, 10⁻³ M)"
    },
    problem: {
      title: "Xelat effekti — juda barqaror kompleks",
      description: "3 ta en ichki sferada — Co³⁺ ga mustahkam bog'langan. Eritmada [Co(en)₃]³⁺ kationi butunligicha qoladi, parchalanmaydi.",
      impact: "Λm ≈ 435 S·cm²/mol — bu [Co(NH₃)₆]³⁺ (Λm ≈ 432) ga deyarli teng. Xelat effekti tufayli [Co(en)₃]³⁺ eritmada barqaror."
    },
    solution: {
      title: "Kohlrausch qonuni",
      description: "Kohlrausch qonuni bo'yicha: Λm° = λ₊ + λ₋. Bu yerda λ₊ = λ([Co(en)₃]³⁺), λ₋ = 3×λ(Cl⁻).",
      mechanism: "Λm° ≈ 435 S·cm²/mol = λ([Co(en)₃]³⁺) + 3×λ(Cl⁻). λ(Cl⁻) ≈ 76 S·cm²/mol bo'lsa, λ([Co(en)₃]³⁺) ≈ 435 - 3×76 = 207 S·cm²/mol."
    }
  },
  ...
  theoretical: {
    Co:  { mass: 58.933,  percent: 17.10, source: "Co³⁺ markaziy atom (ichki sfera)", conductSignal: "[Co(en)₃]³⁺ kationi — o'tkazuvchanlikka hissa qo'shadi" },
    C:   { mass: 72.066,  percent: 20.87, source: "3×en (6×C, ichki sfera)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" },
    H:   { mass: 24.192,  percent: 7.00,  source: "3×en (24×H, ichki sfera)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" },
    N:   { mass: 84.042,  percent: 24.34, source: "3×en (6×N, ichki sfera)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" },
    Cl:  { mass: 106.350, percent: 30.80, source: "3×Cl⁻ (tashqi sfera, ion)", conductSignal: "3 ta Cl⁻ anioni — o'tkazuvchanlikka hissa qo'shadi" }
  },
  ...
  conductometricData: [
    ...
    { conc: 0.005, lm: 422, kappa: 0.211, event: "O'rta konsentratsiya", theoryNote: "Λm kamayadi — ion-ion o'zaro ta'siri" },
  ...
  solventData: [
    { solvent: "Suv (H₂O)", dielectric: 78.5, lm: 435, kappa: 0.0435, color: "sariq", note: "Standart erituvchi — eng yuqori o'tkazuvchanlik" },
  ...
  temperatureData: [
    ...
    { temp: 30, lm: 448, kappa: 0.0448, note: "Yuqori temperatura — ko'proq o'tkazuvchanlik" },
    { temp: 40, lm: 472, kappa: 0.0472, note: "Yuqori temperatura" },
    { temp: 50, lm: 498, kappa: 0.0498, note: "Juda yuqori temperatura" }
  ],
  ...
  experimentalRuns: [
    { 
      ...
      theoryNote: "Standart sharoitda Λm ≈ 435 S·cm²/mol — bu 1:3 elektrolit uchun tipik qiymat. Xelat effekti tufayli barqaror."
    },
    { 
      id: "COND-24-002", 
      date: "2026-05-15", 
      ...
      theoryNote: "Takrorlanish — natijalar bir xil (Λm ≈ 436 S·cm²/mol)."
    },
    { 
      id: "COND-24-003", 
      date: "2026-05-16", 
    ...
    { 
      ...
      ions: 4, 
      type: "1:3 elektrolit",
      note: "Λ-[Co(en)₃]Cl₃ — optik izomer (lambda)",
      theoryNote: "Λ-izomer — optik faol, qutblangan yorug'likni chapga aylantiradi."
    },
    { 
      id: "COND-24-006", 
      date: "2026-05-17", 
      ...
      ions: 4, 
      type: "1:3 elektrolit",
      note: "Δ-[Co(en)₃]Cl₃ — optik izomer (delta)",
      theoryNote: "Δ-izomer — optik faol, qutblangan yorug'likni o'ngga aylantiradi. Λm bir xil!"
    },
    { 
      id: "COND-24-007", 
      date: "2026-05-18", 
  ...
  samplePrepSteps: [
    { step: 1, title: "⚠ Xavfsizlik choralari", desc: "[Co(en)₃]Cl₃ zaharli emas, lekin Co³⁺ zaharli. Qo'lqop, himoya ko'zoynaklari va laboratoriya xalati majburiy. Ventilyatsiya zarur!", time: "doimiy", critical: true },
    ...
    { step: 4, title: "Eritma tayyorlash (10⁻³ M)", desc: "Analitik tarozida 34.53 mg [Co(en)₃]Cl₃ tortilib, 100 mL o'lchov kolbasiga solinadi. 50 mL deionizatsiyalangan suv qo'shib, eritiladi.", time: "5 daq", critical: true },
    ...
    { step: 8, title: "Λm hisoblash", desc: "Λm = (κ × 1000) / c hisoblanadi. Natija ≈ 435 S·cm²/mol bo'lishi kerak.", time: "2 daq", critical: false },
  ...
  relatedMethods: [
    ...
    },
    {
      ...
      role: "Kristall strukturani aniqlaydi (Λ/Δ enantiomerlar)",
    ...
    },
    {
      ...
      role: "Λ/Δ enantiomerlarni farqlaydi",
...
export default function CoEn3Cl3ConductometricPage() {
  ...
  const [calcKappa, setCalcKappa] = useState(0.0435)
  const [calcConc, setCalcConc] = useState(0.001)
  
  const [calcLambdaPlus, setCalcLambdaPlus] = useState(207)
    ...
    <main className="min-h-screen bg-gradient-to-b from-purple-950 via-pink-950/20 to-blue-950 text-white">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4">
          <div className="bg-gradient-to-br from-pink-950 to-purple-950 border-2 border-pink-500 rounded-2xl p-6 max-w-3xl w-full animate-pulse">
            ...
            <p className="text-purple-200 text-sm mb-4">
              <strong className="text-pink-300">[Co(en)₃]Cl₃</strong> — xelat effektining klassik namunasi. 
              3 ta en bidentat ligand — 3 ta 5 a'zoli xelat halqa!
            </p>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <div className="text-purple-200">
                    <strong>3 ta en (6 ta N donor)</strong> — Co³⁺ ga mustahkam bog'langan.
                  </div>
                  <div className="text-purple-200 mt-2">
                    <strong>Sariq rang</strong> — xelat effekt tufayli.
                  </div>
                </div>
                <div>
                  ...
                  <div className="text-purple-200 mt-2">
                    <strong>Λm ≈ 435 S·cm²/mol</strong> — 1:3 elektrolit!
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-pink-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-pink-300">Xelat effekti:</strong> [Co(en)₃]³⁺ (log β₃ ≈ 49) [Co(NH₃)₆]³⁺ (log β₆ ≈ 35) dan <strong>10¹⁴ marta barqaror</strong>!
              </p>
            </div>

            <div className="bg-pink-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-pink-300">Λ va Δ enantiomerlar:</strong> Bu kompleksning ikkita optik izomeri mavjud — ular bir-birining ko'zgudagi aksi.
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-4">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  ...
                  <span className="px-2 py-1 rounded bg-yellow-900/30 border border-yellow-700/50 text-yellow-400 text-[10px] uppercase tracking-wide">Λm ≈ 435</span>
                  <span className="px-2 py-1 rounded bg-blue-900/30 border border-blue-700/50 text-blue-400 text-[10px] uppercase tracking-wide">Xelat effekt</span>
                </div>
              </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-purple-200">
            <div className="space-y-3">
              <p className="leading-relaxed">
                <strong className="text-white">[Co(en)₃]Cl₃</strong> — xelat effektining klassik namunasi. Termik tahlilda <strong className="text-pink-300">1:3 elektrolit</strong> — 4 ta ion borligini ko'rsatadi.
              </p>
              <ul className="list-disc list-inside space-y-2 marker:text-pink-500 text-xs md:text-sm">
                ...
                <li><strong className="text-white">3 ta en (bidentat)</strong> ichki sferada</li>
                <li><strong className="text-pink-300">3 ta Cl⁻</strong> tashqi sferada (erkin ionlar)</li>
                <li><strong className="text-pink-300">Λm ≈ 435 S·cm²/mol</strong> — 1:3 elektrolit</li>
                <li><strong className="text-pink-300">4 ta ion</strong> — 1 ta [Co(en)₃]³⁺ + 3 ta Cl⁻</li>
                <li><strong className="text-pink-300">Diamagnit</strong> — μ = 0 BM</li>
                <li><strong className="text-pink-300">Λ va Δ</strong> optik izomerlar</li>
              </ul>
            </div>
        ...
        <div className="bg-gradient-to-r from-pink-900/40 to-red-900/40 border-2 border-pink-700/70 rounded-2xl p-6">
          ...
          <div className="bg-purple-950/60 rounded-lg p-4 mb-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
              ...
              <div className="bg-pink-900/30 rounded p-3">
                <p className="text-pink-400 font-bold text-lg">4 ion</p>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-4">
            [Co(en)₃]Cl₃ uchun nazariy tarkib. Co³⁺ markaziy atom, 3 ta en ichki sferada, 3 ta Cl⁻ tashqi sferada.
          </p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-purple-200">
                ...
                <tr className="bg-pink-900/20 font-bold border-t border-pink-500/30">
                  ...
                  <td colSpan={2} className="py-3 text-[10px] text-pink-300">Konduktometriya: 1 ta [Co(en)₃]³⁺ + 3 ta Cl⁻ = 4 ion</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-sm text-purple-200 mb-5 leading-relaxed">
            [Co(en)₃]Cl₃ uchun standart konduktometrik tahlil sharoitlari.
          </p>
        ...
        <div className="bg-blue-900/20 border border-blue-500/30 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
              <label className="block text-xs text-purple-400 mb-1">λ₊ = λ([Co(en)₃]³⁺) (S·cm²/mol):</label>
              <input
                type="number"
                step="1"
        ...
        <div className="bg-gradient-to-r from-pink-900/40 to-purple-900/40 border border-pink-700/50 rounded-2xl p-8">
          ...
          <div className="mt-5 bg-pink-900/20 border border-pink-700/30 rounded-xl p-4">
            ...
            <p className="text-xs text-purple-200 leading-relaxed">
              <strong className="text-white">Konduktometriya (Λm, ionlar soni) + ICP (Co, Cl miqdori) + UV-Vis (rang) + XRD (struktura) + EA (C, H, N) + Qutblanish (Λ/Δ)</strong> — oltita metod birgalikda [Co(en)₃]Cl₃ ni to'liq tavsiflaydi va optik izomerlarni aniqlaydi.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-900/30 via-indigo-900/30 to-purple-900/30 border border-green-700/30 rounded-2xl p-6">
          ...
          <ol className="space-y-2 text-purple-200 list-decimal list-inside">
            ...
            <li>Λ/Δ enantiomerlar — <strong className="text-pink-300">optik faol kompleks</strong></li>
          </ol>
        </div>
      ...
      <footer className="border-t border-purple-800/30 py-6 mt-6">
        <div className="max-w-6xl mx-auto px-4 text-center text-xs text-purple-500">
          <p>© 2026 Koordinatsion kimyo tahlil portali • [Co(en)₃]Cl₃ • Konduktometrik tahlil moduli</p>
          <p className="mt-1">Manbalar: Vogel's Quantitative Chemical Analysis, Bard & Faulkner, Werner (1893), Schwarzenbach (1950)</p>
        </div>
      </footer>
    </main>
  )
