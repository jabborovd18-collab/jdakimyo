...
// Xususiyat: Sisplatin, NOELEKTROLIT, 0 ion, kvadrat-tekis
// O'ziga xoslik: Saraton dori (1978 FDA), cis-izomer, Rosenberg 1965
...
const COMPOUND = {
  ...
  color: "sariq (cis) / och sariq (trans)",
  stability: "havoda barqaror, Pt²⁺ juda inert (d⁸, past spin)",
  crystalStructure: "Kvadrat-tekis — Pt²⁺ markazida 2 ta NH₃ + 2 ta Cl⁻ (barchasi ichki sferada)",
  coordinationNumber: "4 (kvadrat-tekis)",
  spinState: "Past spin (d⁸) — diamagnit (0 toq elektron)",
  magneticMoment: "μ = 0 BM (diamagnit)",
  
  wernerInfo: {
    wernerGroup: "Noelektrolit guruhi",
    electrolyteType: "Noelektrolit",
    ions: 0,
    lm: 0,
    formula_verner: "[Pt(NH₃)₂Cl₂]⁰ (neytral)",
    wernerProof: "Verner va keyingi kimyogarlar konduktometrik o'lchashlar orqali hech qanday ion tashqi sferada emasligini isbotladi. Λm ≈ 0 S·cm²/mol — bu noelektrolit ekanligini ko'rsatadi. Barcha 2 ta NH₃ va 2 ta Cl⁻ ichki sferada — Pt²⁺ ga bog'langan."
  },

  historicalFact: {
    title: "Sisplatin — saraton kasalligiga qarshi dori (1965-1978)",
    text: "[Pt(NH₃)₂Cl₂] — sisplatin, saraton kasalligiga qarshi eng muhim dori vositasi. 1965-yilda Barnett Rosenberg (Michigan universiteti) E. coli bakteriyalarining bo'linishi platina elektrodlar ta'sirida to'xtashini kashf qildi.",
    textExtended: "Rosenberg tajribalarida platina elektrodlaridan hosil bo'lgan sisplatin bakteriyalar bo'linishini to'xtatdi. 1978-yilda FDA sisplatinni saraton kasalligiga qarshi dori sifatida tasdiqladi. Sisplatin DNK bilan bog'lanib, hujayra bo'linishini to'xtatadi. Cis-izomer (2 ta Cl⁻ bir tomonda, 90° burchakda) faol, trans-izomer (2 ta Cl⁻ qarama-qarshi, 180° burchakda) faol emas. Bu geometrik izomerlarning biologik faolligi farqining klassik namunasi."
  },

  interestingFacts: [
    {
      title: "Sisplatin — saraton dori",
      fact: "Sisplatin 1978-yilda FDA tomonidan saraton kasalligiga qarshi dori sifatida tasdiqlangan. Bu birinchi platina asosidagi saraton dori."
    },
    {
      title: "Cis vs trans izomerlar",
      fact: "Cis-[Pt(NH₃)₂Cl₂] (2 ta Cl⁻ 90° burchakda) faol, trans-[Pt(NH₃)₂Cl₂] (2 ta Cl⁻ 180° burchakda) faol emas. Bu geometrik izomerlarning biologik faolligi farqi."
    },
    {
      title: "DNK bilan bog'lanish",
      fact: "Sisplatin DNK ning N7 atomlari bilan bog'lanib, DNK spiralini buzadi va hujayra bo'linishini to'xtatadi."
    },
    {
      title: "Noelektrolit — 0 ion",
      fact: "[Pt(NH₃)₂Cl₂] noelektrolit — eritmada ionlarga dissotsiatsiyalanmaydi. Λm ≈ 0 S·cm²/mol. Barcha ligandlar ichki sferada."
    },
    {
      title: "Kvadrat-tekis geometriya",
      fact: "Pt²⁺ (d⁸, past spin) kvadrat-tekis geometriyaga ega. 2 ta NH₃ va 2 ta Cl⁻ bir tekislikda joylashgan."
    }
  ],

  conductometricFeature: {
    title: "[Pt(NH₃)₂Cl₂] — Noelektrolit, Λm ≈ 0 S·cm²/mol",
    description: "Bu kompleks konduktometriyada klassik noelektrolit namuna hisoblanadi. Barcha 2 ta NH₃ va 2 ta Cl⁻ ichki sferada — Pt²⁺ ga bog'langan, erkin harakatlanmaydi. Eritmada ionlarga dissotsiatsiyalanmaydi.",
    reaction: {
      dissociation: "[Pt(NH₃)₂Cl₂] → [Pt(NH₃)₂Cl₂] (dissotsiatsiyalanmaydi)",
      ions: "0 ion — noelektrolit",
      electrolyteType: "Noelektrolit",
      lm_theoretical: "Λm ≈ 0 S·cm²/mol (25°C, 10⁻³ M)"
    },
    problem: {
      title: "Noelektrolit — nol o'tkazuvchanlik",
      description: "Barcha 2 ta NH₃ va 2 ta Cl⁻ ichki sferada — Pt²⁺ ga mustahkam bog'langan. Eritmada ionlarga dissotsiatsiyalanmaydi.",
      impact: "Λm ≈ 0 S·cm²/mol — bu noelektrolit uchun tipik qiymat. [Co(NH₃)₃Cl₃] (Λm ≈ 0) ga o'xshash."
    },
    solution: {
  ...
  theoretical: {
    Pt:  { mass: 195.08,  percent: 65.02, source: "Pt²⁺ markaziy atom (ichki sfera)", conductSignal: "[Pt(NH₃)₂Cl₂] — o'tkazuvchanlikka hissa qo'shmaydi" },
    N:   { mass: 28.014,  percent: 9.34,  source: "2×NH₃ (2×N, ichki sfera)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" },
    H:   { mass: 6.048,   percent: 2.02,  source: "2×NH₃ (6×H, ichki sfera)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" },
    Cl:  { mass: 70.900,  percent: 23.63, source: "2×Cl⁻ (ichki sfera, Pt²⁺ ga bog'langan)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" }
  },

  conductometricData: [
    { conc: 0.0001, lm: 2, kappa: 0.00020, event: "Juda suyultirilgan", theoryNote: "Cheksiz suyultirishda ham Λm ≈ 0 — noelektrolit" },
  ...
  solventData: [
    { solvent: "Suv (H₂O)", dielectric: 78.5, lm: 1, kappa: 0.001, color: "sariq", note: "Standart erituvchi — Λm ≈ 0 (noelektrolit)" },
    { solvent: "Metanol (CH₃OH)", dielectric: 32.7, lm: 0.8, kappa: 0.0008, color: "sariq", note: "Kamroq dielektrik — Λm ≈ 0" },
    { solvent: "Etanol (C₂H₅OH)", dielectric: 24.3, lm: 0.5, kappa: 0.0005, color: "sariq", note: "Yanada kamroq dielektrik" },
    { solvent: "DMF (Dimetilformamid)", dielectric: 36.7, lm: 0.7, kappa: 0.0007, color: "sariq", note: "Qutbli organik erituvchi" },
    { solvent: "CH₃CN (Asetonitril)", dielectric: 37.5, lm: 0.6, kappa: 0.0006, color: "sariq", note: "Qutbli organik erituvchi" },
    { solvent: "Aseton ((CH₃)₂CO)", dielectric: 20.7, lm: 0.3, kappa: 0.0003, color: "sariq", note: "Kam qutbli — Λm ≈ 0" }
  ],
  ...
  temperatureData: [
    ...
    { temp: 40, lm: 1.3, kappa: 0.0013, note: "Yuqori temperatura — Λm ≈ 0" },
  ...
  experimentalRuns: [
    ...
    { 
      ...
      theoryNote: "Yuqori konsentratsiyada ham Λm ≈ 0 — noelektrolit."
    },
    { 
      id: "COND-24-004", 
      date: "2026-11-16", 
    ...
    { 
      ...
      ions: 0, 
      type: "Noelektrolit",
      note: "Cis-izomer (saraton dori)",
      theoryNote: "Cis-izomer — 2 ta Cl⁻ 90° burchakda. Bu saraton kasalligiga qarshi faol izomer."
    },
    { 
      id: "COND-24-006", 
      date: "2026-11-17", 
      ...
      ions: 0, 
      type: "Noelektrolit",
      note: "Trans-izomer (faol emas)",
      theoryNote: "Trans-izomer — 2 ta Cl⁻ 180° burchakda. Bu saraton kasalligiga qarshi faol EMAS. Λm bir xil!"
    },
    { 
      id: "COND-24-007", 
      date: "2026-11-18", 
  ...
  samplePrepSteps: [
    ...
    { step: 4, title: "Eritma tayyorlash (10⁻³ M)", desc: "Analitik tarozida 30.01 mg [Pt(NH₃)₂Cl₂] tortilib, 100 mL o'lchov kolbasiga solinadi. 50 mL deionizatsiyalangan suv qo'shib, eritiladi.", time: "5 daq", critical: true },
  ...
  relatedMethods: [
    ...
    },
    {
      ...
      role: "Kompleks rangini va konsentratsiyani aniqlaydi (301 nm)",
    ...
    },
    {
      ...
      role: "Kristall strukturani aniqlaydi (cis/trans farqi)",
    ...
    {
      name: "Biologik testlar",
      role: "Saraton hujayralariga ta'sirini tekshiradi",
      condAdvantage: "Biologik testlar saraton dori faolligini, konduktometriya ionlar sonini aniqlaydi",
      condDisadvantage: "Birgalikda to'liq tahlil",
      complementarity: "90%"
    }
  ]
    ...
    <main className="min-h-screen bg-gradient-to-b from-purple-950 via-orange-950/20 to-blue-950 text-white">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4">
          <div className="bg-gradient-to-br from-orange-950 to-purple-950 border-2 border-orange-500 rounded-2xl p-6 max-w-3xl w-full animate-pulse">
            <h3 className="text-xl font-bold text-orange-400 mb-4 flex items-center gap-2">
              <span className="text-3xl">⚠️</span> SISPLATIN — SARATON DORI!
            </h3>
            <p className="text-purple-200 text-sm mb-4">
              <strong className="text-orange-300">[Pt(NH₃)₂Cl₂]</strong> — sisplatin, saraton kasalligiga qarshi eng muhim dori. 
              Barcha ligandlar ichki sferada — NOELEKTROLIT!
            </p>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <div className="text-purple-200">
                    <strong>2 ta NH₃ + 2 ta Cl⁻</strong> — Pt²⁺ ga mustahkam bog'langan.
                  </div>
                  <div className="text-purple-200 mt-2">
                    <strong>Sariq rang</strong> — kvadrat-tekis geometriya.
                  </div>
                </div>
                <div>
            ...
            <div className="bg-orange-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-orange-300">Cis vs trans:</strong> Cis-izomer (2 ta Cl⁻ 90° burchakda) saraton dori sifatida faol. Trans-izomer (2 ta Cl⁻ 180° burchakda) faol emas.
              </p>
            </div>

            <div className="bg-orange-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-orange-300">XAVF:</strong> Sisplatin ZAHARLI — saraton dori! Qo'lqop va himoya ko'zoynaklari majburiy!
              </p>
            </div>
        ...
        <header className="border-b border-purple-800/50 sticky top-0 z-40 bg-purple-950/95 backdrop-blur-md">
          <div className="max-w-6xl mx-auto px-4 py-4">
            <nav className="flex items-center gap-2 text-xs mb-2 text-purple-400 flex-wrap">
              ...
              <span className="text-purple-600">›</span>
              <span className="text-orange-400 font-semibold">[Pt(NH₃)₂Cl₂]</span>
            </nav>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-4">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  <span className="px-2 py-1 rounded bg-orange-900/30 border border-orange-700/50 text-orange-400 text-[10px] uppercase tracking-wide">Noelektrolit</span>
                  ...
                  <span className="px-2 py-1 rounded bg-blue-900/30 border border-blue-700/50 text-blue-400 text-[10px] uppercase tracking-wide">Saraton dori</span>
                </div>
              </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-purple-200">
            <div className="space-y-3">
              <p className="leading-relaxed">
                <strong className="text-white">[Pt(NH₃)₂Cl₂]</strong> — sisplatin, saraton kasalligiga qarshi eng muhim dori. Termik tahlilda <strong className="text-orange-300">noelektrolit</strong> — 0 ta ion borligini ko'rsatadi.
              </p>
              <ul className="list-disc list-inside space-y-2 marker:text-orange-500 text-xs md:text-sm">
                ...
                <li><strong className="text-white">2 ta NH₃ + 2 ta Cl⁻</strong> barchasi ichki sferada</li>
                <li><strong className="text-orange-300">Hech qanday ion</strong> tashqi sferada yo'q</li>
                <li><strong className="text-orange-300">Λm ≈ 0 S·cm²/mol</strong> — noelektrolit</li>
                <li><strong className="text-orange-300">0 ta ion</strong> — dissotsiatsiyalanmaydi</li>
                <li><strong className="text-orange-300">Diamagnit</strong> — μ = 0 BM (0 toq elektron)</li>
                <li><strong className="text-orange-300">Saraton dori</strong> — 1978 FDA</li>
              </ul>
            </div>
          ...
          <div className="bg-purple-950/60 rounded-lg p-4 mb-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
              <div className="bg-orange-900/30 rounded p-3">
                <p className="text-orange-400 font-bold text-lg">{COMPOUND.conductometricFeature.reaction.ions}</p>
              ...
              <div className="bg-orange-900/30 rounded p-3">
                <p className="text-orange-400 font-bold text-lg">{COMPOUND.conductometricFeature.reaction.lm_theoretical}</p>
                <p className="text-purple-300 text-xs mt-1">Λm (25°C, 10⁻³ M)</p>
              </div>
              <div className="bg-orange-900/30 rounded p-3">
                <p className="text-orange-400 font-bold text-lg">0 ion</p>
                <p className="text-purple-300 text-xs mt-1">Ionlar soni</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-4">
            [Pt(NH₃)₂Cl₂] uchun nazariy tarkib. Pt²⁺ markaziy atom, barcha ligandlar ichki sferada.
          </p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-purple-200">
                {Object.entries(COMPOUND.theoretical).map(([el, d]) => {
                  const elColor = el === "Pt" ? "text-orange-400" : "text-purple-400"
                  return (
                ...
                <tr className="bg-orange-900/20 font-bold border-t border-orange-500/30">
                  ...
                  <td colSpan={2} className="py-3 text-[10px] text-orange-300">Konduktometriya: 0 ion — noelektrolit</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-8">
          ...
          <p className="text-purple-200 mb-4 leading-relaxed">
            Temperatura ortishi bilan Λm ≈ 0 (noelektrolit).
          </p>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-8">
          ...
          <div className="bg-purple-800/30 rounded-xl p-5 border border-purple-700/30 mb-4">
            ...
            <p className="text-purple-400 text-xs mt-3">
              * Verner bu ma'lumotlar asosida barcha ligandlar ichki sferada (kompleks bilan bog'langan) ekanligini ko'rsatgan.
            </p>
          </div>
        </div>
        ...
        <div className="bg-blue-900/20 border border-blue-500/30 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
              <label className="block text-xs text-purple-400 mb-1">λ₊ (kation) (S·cm²/mol):</label>
              <input
                type="number"
                step="1"
            ...
            <div>
              <label className="block text-xs text-purple-400 mb-1">λ₋ (anion) (S·cm²/mol):</label>
              <input
                type="number"
                step="1"
        ...
        <div className="bg-gradient-to-r from-orange-900/40 to-purple-900/40 border border-orange-700/50 rounded-2xl p-8">
          ...
          <div className="mt-5 bg-orange-900/20 border border-orange-700/30 rounded-xl p-4">
            ...
            <p className="text-xs text-purple-200 leading-relaxed">
              <strong className="text-white">Konduktometriya (Λm, ionlar soni) + ICP (Pt, Cl miqdori) + UV-Vis (301 nm) + XRD (cis/trans farqi) + EA (C, H, N) + Biologik testlar (saraton dori faolligi)</strong> — oltita metod birgalikda [Pt(NH₃)₂Cl₂] ni to'liq tavsiflaydi va saraton dori faolligini aniqlaydi.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-900/30 via-indigo-900/30 to-purple-900/30 border border-green-700/30 rounded-2xl p-6">
          ...
          <ol className="space-y-2 text-purple-200 list-decimal list-inside">
            ...
            <li>Sisplatin — <strong className="text-orange-300">saraton kasalligiga qarshi eng muhim dori</strong></li>
            <li>Molyar o'tkazuvchanlik Λm — <strong className="text-orange-300">ionlar soniga to'g'ri proporsional</strong></li>
            <li>Noelektrolit — <strong className="text-orange-300">0 ion, barcha ligandlar ichki sferada</strong></li>
      ...
      <footer className="border-t border-purple-800/30 py-6 mt-6">
        <div className="max-w-6xl mx-auto px-4 text-center text-xs text-purple-500">
          <p>© 2026 Koordinatsion kimyo tahlil portali • [Pt(NH₃)₂Cl₂] (Sisplatin) • Konduktometrik tahlil moduli</p>
          <p className="mt-1">Manbalar: Vogel's Quantitative Chemical Analysis, Bard & Faulkner, Rosenberg (1965, FDA 1978)</p>
        </div>
      </footer>
    </main>
  )
