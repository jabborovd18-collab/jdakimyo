...
// Xususiyat: Verner klassik qatori, 1:1 elektrolit, 2 ion
// O'ziga xoslik: Praseo tuzi, 2 ta ichki Cl⁻, 1 ta tashqi Cl⁻
...
const COMPOUND = {
  ...
  commonName: "Praseo-kobalt xlorid (yashil)",
  molarMass: 233.40,
  casNumber: "14878-43-8",
  color: "yashil (praseo = lotincha 'yashil')",
  stability: "havoda barqaror, Co³⁺ inert (d⁶, past spin)",
  crystalStructure: "Oktaedr — Co³⁺ markazida 4 ta NH₃ + 2 ta Cl⁻ (ichki sfera), 1 ta Cl⁻ tashqi sferada",
  ...
  wernerInfo: {
    ...
    wernerProof: "Verner 1893-yilda konduktometrik o'lchashlar orqali 1 ta Cl⁻ ionining tashqi sferada ekanligini isbotladi. Λm ≈ 250 S·cm²/mol — bu 2 ta ion borligini ko'rsatadi (1:1 elektrolit)."
  },

  historicalFact: {
    title: "Praseo tuzi — Verner nazariyasining uchinchi isboti",
    text: "[Co(NH₃)₄Cl₂]Cl — Alfred Verner koordinatsion nazariyasining uchinchi muhim namunasi. Bu kompleks yashil (praseo) rangli bo'lib, Verner Λm ni o'lchab, 2 ta ion borligini ko'rsatdi (1:1 elektrolit).",
    textExtended: "Praseo (lotincha 'yashil') nomi kompleksning rangini ko'rsatadi. Co³⁺ (d⁶) past spin konfiguratsiyaga ega — barcha 6 elektron t₂g orbitallarini to'ldiradi, shuning uchun diamagnit (μ = 0). Bu kompleks inert — ligand almashinishi juda sekin (kunlar-oylar). Verner bu kompleks orqali ichki sferada 2 ta Cl⁻ borligini isbotladi — 1 ta Cl⁻ tashqi sferada (AgNO₃ bilan cho'kadi), 2 ta Cl⁻ ichki sferada (cho'kmaydi). AgNO₃ qo'shilganda faqat 1 ta Cl⁻ cho'kadi (AgCl), 2 ta Cl⁻ ichki sferada qoladi.",
    year: "1893-yil (Nobel 1913)"
  },

  interestingFacts: [
    {
      title: "Luteo, Purpureo va Praseo farqi",
      fact: "Luteo (sariq) — [Co(NH₃)₆]Cl₃ (3 tashqi Cl⁻), Purpureo (binafsha) — [Co(NH₃)₅Cl]Cl₂ (2 tashqi Cl⁻), Praseo (yashil) — [Co(NH₃)₄Cl₂]Cl (1 tashqi Cl⁻)."
    },
    {
      title: "Verner tajribasi (1893)",
      fact: "AgNO₃ qo'shilganda praseo dan faqat 1 ta Cl⁻ cho'kadi (AgCl), 2 ta Cl⁻ ichki sferada qoladi. Bu Verner nazariyasining asosiy isboti."
    },
    {
    ...
    },
    {
      ...
      fact: "Λm° = λ₊ + λ₋ = λ([Co(NH₃)₄Cl₂]⁺) + λ(Cl⁻) ≈ 250 S·cm²/mol"
    },
    {
      title: "Geometrik izomerlar",
      fact: "[Co(NH₃)₄Cl₂]⁺ ning cis- va trans-izomerlari mavjud. Cis-izomer binafsha, trans-izomer yashil rangli."
    }
  ],

  conductometricFeature: {
    title: "[Co(NH₃)₄Cl₂]Cl — 1:1 elektrolit, Λm ≈ 250 S·cm²/mol",
    description: "Bu kompleks konduktometriyada klassik namuna hisoblanadi. 1 ta Cl⁻ tashqi sferada — eritmada erkin harakatlanadi. 4 ta NH₃ va 2 ta Cl⁻ ichki sferada — Co³⁺ ga bog'langan, erkin harakatlanmaydi.",
    reaction: {
      dissociation: "[Co(NH₃)₄Cl₂]Cl → [Co(NH₃)₄Cl₂]⁺ + Cl⁻",
      ions: "2 ion: 1 ta [Co(NH₃)₄Cl₂]⁺ + 1 ta Cl⁻",
      electrolyteType: "1:1 elektrolit",
      lm_theoretical: "Λm ≈ 250 S·cm²/mol (25°C, 10⁻³ M)"
    },
    problem: {
      title: "Past o'tkazuvchanlik — 2 ta ion",
      description: "1 ta Cl⁻ tashqi sferada — eritmada erkin harakatlanadi. 4 ta NH₃ va 2 ta Cl⁻ ichki sferada — Co³⁺ ga bog'langan, erkin harakatlanmaydi.",
      impact: "Λm ≈ 250 S·cm²/mol — bu 1:1 elektrolit uchun tipik qiymat. Verner bu qiymat orqali 1 ta Cl⁻ tashqi sferada ekanligini isbotladi."
    },
    solution: {
      title: "Kohlrausch qonuni",
      description: "Kohlrausch qonuni bo'yicha: Λm° = λ₊ + λ₋. Bu yerda λ₊ = λ([Co(NH₃)₄Cl₂]⁺), λ₋ = λ(Cl⁻).",
      mechanism: "Λm° ≈ 250 S·cm²/mol = λ([Co(NH₃)₄Cl₂]⁺) + λ(Cl⁻). λ(Cl⁻) ≈ 76 S·cm²/mol bo'lsa, λ([Co(NH₃)₄Cl₂]⁺) ≈ 250 - 76 = 174 S·cm²/mol."
    }
  },
  ...
  theoretical: {
    Co:  { mass: 58.933,  percent: 25.25, source: "Co³⁺ markaziy atom (ichki sfera)", conductSignal: "[Co(NH₃)₄Cl₂]⁺ kationi — o'tkazuvchanlikka hissa qo'shadi" },
    N:   { mass: 56.028,  percent: 24.00, source: "4×NH₃ (4×N, ichki sfera)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" },
    H:   { mass: 12.096,  percent: 5.18,  source: "4×NH₃ (12×H, ichki sfera)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" },
    Cl_inner: { mass: 70.900, percent: 30.38, source: "2×Cl⁻ (ichki sfera, Co³⁺ ga bog'langan)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" },
    Cl_outer: { mass: 35.450, percent: 15.19, source: "1×Cl⁻ (tashqi sfera, ion)", conductSignal: "1 ta Cl⁻ anioni — o'tkazuvchanlikka hissa qo'shadi" }
  },
  ...
  solventData: [
    { solvent: "Suv (H₂O)", dielectric: 78.5, lm: 250, kappa: 0.0250, color: "yashil", note: "Standart erituvchi — eng yuqori o'tkazuvchanlik" },
    { solvent: "Metanol (CH₃OH)", dielectric: 32.7, lm: 215, kappa: 0.0215, color: "yashil", note: "Kamroq dielektrik — kamroq dissotsiatsiya" },
    { solvent: "Etanol (C₂H₅OH)", dielectric: 24.3, lm: 180, kappa: 0.0180, color: "yashil", note: "Yanada kamroq dielektrik" },
    { solvent: "DMF (Dimetilformamid)", dielectric: 36.7, lm: 200, kappa: 0.0200, color: "yashil", note: "Qutbli organik erituvchi" },
    { solvent: "CH₃CN (Asetonitril)", dielectric: 37.5, lm: 205, kappa: 0.0205, color: "yashil", note: "Qutbli organik erituvchi" },
    { solvent: "Aseton ((CH₃)₂CO)", dielectric: 20.7, lm: 155, kappa: 0.0155, color: "yashil", note: "Kam qutbli — kam dissotsiatsiya" }
  ],
  ...
  experimentalRuns: [
    { 
      ...
      theoryNote: "Standart sharoitda Λm ≈ 250 S·cm²/mol — bu 1:1 elektrolit uchun tipik qiymat."
    },
    { 
      id: "COND-24-002", 
      date: "2026-03-15", 
    ...
    { 
      ...
      theoryNote: "Tozalangan elektrod — eng aniq natija (Λm ≈ 250 S·cm²/mol)."
    },
    { 
      id: "COND-24-006", 
      date: "2026-03-17", 
  ...
  samplePrepSteps: [
    ...
    { step: 4, title: "Eritma tayyorlash (10⁻³ M)", desc: "Analitik tarozida 23.34 mg [Co(NH₃)₄Cl₂]Cl tortilib, 100 mL o'lchov kolbasiga solinadi. 50 mL deionizatsiyalangan suv qo'shib, eritiladi.", time: "5 daq", critical: true },
...
export default function CoNH34Cl2ClConductometricPage() {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4">
          <div className="bg-gradient-to-br from-green-950 to-purple-950 border-2 border-green-500 rounded-2xl p-6 max-w-3xl w-full animate-pulse">
            <h3 className="text-xl font-bold text-green-400 mb-4 flex items-center gap-2">
              <span className="text-3xl">⚠️</span> VERNER NAZARIYASI — 1:1 ELEKTROLIT!
            </h3>
            <p className="text-purple-200 text-sm mb-4">
              <strong className="text-green-300">[Co(NH₃)₄Cl₂]Cl</strong> — praseo tuzi, Verner nazariyasining uchinchi isboti. 
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <div className="text-purple-200">
                    <strong>4 ta NH₃ + 2 ta Cl⁻</strong> — Co³⁺ ga bog'langan.
                  </div>
                  <div className="text-purple-200 mt-2">
                    <strong>Yashil rang</strong> — praseo (lotincha).
                  </div>
                </div>
                <div>
            ...
            <div className="bg-green-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-green-300">Verner isboti (Nobel 1913):</strong> Λm ≈ 250 S·cm²/mol — bu 2 ta ion borligini ko'rsatadi. 
                1 ta [Co(NH₃)₄Cl₂]⁺ + 1 ta Cl⁻ = 2 ion.
              </p>
            </div>

            <div className="bg-green-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-green-300">Qiziqarli fakt:</strong> AgNO₃ qo'shilganda faqat 1 ta Cl⁻ cho'kadi (AgCl), 2 ta Cl⁻ ichki sferada qoladi. 
      ...
      <section className="max-w-6xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-purple-200">
            <div className="space-y-3">
              <p className="leading-relaxed">
                <strong className="text-white">[Co(NH₃)₄Cl₂]Cl</strong> — praseo tuzi, Verner nazariyasining uchinchi namunasi. Termik tahlilda <strong className="text-green-300">1:1 elektrolit</strong> — 2 ta ion borligini ko'rsatadi.
              </p>
              <ul className="list-disc list-inside space-y-2 marker:text-green-500 text-xs md:text-sm">
                ...
                <li><strong className="text-white">4 ta NH₃ + 2 ta Cl⁻</strong> ichki sferada</li>
                <li><strong className="text-green-300">1 ta Cl⁻</strong> tashqi sferada (erkin ion)</li>
                <li><strong className="text-green-300">Λm ≈ 250 S·cm²/mol</strong> — 1:1 elektrolit</li>
                <li><strong className="text-green-300">2 ta ion</strong> — 1 ta [Co(NH₃)₄Cl₂]⁺ + 1 ta Cl⁻</li>
                <li><strong className="text-green-300">Diamagnit</strong> — μ = 0 BM</li>
              </ul>
            </div>
        ...
        <div className="bg-gradient-to-r from-green-900/40 to-red-900/40 border-2 border-green-700/70 rounded-2xl p-6">
          ...
          <div className="bg-purple-950/60 rounded-lg p-4 mb-4">
            ...
            <div className="text-center text-2xl font-mono text-green-400 mb-3">
              {COMPOUND.conductometricFeature.reaction.dissociation}
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
              <div className="bg-green-900/30 rounded p-3">
                <p className="text-green-400 font-bold text-lg">{COMPOUND.conductometricFeature.reaction.ions.split(":")[0]}</p>
              ...
              <div className="bg-green-900/30 rounded p-3">
                <p className="text-green-400 font-bold text-lg">2 ion</p>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-4">
            [Co(NH₃)₄Cl₂]Cl uchun nazariy tarkib. Co³⁺ markaziy atom, 4 ta NH₃ + 2 ta Cl⁻ ichki sferada, 1 ta Cl⁻ tashqi sferada.
          </p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-purple-200">
                {Object.entries(COMPOUND.theoretical).map(([el, d]) => {
                  const elColor = el === "Co" ? "text-green-400" : el.includes("inner") ? "text-orange-400" : el.includes("outer") ? "text-yellow-400" : "text-purple-400"
                ...
                <tr className="bg-green-900/20 font-bold border-t border-green-500/30">
                  ...
                  <td colSpan={2} className="py-3 text-[10px] text-green-300">Konduktometriya: 1 ta [Co(NH₃)₄Cl₂]⁺ + 1 ta Cl⁻ = 2 ion</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-sm text-purple-200 mb-5 leading-relaxed">
            [Co(NH₃)₄Cl₂]Cl uchun standart konduktometrik tahlil sharoitlari.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
            <div className="bg-purple-950/60 p-3 rounded-xl border border-purple-700/30">
              ...
              <div className="text-sm font-bold text-green-400">{COMPOUND.conductometricParameters.cellConstant}</div>
            </div>
            <div className="bg-purple-950/60 p-3 rounded-xl border border-purple-700/30">
              <div className="text-[10px] text-purple-400 uppercase mb-1">Chastota</div>
              <div className="text-sm font-bold text-green-400">{COMPOUND.conductometricParameters.frequency}</div>
            </div>
            <div className="bg-purple-950/60 p-3 rounded-xl border border-purple-700/30">
              <div className="text-[10px] text-purple-400 uppercase mb-1">Harorat</div>
              <div className="text-sm font-bold text-green-400">{COMPOUND.conductometricParameters.temperature}</div>
            </div>
            <div className="bg-purple-950/60 p-3 rounded-xl border border-purple-700/30">
              <div className="text-[10px] text-purple-400 uppercase mb-1">Konsentratsiya</div>
              <div className="text-sm font-bold text-green-400">{COMPOUND.conductometricParameters.concentration}</div>
            </div>
            <div className="bg-purple-950/60 p-3 rounded-xl border border-purple-700/30">
              <div className="text-[10px] text-purple-400 uppercase mb-1">Erituvchi</div>
              <div className="text-sm font-bold text-green-400">{COMPOUND.conductometricParameters.solvent}</div>
            </div>
            <div className="bg-purple-950/60 p-3 rounded-xl border border-purple-700/30">
              <div className="text-[10px] text-purple-400 uppercase mb-1">O'lchash vaqti</div>
              <div className="text-sm font-bold text-green-400">{COMPOUND.conductometricParameters.measurementTime}</div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-purple-800/30 rounded-xl p-5 border border-purple-700/30 mb-6">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div>
                ...
                <div className="text-xl font-mono font-bold text-green-400">{currentConductometric.conc.toExponential(1)} M</div>
              </div>
              <div>
                <div className="text-xs text-purple-400">Λm:</div>
                <div className="text-xl font-mono font-bold text-green-400">{currentConductometric.lm.toFixed(1)} S·cm²/mol</div>
              </div>
              <div>
                <div className="text-xs text-purple-400">κ:</div>
                <div className="text-xl font-mono font-bold text-green-400">{(currentConductometric.kappa * 1000).toFixed(3)} mS/cm</div>
              </div>
            </div>
          ...
          <div className="bg-purple-800/30 rounded-xl p-5 border border-purple-700/30 mb-6">
            ...
            <div className="flex justify-between text-xs text-purple-400 mt-1">
              {COMPOUND.solventData.map((s, i) => (
                <span key={i} className={solventSlider === i ? "text-green-400 font-bold" : ""}>
                  {s.solvent.split(" ")[0]}
                </span>
              ))}
            </div>
          ...
          <div className="bg-purple-800/30 rounded-xl p-5 border border-purple-700/30 mb-6">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div>
                ...
                <div className="text-xl font-mono font-bold text-green-400">{COMPOUND.solventData[solventSlider].solvent}</div>
              </div>
              <div>
                <div className="text-xs text-purple-400">Dielektrik ε:</div>
                <div className="text-xl font-mono font-bold text-green-400">{COMPOUND.solventData[solventSlider].dielectric}</div>
              </div>
              <div>
                <div className="text-xs text-purple-400">Λm:</div>
                <div className="text-xl font-mono font-bold text-green-400">{COMPOUND.solventData[solventSlider].lm} S·cm²/mol</div>
              </div>
            </div>
          ...
          <div className="bg-purple-800/30 rounded-xl p-5 border border-purple-700/30 mb-6">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div>
                ...
                <div className="text-xl font-mono font-bold text-green-400">{currentTemperature.temp}°C</div>
              </div>
              <div>
                <div className="text-xs text-purple-400">Λm:</div>
                <div className="text-xl font-mono font-bold text-green-400">{currentTemperature.lm.toFixed(1)} S·cm²/mol</div>
              </div>
              <div>
                <div className="text-xs text-purple-400">κ:</div>
                <div className="text-xl font-mono font-bold text-green-400">{(currentTemperature.kappa * 1000).toFixed(3)} mS/cm</div>
              </div>
            </div>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-purple-700">
                    ...
                    <th className="py-3 px-4 text-green-300">Formulasi (Verner)</th>
                    <th className="py-3 px-4 text-green-300">Ionlar soni</th>
                    <th className="py-3 px-4 text-green-300">Λm (S·cm²/mol)</th>
                    <th className="py-3 px-4 text-green-300">Elektrolit turi</th>
                  </tr>
                </thead>
                <tbody className="text-purple-200">
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                    activeStep === i ? "bg-green-500 text-white" : "bg-purple-800 text-purple-400"
                  }`}>
                    {step.step}
                  </div>
          ...
          <div className="bg-purple-950/60 rounded-xl p-5 border border-purple-700/30">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div>
                ...
                <div className="text-xl font-mono font-bold text-green-400">{(run.kappa * 1000).toFixed(3)}</div>
              </div>
              <div>
                <div className="text-xs text-purple-400">Λm (S·cm²/mol):</div>
                <div className="text-xl font-mono font-bold text-green-400">{run.lm}</div>
              </div>
              <div>
        ...
        <div className="bg-green-900/20 border border-green-500/30 rounded-2xl p-8">
          ...
          <p className="text-xs text-purple-300 mb-5">
            κ va konsentratsiyani kiriting — <strong className="text-green-300">Λm</strong> va elektrolit turi aniqlanadi.
          </p>
          ...
          <div className="bg-purple-950/50 rounded-lg p-5 border border-purple-700/30">
            <div className="grid grid-cols-3 gap-4 mb-4">
              <div>
                ...
                <div className="text-xl font-mono font-bold text-green-400">{calcResult.lm} S·cm²/mol</div>
              </div>
              <div>
                <div className="text-xs text-purple-400">Elektrolit turi:</div>
              ...
              <div>
                <div className="text-xs text-purple-400">Ionlar soni:</div>
                <div className="text-xl font-mono font-bold text-green-400">{calcResult.ions}</div>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-green-900/30 via-indigo-900/30 to-purple-900/30 border border-green-700/30 rounded-2xl p-6">
          ...
          <ol className="space-y-2 text-purple-200 list-decimal list-inside">
            <li>Konduktometriya — <strong className="text-green-300">ionlar sonini aniqlashning eng oddiy va ishonchli usuli</strong></li>
            <li>Verner nazariyasini isbotlashda <strong className="text-green-300">tarixiy ahamiyatga ega</strong> (Nobel 1913)</li>
            <li>Molyar o'tkazuvchanlik Λm — <strong className="text-green-300">ionlar soniga to'g'ri proporsional</strong></li>
            <li>Tashqi va ichki sfera ionlarini <strong className="text-green-300">aniq farqlash</strong> imkonini beradi</li>
            <li>Kompleks sintezi, kinetikasi va izomer farqlash uchun <strong className="text-green-300">yordamchi, ammo muhim usul</strong></li>
          </ol>
        </div>
        ...
        <div className="flex justify-between pt-6">
          ...
          <Link href="/ilmiy/tahlil/konduktometriya/birikmalar" className="px-6 py-3 bg-green-700/80 rounded-xl hover:bg-green-600 text-white font-semibold">Barcha birikmalar →</Link>
        </div>
