...
// ═══════════════════════════════════════════════════════════════════════════════
// [Cu(phen)₃]²⁺ — SPEKTROFOTOMETRIK TITRLASH MAHSUS SAHIFASI (PREMIUM)
// Manbalar: Vogel's Quantitative Chemical Analysis, Skoog (Analytical Chemistry)
// Xususiyat: Tris(1,10-fenantrolin)mis(II), xelat effekti, qizil rang
// O'ziga xoslik: log β₃ = 16.7, qizil rang, 510 nm, MLCT o'tish
// Maqsad: Premium ilmiy sayt — barcha mayda detallar bilan
// ═══════════════════════════════════════════════════════════════════════════════

const ATOMIC_MASSES = {
  Cu: 63.546, C: 12.011, N: 14.007, H: 1.008, Cl: 35.450
}
...
const COMPOUND = {
  ...
  commonName: "Tris(1,10-fenantrolin)mis(II) (qizil)",
  molarMass: 536.99,
  casNumber: "14768-11-7",
  color: "qizil (red)",
  stability: "Yuqori barqarorlik (xelat effekti)",
  lambdaMax: 510,
  logBeta: 16.7,
  stox: "1:3",
  ...
  historicalFact: {
    title: "Tris(1,10-fenantrolin)mis(II) — xelat effekti namunasi",
    text: "[Cu(phen)₃]²⁺ — mis(II) ning tris(1,10-fenantrolin) kompleksi, xelat effektining klassik namunasi. 1,10-fenantrolin (phen) bidentat ligand — 2 ta N atomi orqali Cu²⁺ ga bog'lanadi.",
    textExtended: "3 ta phen ligandi 3 ta 5 a'zoli xelat halqa hosil qiladi. Cu²⁺ (d⁹) Jahn-Teller effekti tufayli oktaedr geometriya buziladi. Bu kompleks qizil rang beradi (λmax = 510 nm). log β₃ = 16.7 — yuqori barqarorlik, xelat effekti tufayli. [Cu(H₂O)₆]²⁺ dan 10¹⁰ marta barqaror. Bu kompleks analitik kimyoda mis miqdorini aniqlashda ishlatiladi."
  },

  interestingFacts: [
    {
      title: "Xelat effekti — 10¹⁰ marta barqarorlik",
      fact: "[Cu(phen)₃]²⁺ (log β₃ = 16.7) [Cu(H₂O)₆]²⁺ dan 10¹⁰ marta barqaror. Sababi: entropiya ortishi — 3 ta bidentat ligand 6 ta monodentat ligand o'rnini egallaydi."
    },
    {
      title: "Qizil rang — MLCT o'tish",
      fact: "[Cu(phen)₃]²⁺ qizil rang beradi (λmax = 510 nm). Bu metal-to-ligand charge transfer (MLCT) o'tish natijasida yuzaga keladi. Molyar yutilish koeffitsienti ε = 7800 M⁻¹cm⁻¹ — juda yuqori sezgirlik."
    },
    {
    ...
    },
    {
      ...
      fact: "A = ε·l·c — absorbsiya konsentratsiyaga to'g'ri proporsional. ε = 7800 M⁻¹cm⁻¹ — juda yuqori sezgirlik, past konsentratsiyalarda ham aniqlash mumkin."
    },
    {
    ...
    },
    {
      ...
      fact: "Cu²⁺ (d⁹) Jahn-Teller effekti tufayli oktaedr geometriya buziladi. 3 ta phen ligandi ekvatorial tekislikda joylashgan."
    }
  ],

  conductometricFeature: {
    title: "[Cu(phen)₃]²⁺ — 1:3 elektrolit, log β₃ = 16.7",
    description: "Bu kompleks spektrofotometrik titrlashda klassik namuna hisoblanadi. 3 ta phen ichki sferada — Cu²⁺ ga bog'langan. Xelat effekti tufayli yuqori barqaror.",
    reaction: {
      dissociation: "[Cu(phen)₃]²⁺ ⇌ Cu²⁺ + 3phen",
      ions: "Cu²⁺ + 3phen",
      electrolyteType: "1:3 elektrolit",
      lm_theoretical: "log β₃ = 16.7 (25°C)"
    },
    problem: {
      title: "Xelat effekti — yuqori barqarorlik",
      description: "log β₃ = 16.7 — yuqori barqarorlik. Kompleks yuqori barqaror va sekin parchalanadi.",
  ...
  theoretical: {
    Cu:  { mass: 63.546,  percent: 11.83, source: "Cu²⁺ markaziy atom (ichki sfera)", conductSignal: "[Cu(phen)₃]²⁺ kationi — o'tkazuvchanlikka hissa qo'shadi" },
    C:   { mass: 432.396, percent: 80.52, source: "3×phen (36×C, ichki sfera)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" },
    N:   { mass: 84.042,  percent: 15.65, source: "3×phen (6×N, ichki sfera)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" },
    H:   { mass: 24.192,  percent: 4.50,  source: "3×phen (24×H, ichki sfera)", conductSignal: "Ichki sferada — o'tkazuvchanlikka hissa qo'shmaydi" }
  },

  // Spektral ma'lumotlar — to'lqin uzunligi vs absorbsiya
  spectralData: [
    { wavelength: 350, absorbance: 0.12, event: "UV sohasi", theoryNote: "Past yutilish — UV sohasi" },
    { wavelength: 380, absorbance: 0.25, event: "UV-Vis chegarasi", theoryNote: "Yutilish boshlanadi" },
    { wavelength: 420, absorbance: 0.50, event: "Izosbestik nuqta", theoryNote: "Izosbestik nuqta — muvozanat ko'rsatkichi" },
    { wavelength: 450, absorbance: 0.70, event: "Ko'k-binafsha soha", theoryNote: "Yutilish ortadi" },
    { wavelength: 480, absorbance: 0.90, event: "Ko'k soha", theoryNote: "Maksimal yutilishga yaqin" },
    { wavelength: 510, absorbance: 1.10, event: "λmax — maksimal yutilish", theoryNote: "Maksimal yutilish — MLCT o'tish" },
    { wavelength: 540, absorbance: 0.95, event: "Yashil soha", theoryNote: "Yutilish kamayadi" },
    { wavelength: 580, absorbance: 0.70, event: "Sariq soha", theoryNote: "Yutilish kamayadi" },
    { wavelength: 620, absorbance: 0.45, event: "To'q sariq soha", theoryNote: "Past yutilish" },
    { wavelength: 650, absorbance: 0.28, event: "Qizil soha", theoryNote: "Past yutilish" },
    { wavelength: 700, absorbance: 0.15, event: "Infraqizil soha", theoryNote: "Juda past yutilish" },
  ...
  jobMethodData: [
    ...
    { xL: 0.2, absorbance: 0.24, corrected: 0.24, event: "Kam ligand", theoryNote: "Kompleks hosil bo'lishi boshlanadi" },
    { xL: 0.3, absorbance: 0.36, corrected: 0.36, event: "O'rta ligand", theoryNote: "Kompleks miqdori ortadi" },
    { xL: 0.4, absorbance: 0.48, corrected: 0.48, event: "O'rta ligand", theoryNote: "Kompleks miqdori ortadi" },
    { xL: 0.5, absorbance: 0.60, corrected: 0.60, event: "O'rta ligand", theoryNote: "Kompleks miqdori ortadi" },
    { xL: 0.6, absorbance: 0.70, corrected: 0.70, event: "O'rta ligand", theoryNote: "Kompleks miqdori ortadi" },
    { xL: 0.7, absorbance: 0.78, corrected: 0.78, event: "O'rta ligand", theoryNote: "Kompleks miqdori ortadi" },
    { xL: 0.75, absorbance: 0.82, corrected: 0.82, event: "1:3 stoxiometriya — MAKSIMUM", theoryNote: "MAKSIMUM — 1:3 stoxiometriya (ML₃)" },
    { xL: 0.8, absorbance: 0.78, corrected: 0.78, event: "Ortiqcha ligand", theoryNote: "Ligand ortiqcha — kompleks miqdori kamayadi" },
  ...
  stepwiseConstants: [
    { step: 1, reaction: "Cu²⁺ + phen ⇌ [Cu(phen)]²⁺", logK: 6.8, K: "6.31×10⁶", species: "[Cu(phen)]²⁺", color: "och qizil" },
    { step: 2, reaction: "[Cu(phen)]²⁺ + phen ⇌ [Cu(phen)₂]²⁺", logK: 5.4, K: "2.51×10⁵", species: "[Cu(phen)₂]²⁺", color: "qizil" },
    { step: 3, reaction: "[Cu(phen)₂]²⁺ + phen ⇌ [Cu(phen)₃]²⁺", logK: 4.5, K: "3.16×10⁴", species: "[Cu(phen)₃]²⁺", color: "to'q qizil" }
  ],
  ...
  experimentalRuns: [
    { 
      ...
      ions: 4, 
      type: "1:3 elektrolit",
      note: "Toza [Cu(phen)₃]²⁺ — standart sharoit",
      theoryNote: "Standart sharoitda A = 1.10, λmax = 510 nm. Bu [Cu(phen)₃]²⁺ ning qizil rangini ko'rsatadi."
    },
    { 
      id: "SPEC-24-002", 
      date: "2026-05-15", 
      ...
      theoryNote: "Takrorlanish — natijalar bir xil (A ≈ 1.11)."
    },
    { 
      id: "SPEC-24-003", 
      date: "2026-05-16", 
      ...
      theoryNote: "Beer-Lambert qonuni: A konsentratsiyaga proporsional. A ≈ 0.55."
    },
    { 
      id: "SPEC-24-004", 
      date: "2026-05-16", 
      ...
      theoryNote: "A ≈ 2.20 — Beer-Lambert qonuni bajariladi."
    },
    { 
      id: "SPEC-24-005", 
      date: "2026-05-17", 
  ...
  samplePrepSteps: [
    { step: 1, title: "⚠ Xavfsizlik choralari", desc: "[Cu(phen)₃]²⁺ zaharli, Cu²⁺ va phen zaharli. Qo'lqop, himoya ko'zoynaklari va laboratoriya xalati majburiy. Ventilyatsiya zarur! phen (1,10-fenantrolin) zaharli — teri va ko'zga zarar yetkazadi.", time: "doimiy", critical: true, theory: "Cu²⁺ ionlari teri va ko'zga zarar yetkazadi. phen (1,10-fenantrolin) zaharli — teri va ko'zga zarar yetkazadi." },
    { step: 2, title: "Kerakli asboblar", desc: "Analitik tarozi (0.1 mg aniqlik), 100 mL o'lchov kolbasi, spektrofotometr (UV-Vis), kyuvetalar (1 sm yo'l uzunligi), pipetka, deionizatsiyalangan suv, CuSO₄ eritmasi (0.001 M), phen eritmasi (0.003 M).", time: "5 daq", critical: true, theory: "Spektrofotometr 350-700 nm diapazonida ishlashi kerak. Kyuvetalar toza bo'lishi shart. Cu²⁺ va phen eritmalari aniq konsentratsiyada bo'lishi kerak." },
    ...
    { step: 5, title: "Job metodi uchun eritmalarni tayyorlash", desc: "10 ta eritma tayyorlanadi: [Cu²⁺] + [phen] = const = 10⁻³ M. xL = 0 dan 1 gacha o'zgartiriladi. Har bir eritma uchun 10 mL.", time: "15 daq", critical: true, theory: "Job metodi: umumiy konsentratsiya o'zgarmas. xL = [phen] / ([Cu²⁺] + [phen]). xL = 0.75 da maksimum bo'lishi kerak." },
    { step: 6, title: "Spektrofotometrik o'lchash", desc: "Har bir eritmaning UB-Vis spektri qayd etiladi (350-700 nm). λmax = 510 nm da absorbsiya o'lchanadi. Kyuvetalar toza bo'lishi shart.", time: "20 daq", critical: false, theory: "λmax = 510 nm — bu [Cu(phen)₃]²⁺ ning maksimal yutilish to'lqin uzunligi. ε = 7800 M⁻¹cm⁻¹ — juda yuqori sezgirlik." },
    ...
    { step: 8, title: "β₃ hisoblash (Benesi-Hildebrand)", desc: "Benesi-Hildebrand metodi yordamida β₃ hisoblanadi. 1/(A-A₀) vs 1/[phen] grafigi quriladi. log β₃ = 16.7.", time: "5 daq", critical: false, theory: "Benesi-Hildebrand: 1/(A-A₀) = 1/(ε·[Cu²⁺]·β₃) + 1/(ε·[Cu²⁺]·β₃·[phen]). Chiziqli grafik β₃ ni aniqlash imkonini beradi." },
  ...
  relatedMethods: [
    {
      ...
      condAdvantage: "Tez va aniq spektral ma'lumotlar, ε = 7800 M⁻¹cm⁻¹ — juda yuqori sezgirlik",
...
export default function CuPhen3SpectrophotometricPage() {
  ...
  // βn kalkulyatori
  const [betaValue, setBetaValue] = useState(16.7)
  ...
  const [absorbance, setAbsorbance] = useState(1.10)
    ...
    <main className="min-h-screen bg-gradient-to-b from-purple-950 via-red-950/20 to-blue-950 text-white">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4">
          <div className="bg-gradient-to-br from-red-950 to-purple-950 border-2 border-red-500 rounded-2xl p-6 max-w-3xl w-full animate-pulse">
            <h3 className="text-xl font-bold text-red-400 mb-4 flex items-center gap-2">
              <span className="text-3xl">📊</span> TRIS(1,10-FENANTROLIN)MIS(II) — XELAT EFFEKTİ!
            </h3>
            <p className="text-purple-200 text-sm mb-4">
              <strong className="text-red-300">[Cu(phen)₃]²⁺</strong> — tris(1,10-fenantrolin)mis(II), xelat effektining klassik namunasi. 
              Qizil rang, λmax = 510 nm, log β₃ = 16.7.
            </p>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <div className="text-purple-200">
                    <strong>Barqarorlik konstantasi (β₃)</strong> — log β₃ = 16.7.
                  </div>
            ...
            <div className="bg-red-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-red-300">Xelat effekti:</strong> log β₃ = 16.7 — yuqori barqarorlik. 
            ...
            <div className="bg-red-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-red-300">MLCT o'tish:</strong> λmax = 510 nm, ε = 7800 M⁻¹cm⁻¹. 
        ...
        <header className="border-b border-purple-800/50 sticky top-0 z-40 bg-purple-950/95 backdrop-blur-md">
          <div className="max-w-6xl mx-auto px-4 py-4">
            <nav className="flex items-center gap-2 text-xs mb-2 text-purple-400 flex-wrap">
              ...
              <span className="text-purple-600">›</span>
              <span className="text-red-400 font-semibold">[Cu(phen)₃]²⁺</span>
            </nav>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-4">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  ...
                  <span className="px-2 py-1 rounded bg-red-900/30 border border-red-700/50 text-red-400 text-[10px] uppercase tracking-wide">log β₃ = 16.7</span>
                  ...
                  <span className="px-2 py-1 rounded bg-green-900/30 border border-green-700/50 text-green-400 text-[10px] uppercase tracking-wide">ε = 7800</span>
                </div>
              </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-purple-200">
            <div className="space-y-3">
              <p className="leading-relaxed">
                <strong className="text-white">[Cu(phen)₃]²⁺</strong> — tris(1,10-fenantrolin)mis(II), xelat effektining klassik namunasi. Spektrofotometrik titrlashda <strong className="text-red-300">1:3 elektrolit</strong> — 4 ta ion borligini ko'rsatadi.
              </p>
              <ul className="list-disc list-inside space-y-2 marker:text-red-500 text-xs md:text-sm">
                <li><strong className="text-white">Cu²⁺ (d⁹)</strong> — oktaedr geometriya (Jahn-Teller effekti)</li>
                <li><strong className="text-white">3 ta phen</strong> ichki sferada (Cu²⁺ ga bog'langan)</li>
                <li><strong className="text-red-300">log β₃ = 16.7</strong> — yuqori barqarorlik</li>
                <li><strong className="text-red-300">λmax = 510 nm</strong> — qizil rang</li>
                <li><strong className="text-red-300">ε = 7800 M⁻¹cm⁻¹</strong> — juda yuqori sezgirlik</li>
                ...
                <li><strong className="text-red-300">Paramagnit</strong> — μ ≈ 1.9 BM (1 toq elektron)</li>
              </ul>
            </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-sm text-purple-200 mb-5 leading-relaxed">
            <strong className="text-red-400">Umumiy barqarorlik konstantasi (β₃)</strong> — Cu²⁺ ioniga 
            3 ta phen ligand birikishi natijasida hosil bo'lgan kompleksning termodinamik barqarorligini ifodalaydi.
            log β₃ = 16.7 — bu yuqori barqarorlikni ko'rsatadi, xelat effekti tufayli.
          </p>
          ...
          <div className="bg-purple-800/30 rounded-xl p-5 border border-purple-700/30 mb-4">
            ...
            <div className="space-y-3 text-sm text-purple-200">
              ...
              <div className="bg-red-600/10 border border-red-500/30 rounded-lg p-3">
                <p className="font-mono">β₃ = K₁ · K₂ · K₃ = 10^16.7</p>
        ...
        <div className="bg-red-900/20 border border-red-500/30 rounded-2xl p-8">
          ...
          <div className="bg-purple-950/50 rounded-lg p-5 border border-purple-700/30">
            ...
            <p className="text-xs text-purple-300 font-mono">
              Formula: xL = [phen] / ([Cu²⁺] + [phen]) = {ligandConc} / ({metalConc} + {ligandConc}) = {jobResult.xL}
            </p>
        ...
        <div className="bg-cyan-900/20 border border-cyan-500/30 rounded-2xl p-8">
          ...
          <div className="bg-purple-950/50 rounded-lg p-5 border border-purple-700/30">
            ...
            <p className="text-xs text-purple-300 font-mono">
              Formula: 1/(A-A₀) = 1/(ε·[Cu²⁺]·β₃) + 1/(ε·[Cu²⁺]·β₃·[phen])
            </p>
            <p className="text-xs text-purple-400 mt-2">
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-8">
          ...
          <p className="text-purple-200 mb-4 leading-relaxed">
            ...
            olingan spektrlarning <strong>kesishgan nuqtasi</strong>. [Cu(phen)₃]²⁺ uchun izosbestik nuqtalar: 420, 510 nm.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-yellow-600/10 border border-yellow-500/30 rounded-xl p-5">
              ...
              <p className="text-purple-200 text-sm">
                <strong>[Cu(phen)]²⁺, [Cu(phen)₂]²⁺, [Cu(phen)₃]²⁺</strong> — bir nechta kompleks shakllari muvozanatda.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-red-900/40 to-purple-900/40 border border-red-700/50 rounded-2xl p-8">
          ...
          <div className="mt-5 bg-red-900/20 border border-red-700/30 rounded-xl p-4">
            ...
            <p className="text-xs text-purple-200 leading-relaxed">
              <strong className="text-white">Spektrofotometrik titrlash (β₃, stoxiometriya) + UV-Vis (spektrlar) + EPR (paramagnit Cu²⁺) + EXAFS (mahalliy struktura) + Kalorimetriya (ΔH, ΔS)</strong> — besh metod birgalikda [Cu(phen)₃]²⁺ ni to'liq tavsiflaydi.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-red-600/10 to-purple-600/10 border border-red-500/20 rounded-2xl p-8">
          ...
          <ol className="space-y-2 text-purple-200 list-decimal list-inside">
            ...
            <li>Umumiy barqarorlik konstantasi β₃ — <strong className="text-red-400">log β₃ = 16.7</strong> (yuqori barqarorlik)</li>
            ...
            <li>MLCT o'tish — <strong className="text-red-400">λmax = 510 nm, ε = 7800 M⁻¹cm⁻¹</strong></li>
            <li>Paramagnit — <strong className="text-red-400">μ ≈ 1.9 BM (1 toq elektron)</strong></li>
          </ol>
        </div>
      ...
      <footer className="border-t border-purple-800/30 py-6 mt-6">
        <div className="max-w-6xl mx-auto px-4 text-center text-xs text-purple-500">
          <p>© 2026 Koordinatsion kimyo tahlil portali • [Cu(phen)₃]²⁺ • Spektrofotometrik titrlash moduli</p>
