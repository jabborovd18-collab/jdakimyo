...
const CRYSTAL = {
  ...
  molarMass: "141.94 g·mol⁻¹ (ioni), 176.94 g·mol⁻¹ (NO₃⁻ tuzi)",
  oxidationState: "Ag(I), d¹⁰ (S = 0)",
  coordinationGeom: "Chiziqli (D∞h)",
  electronConfig: "[Kr]4d¹⁰ — to'liq to'lgan d-qobiq, rangiz, diamagnit",
  
  crystalSystem: "Ortorombik",
  spaceGroup: "Pnma (№62)",
  a: 8.542, b: 7.118, c: 11.234,
  alpha: 90, beta: 90, gamma: 90,
  volume: 683.2, Z: 4,
  densityCalc: 2.85,
  formulaUnitsPerCell: "Z = 4 (4 ta [Ag(NH₃)₂]NO₃ birligi)",
  
  temperature: "293 K",
  radiationType: "Mo Kα (λ = 0.71073 Å)",
  diffractometer: "Bruker SMART APEX CCD",
  crystalSize: "0.28 × 0.22 × 0.18 mm³",
  absorptionCorrection: "SADABS (multi-scan)",
  tMin: 0.62, tMax: 0.75,
  
  reflectionsCollected: 4520,
  independentReflections: 2150,
  completeness: "99.5%",
  rInt: 0.025,
  rSigma: 0.019,
  r1Obs: 0.024, r1All: 0.031,
  wR2Obs: 0.058, wR2All: 0.064,
  gof: 1.04,
  largestDiffPeak: 0.35,
  largestDiffHole: -0.28,
  flackParameter: "N/A (sentrosimmetrik)",
  
  bondLengths: [
    { bond: "Ag−N", length: "2.115(3)", note: "2 ta ekvivalent bog', chiziqli" },
    { bond: "Ag−N (min)", length: "2.112(3)", note: "Individual qiymat" },
    { bond: "Ag−N (max)", length: "2.118(3)", note: "Individual qiymat" },
    { bond: "N−H", length: "0.89(4)", note: "6 ta ekvivalent N−H bog'" },
    { bond: "Ag···O (anion)", length: "2.782−3.245", note: "Kuchsiz koordinatsion kontaktlar" },
    { bond: "N−H···O (vodorod bog')", length: "2.05−2.35", note: "H···O masofa" },
    { bond: "Ag···Ag (eng yaqin)", length: "4.852", note: "Metall-metall ta'siri yo'q" },
  ],
  
  bondAngles: [
    { angle: "N−Ag−N", value: "178.2(2)°" },
    { angle: "Ag−N−H (o'rtacha)", value: "109.5(3)°" },
    { angle: "H−N−H", value: "107.8(4)°" },
    { angle: "N−Ag···O (eng yaqin)", value: "85.3(1)°" },
  ],
  
  torsions: [
    { torsion: "N−Ag−N−H (staggered)", value: "±60°" },
    { torsion: "NH₃ guruhlari orientatsiyasi", value: "Staggered — energetik minimum" },
  ],
  
  packing: {
    title: "Kristall o'rash tuzilishi",
    description: "[Ag(NH₃)₂]⁺ kationlari NO₃⁻ anionlari bilan N−H···O vodorod bog'lari orqali bog'langan. Har bir kation 6 ta anion bilan o'ralgan — 3D tarmoq hosil bo'ladi. Chiziqli kationlar ortorombik panjarada parallel va antiparallel yo'nalgan.",
    hBondsPerCation: "6 ta N−H···O vodorod bog'i",
    coordinationNumber: "Ag⁺ — 2 (chiziqli) + 4 (kuchsiz Ag···O)",
  },
  
  comparison: {
    title: "Ag(I) koordinatsion geometriyalar",
    linear: "[Ag(NH₃)₂]⁺ — chiziqli (180°), koord. soni 2",
    trigonal: "[Ag(CN)₃]²⁻ — trigonal planar (120°), koord. soni 3",
    tetrahedral: "[Ag(SCN)₄]³⁻ — tetraedrik, koord. soni 4",
    linearBent: "[AgCl₂]⁻ — chiziqli, lekin erituvchi ta'sirida egilishi mumkin",
  },
  
  safety: "Ag(I) birikmalari — teri va shilliq qavatlar bilan kontaktda qorayish (argiriya). Ammiakli eritmalar ishqoriy muhit hosil qiladi. Ko'z va teri bilan kontaktdan saqlaning.",
  
  diffractionPeaks: [
    { h: 1, k: 0, l: 1, twotheta: 8.25, d: 5.36, intensity: 72 },
    { h: 0, k: 1, l: 1, twotheta: 10.68, d: 4.14, intensity: 45 },
    { h: 1, k: 1, l: 0, twotheta: 12.45, d: 3.55, intensity: 100 },
    { h: 0, k: 2, l: 0, twotheta: 14.88, d: 2.97, intensity: 38 },
    { h: 1, k: 1, l: 1, twotheta: 16.95, d: 2.61, intensity: 55 },
    { h: 2, k: 0, l: 0, twotheta: 18.72, d: 2.37, intensity: 28 },
    { h: 0, k: 0, l: 2, twotheta: 20.85, d: 2.13, intensity: 32 },
    { h: 1, k: 2, l: 1, twotheta: 23.15, d: 1.92, intensity: 20 },
    { h: 2, k: 1, l: 0, twotheta: 25.48, d: 1.75, intensity: 18 },
    { h: 1, k: 1, l: 2, twotheta: 27.85, d: 1.60, intensity: 15 },
    { h: 2, k: 1, l: 1, twotheta: 30.25, d: 1.48, intensity: 12 },
    { h: 0, k: 3, l: 1, twotheta: 32.68, d: 1.37, intensity: 10 },
    { h: 2, k: 2, l: 0, twotheta: 35.15, d: 1.28, intensity: 8 },
    { h: 1, k: 3, l: 1, twotheta: 37.55, d: 1.20, intensity: 6 },
    { h: 3, k: 0, l: 1, twotheta: 40.05, d: 1.13, intensity: 5 },
    { h: 2, k: 2, l: 2, twotheta: 42.45, d: 1.06, intensity: 4 },
  ],
}

function DifraktogrammaGrafik({ lineColor = "#c0c0c0" }) {
...
const TABS = [
  ...
  { id: "geometry", label: "Geometriya turlari", icon: "📐" },
  { id: "refinement", label: "Ishonchlilik", icon: "📋" },
]

export default function AgNH32RentgenPage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-950 to-blue-950 text-white">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex items-center gap-4 px-6 py-4 mb-6 border-b border-purple-800/50">
          ...
          <h1 className="text-xl font-bold text-white">[Ag(NH₃)₂]⁺ — Rentgen difraksiyasi tahlili</h1>
        </div>
        <HeroSection />
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6 md:p-8">
          {activeTab==="diffraction"&&(<div className="space-y-4"><h2 className="text-xl font-bold text-gray-300">Hisoblangan difraktogramma</h2><p className="text-purple-400 text-sm">[Ag(NH₃)₂]NO₃ ning ortorombik fazasi (Pnma) uchun hisoblangan PXRD pattern. <strong className="text-gray-300">Bu xom eksperimental difraktogramma emas.</strong></p><DifraktogrammaGrafik /><div className="bg-purple-800/30 rounded-xl p-4"><h3 className="text-white font-semibold mb-3">Piklar ro'yxati (16 ta refleks)</h3><div className="overflow-x-auto max-h-64"><table className="w-full text-sm"><thead><tr className="border-b border-purple-700/50"><th className="text-left py-2 px-3 text-purple-400">hkl</th><th className="text-left py-2 px-3 text-purple-400">2θ (°)</th><th className="text-left py-2 px-3 text-purple-400">d (Å)</th><th className="text-left py-2 px-3 text-purple-400">I (%)</th></tr></thead><tbody>{CRYSTAL.diffractionPeaks.map((p,i)=>(<tr key={i} className="border-b border-purple-800/30 hover:bg-purple-800/20"><td className="py-2 px-3 font-mono text-gray-300">({p.h}{p.k}{p.l})</td><td className="py-2 px-3 text-purple-200">{p.twotheta.toFixed(2)}</td><td className="py-2 px-3 text-purple-200">{p.d.toFixed(2)}</td><td className="py-2 px-3 text-purple-200">{p.intensity}</td></tr>))}</tbody></table></div></div></div>)}
          {activeTab==="calculator"&&(<div className="space-y-4"><h2 className="text-xl font-bold text-gray-300">Bragg + Scherrer kalkulyatori</h2><p className="text-purple-400 text-sm">Ortorombik Pnma birlik hujayra uchun d(hkl) ni hisoblang.</p><BraggScherrerKalkulyator /></div>)}
          {activeTab==="structure"&&(<div className="space-y-4"><h2 className="text-xl font-bold text-gray-300">Kristall struktura ma'lumotlari</h2><div className="grid grid-cols-1 md:grid-cols-2 gap-4"><div className="bg-purple-800/30 rounded-xl p-4"><h3 className="text-white font-semibold mb-3">Bog' uzunliklari</h3><table className="w-full text-sm"><thead><tr className="border-b border-purple-700/50"><th className="text-left py-2 px-3 text-purple-400">Bog'</th><th className="text-left py-2 px-3 text-purple-400">Uzunlik (Å)</th></tr></thead><tbody>{CRYSTAL.bondLengths.map((r,i)=>(<tr key={i} className="border-b border-purple-800/30"><td className="py-2 px-3 text-gray-300 font-mono text-xs">{r.bond}</td><td className="py-2 px-3 text-purple-200">{r.length}</td></tr>))}</tbody></table></div><div className="bg-purple-800/30 rounded-xl p-4"><h3 className="text-white font-semibold mb-3">Bog' burchaklari</h3><table className="w-full text-sm"><thead><tr className="border-b border-purple-700/50"><th className="text-left py-2 px-3 text-purple-400">Burchak</th><th className="text-left py-2 px-3 text-purple-400">Qiymat</th></tr></thead><tbody>{CRYSTAL.bondAngles.map((r,i)=>(<tr key={i} className="border-b border-purple-800/30"><td className="py-2 px-3 text-gray-300 font-mono text-xs">{r.angle}</td><td className="py-2 px-3 text-purple-200">{r.value}</td></tr>))}</tbody></table></div></div><div className="bg-blue-600/10 border border-blue-500/30 rounded-xl p-4"><h3 className="text-blue-400 font-semibold text-sm mb-2">🔬 N−Ag−N chiziqli geometriya — sp gibridlanish</h3><p className="text-purple-200 text-sm">Ag⁺ (d¹⁰) — to'liq to'lgan d-qobiq, ligand maydon stabilizatsiya energiyasi nolga teng. sp gibridlanish natijasida chiziqli geometriya hosil bo'ladi. N−Ag−N burchagi <strong className="text-gray-300">178.2°</strong> — ideal 180° dan ozgina og'ishgan. Bu og'ish anionlar bilan kuchsiz Ag···O kontaktlari va kristall o'rash kuchlari ta'sirida yuzaga keladi. Ag−N bog' uzunligi 2.115 Å — Ag(I) uchun xarakterli.</p></div></div>)}
          {activeTab==="packing"&&(<div className="space-y-4"><h2 className="text-xl font-bold text-gray-300">{CRYSTAL.packing.title}</h2><p className="text-purple-200 text-sm">{CRYSTAL.packing.description}</p><div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center"><div className="bg-purple-800/30 rounded-xl p-4"><p className="text-gray-300 font-bold text-lg">{CRYSTAL.packing.hBondsPerCation}</p><p className="text-purple-400 text-xs mt-1">Vodorod bog'lari</p></div><div className="bg-purple-800/30 rounded-xl p-4"><p className="text-gray-300 font-bold text-lg">{CRYSTAL.packing.coordinationNumber}</p><p className="text-purple-400 text-xs mt-1">Koordinatsion son</p></div><div className="bg-purple-800/30 rounded-xl p-4"><p className="text-gray-300 font-bold text-lg">4.852 Å</p><p className="text-purple-400 text-xs mt-1">Ag···Ag masofa</p></div></div></div>)}
          {activeTab==="geometry"&&(<div className="space-y-4"><h2 className="text-xl font-bold text-gray-300">{CRYSTAL.comparison.title}</h2><div className="grid grid-cols-1 md:grid-cols-2 gap-4"><div className="bg-gray-500/10 border border-gray-400/30 rounded-xl p-4"><h3 className="text-gray-300 font-semibold mb-2">Chiziqli</h3><p className="text-purple-200 text-sm">{CRYSTAL.comparison.linear}</p></div><div className="bg-purple-800/30 rounded-xl p-4"><h3 className="text-purple-300 font-semibold mb-2">Trigonal planar</h3><p className="text-purple-200 text-sm">{CRYSTAL.comparison.trigonal}</p></div><div className="bg-purple-800/30 rounded-xl p-4"><h3 className="text-purple-300 font-semibold mb-2">Tetraedrik</h3><p className="text-purple-200 text-sm">{CRYSTAL.comparison.tetrahedral}</p></div><div className="bg-purple-800/30 rounded-xl p-4"><h3 className="text-purple-300 font-semibold mb-2">Chiziqli (egiluvchan)</h3><p className="text-purple-200 text-sm">{CRYSTAL.comparison.linearBent}</p></div></div></div>)}
          {activeTab==="refinement"&&(<div className="space-y-4"><h2 className="text-xl font-bold text-gray-300">Ishonchlilik parametrlari</h2><div className="overflow-x-auto"><table className="w-full text-sm"><thead><tr className="border-b border-purple-700/50"><th className="text-left py-3 px-4 text-purple-400">Parametr</th><th className="text-left py-3 px-4 text-purple-400">Qiymat</th><th className="text-left py-3 px-4 text-purple-400">Maqbul diapazon</th></tr></thead><tbody>{[["R₁",CRYSTAL.r1Obs.toFixed(3),"< 0.05"],["wR₂",CRYSTAL.wR2Obs.toFixed(3),"< 0.10"],["GoF",CRYSTAL.gof.toFixed(2),"0.8−1.3"],["Rint",CRYSTAL.rInt.toFixed(3),"< 0.05"],["Rσ",CRYSTAL.rSigma.toFixed(3),"< 0.03"],["To'liqlik",CRYSTAL.completeness,"> 95%"],["Maks qoldiq",CRYSTAL.largestDiffPeak+" eÅ⁻³","< 1.0"]].map((r,i)=>(<tr key={i} className="border-b border-purple-800/30"><td className="py-3 px-4 text-gray-300 font-mono">{r[0]}</td><td className="py-3 px-4 text-purple-200">{r[1]}</td><td className="py-3 px-4 text-purple-400">{r[2]}</td></tr>))}</tbody></table></div></div>)}
        </div>
        <div className="flex justify-between mt-8 pt-6 border-t border-purple-800/50">
          <Link href="/ilmiy/tahlil/rentgen/birikmalar/cu-h2o6" className="text-purple-400 hover:text-purple-200 text-sm flex items-center gap-2"><span>←</span> [Cu(H₂O)₆]²⁺</Link>
          <Link href="/ilmiy/tahlil/rentgen/birikmalar/co-cl4" className="text-purple-400 hover:text-purple-200 text-sm">[CoCl₄]²⁻ →</Link>
        </div>
      </div>
    </div>
  )
