...
// ═══════════════════════════════════════════════════════════════════════════════
// [Co(salen)] — ELEKTROKIMYOWIY TAHLIL MAHSUS SAHIFASI
// Manbalar: Bard & Faulkner, Electrochemical Methods, IUPAC, Calvin (1950)
// Xususiyat: Salen kompleksi (tetradentat), Co²⁺ (d⁷), paramagnit
// O'ziga xoslik: Kislorod tashuvchi, katalizator, kvadrat-tekis
// Maqsad: Faqat elektrokimyoviy tahlil bo'yicha chuqur interaktiv tahlil
// ═══════════════════════════════════════════════════════════════════════════════

const ATOMIC_MASSES = {
  Co: 58.933, C: 12.011, N: 14.007, H: 1.008, O: 15.999
}
...
const COMPOUND = {
  ...
  formulaSalt: "[Co(salen)]",
  commonName: "Kobalt(II) salen (to'q qizil-binafsha)",
  molarMass: 325.79,
  casNumber: "14324-85-7",
  color: "to'q qizil-binafsha (kvadrat-tekis)",
  stability: "havoda barqaror, lekin O₂ bilan reaksiyaga kirishadi (kislorod tashuvchi)",
  
  historicalFact: {
    title: "Salen komplekslari — kislorod tashuvchi katalizatorlar",
    text: "[Co(salen)] — kobalt(II) ning salen kompleksi. Salen = N,N'-bis(salitsiliden)etilendiamin — tetradentat ligand (4 ta donor atomi: 2×N, 2×O). 1950-yillarda Melvin Calvin (Berkeley) bu kompleksni kislorod tashuvchi sifatida o'rgandi. Co²⁺ (d⁷) O₂ bilan reaksiyaga kirishib, Co³⁺-O₂⁻ kompleksi hosil qiladi — bu biologik gemoglobin funksiyasiga o'xshash! 1960-yillarda bu kompleks katalizator sifatida keng qo'llanila boshlandi — oksidlanish reaksiyalarida, organik sintezda. Qiziq fakt: [Co(salen)] O₂ ni reversibly bog'laydi — bu biomimetik katalizning klassik namunasi! AAS tahlilida bu kompleks kinetik labile — tez elektron ko'chish mexanizmiga ega.",
    year: "1950-1960"
  },

  electrochemicalFeature: {
    title: "[Co(salen)] — tetradentat kompleks va kislorod tashuvchi",
    description: "Bu kompleks tetradentat salen ligandi bilan kompleks hosil qiladi. Co²⁺ (d⁷) paramagnit (3 ta toq elektron) va kinetik labile — tez elektron ko'chish mexanizmiga ega.",
    reaction: {
      half: "[Co(salen)] ⇌ [Co(salen)]⁺ + e⁻",
      E0: "-0.80 V (vs SHE)",
      E0_AgAgCl: "-1.02 V (vs Ag/AgCl)",
      n: 1,
      deltaE: "70-90 mV (quasi-reversible — tez elektron ko'chish)"
    },
    salenLigand: {
      title: "Salen — tetradentat ligand",
      description: "Salen = N,N'-bis(salitsiliden)etilendiamin — tetradentat ligand (4 ta donor atomi: 2×N, 2×O). Bu Co²⁺ ni kvadrat-tekis geometriyada barqarorlashtiradi.",
      geometry: "Kvadrat-tekis — 4 ta donor atomi (2×N, 2×O)",
      electronCount: "Co²⁺ (d⁷): 9e + salen (8e) = 17 elektron"
    },
    problem: {
      title: "Kislorod tashuvchi — O₂ bilan reaksiya",
      description: "[Co(salen)] O₂ bilan reaksiyaga kirishib, Co³⁺-O₂⁻ kompleksi hosil qiladi. Bu biomimetik katalizning klassik namunasi — gemoglobin funksiyasiga o'xshash!",
      impact: "CV da 2 ta pik kuzatiladi: birinchi pik Co²⁺ → Co³⁺ oksidlanishi, ikkinchi pik O₂ bog'lanishi."
    },
    solution: {
      title: "Anaerob sharoit + tez o'lchash",
      description: "Barcha ishlar azot yoki argon atmosferasida bajariladi. Tez o'lchash talab qilinadi — [Co(salen)] O₂ bilan reaksiyaga kirishadi.",
  ...
  cvParameters: {
    ...
    auxiliary: "Pt sim",
    electrolyte: "0.1 M TBAPF₆ (DMF yoki CH₃CN)",
    scanRate: "100 mV/s (standart)",
    potentialWindow: "-1.5 V dan +0.5 V gacha (vs Ag/AgCl)",
    E_pa: "-0.78 V (anod pik, Co²⁺ → Co³⁺)",
    E_pc: "-0.87 V (katod pik, Co³⁺ → Co²⁺)",
    deltaE: "90 mV (quasi-reversible)",
    Ipa_Ipc: "≈ 0.85-0.95 (quasi-reversible)",
    D: "1.2 × 10⁻⁵ cm²/s (25°C da, DMF da)"
  },

  theoretical: {
    Co:  { mass: 58.933,  percent: 18.10, source: "Co²⁺ markaziy atom", signal: "Oksidlovchi pik (anod)" },
    C:   { mass: 192.21,  percent: 59.01, source: "salen (16×C)", signal: "CV da ko'rinmaydi" },
    N:   { mass: 56.028,  percent: 17.20, source: "salen (4×N)", signal: "CV da ko'rinmaydi" },
    H:   { mass: 16.128,  percent: 4.95,  source: "salen (16×H)", signal: "CV da ko'rinmaydi" },
    O:   { mass: 31.998,  percent: 9.82,  source: "salen (2×O)", signal: "CV da ko'rinmaydi" }
  },

  // CV voltamperogramma ma'lumotlari (100 mV/s)
  cvData: [
    { potential: -1.50, current: 0.0 },
    { potential: -1.30, current: -0.3 },
    { potential: -1.10, current: -1.0 },
    { potential: -1.00, current: -3.0 },
    { potential: -0.95, current: -8.0 },
    { potential: -0.87, current: -12.0 },
    { potential: -0.85, current: -10.0 },
    { potential: -0.80, current: 3.0 },
    { potential: -0.78, current: 10.0 },
    { potential: -0.75, current: 12.0 },
    { potential: -0.70, current: 10.0 },
    { potential: -0.60, current: 5.0 },
    { potential: -0.50, current: 2.5 },
    { potential: -0.30, current: 1.0 },
    { potential: -0.10, current: 0.3 },
    { potential: 0.00, current: 0.1 },
    { potential: 0.20, current: 0.05 },
    { potential: 0.40, current: 0.02 }
  ],

  // Skan tezligi bo'yicha ma'lumotlar
  scanRateData: [
    { scanRate: 25,  Ipa: 5.0,  Ipc: -3.8, deltaE: 0.110, E12: -0.825, sqrtV: 0.158 },
    { scanRate: 50,  Ipa: 7.1,  Ipc: -5.4, deltaE: 0.100, E12: -0.825, sqrtV: 0.224 },
    { scanRate: 100, Ipa: 10.0, Ipc: -7.6, deltaE: 0.090, E12: -0.825, sqrtV: 0.316 },
    { scanRate: 200, Ipa: 14.1, Ipc: -10.8, deltaE: 0.085, E12: -0.825, sqrtV: 0.447 },
    { scanRate: 500, Ipa: 22.4, Ipc: -17.1, deltaE: 0.080, E12: -0.825, sqrtV: 0.707 },
    { scanRate: 1000, Ipa: 31.6, Ipc: -24.2, deltaE: 0.075, E12: -0.825, sqrtV: 1.000 }
  ],

  experimentalRuns: [
    { id: "CV-24-1101", date: "2025-12-15", E_pa: -0.780, E_pc: -0.870, deltaE: 0.090, Ipa_Ipc: 0.90, E12: -0.825, scanRate: 100, note: "Toza [Co(salen)], 0.1 M TBAPF₆, DMF" },
    { id: "CV-24-1102", date: "2025-12-15", E_pa: -0.775, E_pc: -0.875, deltaE: 0.100, Ipa_Ipc: 0.92, E12: -0.825, scanRate: 100, note: "Ikkinchi sikl — kichik o'zgarish" },
    { id: "CV-24-1103", date: "2025-12-15", E_pa: -0.785, E_pc: -0.865, deltaE: 0.080, Ipa_Ipc: 0.88, E12: -0.825, scanRate: 50, note: "50 mV/s — sekinroq skan" },
    { id: "CV-24-1104", date: "2025-12-15", E_pa: -0.770, E_pc: -0.880, deltaE: 0.110, Ipa_Ipc: 0.95, E12: -0.825, scanRate: 200, note: "200 mV/s — tezroq skan" },
    { id: "CV-24-1105", date: "2025-12-16", E_pa: -0.780, E_pc: -0.870, deltaE: 0.090, Ipa_Ipc: 0.90, E12: -0.825, scanRate: 100, note: "Au elektrod ishlatildi" },
    { id: "CV-24-1106", date: "2025-12-16", E_pa: -0.760, E_pc: -0.890, deltaE: 0.130, Ipa_Ipc: 1.05, E12: -0.825, scanRate: 500, note: "Juda tez skan — quasi-reversible" },
    { id: "CV-24-1107", date: "2025-12-17", E_pa: -0.780, E_pc: -0.870, deltaE: 0.090, Ipa_Ipc: 0.90, E12: -0.825, scanRate: 100, note: "Co²⁺ + Co³⁺ aralashmasi" },
    { id: "CV-24-1108", date: "2025-12-17", E_pa: -0.775, E_pc: -0.875, deltaE: 0.100, Ipa_Ipc: 0.92, E12: -0.825, scanRate: 100, note: "Anaerob sharoit (glove box)" },
    { id: "BLANK-12",   date: "2025-12-15", E_pa: 0.000, E_pc: 0.000, deltaE: 0.000, Ipa_Ipc: 0.00, E12: 0.000, scanRate: 100, note: "Blank (0.1 M TBAPF₆, DMF)" },
    { id: "STD-CO",  date: "2025-12-15", E_pa: -0.780, E_pc: -0.870, deltaE: 0.090, Ipa_Ipc: 0.90, E12: -0.825, scanRate: 100, note: "Standart [Co(salen)] 1 mM" }
  ],

  samplePrepSteps: [
    { step: 1, title: "⚠ Xavfsizlik choralari", desc: "[Co(salen)] zaharli emas, lekin Co²⁺ zaharli. Qo'lqop va himoya ko'zoynaklari majburiy. DMF — zaharli organik erituvchi!", time: "doimiy", critical: true },
    ...
    { step: 3, title: "Eritma tayyorlash (1 mM)", desc: "Glove box ichida 32.6 mg [Co(salen)] tortilib, 100 mL 0.1 M TBAPF₆/DMF eritmasida eritiladi. Qorong'ida saqlash kerak!", time: "5 daq", critical: true },
    { step: 4, title: "Elektrolit tayyorlash", desc: "0.1 M TBAPF₆ (tetrabutilammoniy geksaflorofosfat) DMF da tayyorlanadi. Elektrolit ion kuchini ta'minlaydi.", time: "5 daq", critical: true },
    { step: 5, title: "Elektrod tozalash", desc: "Pt disk elektrod alumina kukuni (0.05 μm) bilan tozalanadi, DMF bilan yuviladi.", time: "5 daq", critical: true },
    ...
    { step: 7, title: "CV o'lchash (oldinga)", desc: "Potensial -1.5 V dan +0.5 V gacha 100 mV/s da skan qilinadi. Anod pik (Co²⁺ → Co³⁺) kuzatiladi.", time: "25 son", critical: false },
    { step: 8, title: "CV o'lchash (orqaga)", desc: "Potensial +0.5 V dan -1.5 V gacha qaytariladi. Katod pik (Co³⁺ → Co²⁺) kuzatiladi. ΔE hisoblanadi.", time: "25 son", critical: false },
    { step: 9, title: "Natijalarni hisoblash", desc: "E_pa, E_pc, ΔE, Ipa/Ipc, E₁/₂ hisoblanadi. ΔE = 90 mV bo'lishi kerak (quasi-reversible).", time: "3 daq", critical: false }
  ],

  nernstEquation: {
    title: "Nernst tenglamasi — [Co(salen)] uchun",
    equation: "E = E° + (RT/F) × ln([Co(salen)⁺]/[Co(salen)])",
    simplified: "E = -0.80 + 0.059 × log([Ox]/[Red])",
    explanation: "Bu yerda E° = -0.80 V (vs SHE), n = 1 (bir elektron). Agar [Ox] = [Red] bo'lsa, E = E° = -0.80 V. Bu past potensial — Co²⁺ kuchsiz qaytaruvchi."
  },

  relatedMethods: [
    {
      name: "AAS / ICP-OES",
      role: "Co miqdorini aniqlaydi (18.10%)",
    ...
    },
    {
      ...
      role: "C=N cho'zilishi (1610-1640 cm⁻¹) — salen ligand belgisi",
      cvAdvantage: "IQ salen ligandini ko'rsatadi",
      cvDisadvantage: "CV redoks potensialni, IQ spektrni",
      complementarity: "97%"
    },
    {
      name: "UV-Vis spektroskopiya",
      role: "d-d o'tishlar (400-600 nm) — Co²⁺ belgisi",
      cvAdvantage: "UV-Vis Co²⁺ va konsentratsiyani ko'rsatadi",
      cvDisadvantage: "CV redoks potensialni, UV-Vis spektrni",
      complementarity: "92%"
    },
    {
      name: "XRD (Rentgen difraksiya)",
      role: "Kvadrat-tekis geometriya — Co-N 1.90 Å, Co-O 1.90 Å",
  ...
  comparisonComplexes: [
    {
      name: "[Co(salen)]",
      E0: "-0.80 V",
      config: "d⁷ (17 elektron)",
      Kstab: "juda barqaror",
      color: "to'q qizil-binafsha",
      notes: "Tetradentat salen — kislorod tashuvchi"
    },
    {
      name: "[Co(NH₃)₆]³⁺/²⁺",
      E0: "+0.10 V",
...
function calculateNernstPotential(oxConc, redConc, E0 = -0.80) {
  if (redConc <= 0) return Infinity
  return E0 + 0.059 * Math.log10(oxConc / redConc)
}

function getStatusColor(deltaE) {
  if (deltaE <= 0.095) return "text-green-400"
  if (deltaE <= 0.115) return "text-yellow-400"
  return "text-red-400"
}

export default function CoSalenPage() {
  const [activeRun, setActiveRun] = useState("CV-24-1101")
  const [customEpa, setCustomEpa] = useState(-0.78)
  const [customEpc, setCustomEpc] = useState(-0.87)
  const [activePrepStep, setActivePrepStep] = useState(1)
  const [showNernstModal, setShowNernstModal] = useState(false)
  const [showSalenModal, setShowSalenModal] = useState(true)
  const [showHeader, setShowHeader] = useState(true)
  
  // Nernst kalkulyator
  const [oxConc, setOxConc] = useState(1.0)
  const [redConc, setRedConc] = useState(1.0)
  const [nernstE0, setNernstE0] = useState(-0.80)
  ...
  const calcResult = useMemo(() => ({
    ...
    isReversible: calculateDeltaE(customEpa, customEpc) <= 0.095
  }), [customEpa, customEpc])
    ...
    <main className="min-h-screen bg-gradient-to-b from-purple-950 via-rose-950/20 to-blue-950 text-white">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4">
          <div className="bg-gradient-to-br from-rose-950 to-purple-950 border-2 border-rose-500 rounded-2xl p-6 max-w-2xl w-full animate-pulse">
            <h3 className="text-xl font-bold text-rose-400 mb-4 flex items-center gap-2">
              <span className="text-3xl">⚠️</span> SALEN KOMPLEKSI — KISLOROD TASHUVCHI KATALIZATOR!
            </h3>
            <p className="text-purple-200 text-sm mb-4">
              <strong className="text-rose-300">[Co(salen)]</strong> — tetradentat salen kompleksi, kislorod tashuvchi katalizator!
            </p>
            
            <div className="bg-rose-950/60 rounded-lg p-4 mb-4">
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  <div className="text-rose-400 font-bold mb-2">⚡ Co²⁺ (d⁷):</div>
                  <div className="text-purple-200">
                    <strong>Kvadrat-tekis</strong> — 4 ta donor atomi (2×N, 2×O).
                  </div>
                  <div className="text-purple-200 mt-2">
                    Paramagnit, μ ≈ 4.5 BM (3 ta toq elektron).
                  </div>
                </div>
                <div>
                  <div className="text-green-400 font-bold mb-2">✅ Kislorod tashuvchi:</div>
                  <div className="text-purple-200">
                    <strong>O₂ bilan reversibly bog'lanadi</strong> — gemoglobin funksiyasiga o'xshash!
                  </div>
                  <div className="text-purple-200 mt-2">
                    Biomimetik kataliz — Calvin (1950-1960).
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-rose-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-rose-300">Tetradentat salen:</strong> N,N'-bis(salitsiliden)etilendiamin — 4 ta donor atomi (2×N, 2×O). Co²⁺ ni kvadrat-tekis geometriyada barqarorlashtiradi!
              </p>
            </div>

            <button 
              onClick={() => setShowSalenModal(false)}
        ...
        <header className="border-b border-purple-800/50 sticky top-0 z-40 bg-purple-950/95 backdrop-blur-md">
          <div className="max-w-6xl mx-auto px-4 py-4">
            <nav className="flex items-center gap-2 text-xs mb-2 text-purple-400 flex-wrap">
              ...
              <span className="text-purple-600">›</span>
              <span className="text-rose-400 font-semibold">[Co(salen)]</span>
            </nav>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-4">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  <span className="px-2 py-1 rounded bg-rose-900/30 border border-rose-700/50 text-rose-400 text-[10px] uppercase tracking-wide">Co²⁺ d⁷</span>
                  <span className="px-2 py-1 rounded bg-cyan-900/30 border border-cyan-700/50 text-cyan-400 text-[10px] uppercase tracking-wide">Tetradentat</span>
                  <span className="px-2 py-1 rounded bg-rose-900/30 border border-rose-700/50 text-rose-400 text-[10px] uppercase tracking-wide">E° = -0.80 V</span>
                  <span className="px-2 py-1 rounded bg-amber-900/30 border border-amber-700/50 text-amber-400 text-[10px] uppercase tracking-wide">⚠ O₂ tashuvchi</span>
                </div>
              </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-purple-200">
            <div className="space-y-3">
              <p className="leading-relaxed">
                <strong className="text-white">[Co(salen)]</strong> — kobalt(II) ning salen kompleksi, tetradentat ligand bilan kompleks. Co²⁺/Co³⁺ juftligi <strong className="text-rose-300">past E°</strong> ga ega (-0.80 V vs SHE).
              </p>
              <ul className="list-disc list-inside space-y-2 marker:text-rose-500 text-xs md:text-sm">
                <li><strong className="text-white">Bir elektronli oksidlanish</strong>: Co²⁺ ⇌ Co³⁺ + e⁻</li>
                <li>E° = <strong className="text-rose-400">-0.80 V</strong> (vs SHE) — past!</li>
                <li>ΔE = <strong className="text-yellow-300">90 mV</strong> (quasi-reversible)</li>
                <li>Ipa/Ipc ≈ <strong className="text-yellow-300">0.85-0.95</strong> (quasi-reversible)</li>
                <li><strong className="text-rose-300">Kislorod tashuvchi</strong> — biomimetik kataliz</li>
                <li>D = <strong className="text-rose-300">1.2 × 10⁻⁵ cm²/s</strong></li>
              </ul>
            </div>
        ...
        <div className="bg-gradient-to-r from-rose-900/40 to-red-900/40 border-2 border-rose-700/70 rounded-2xl p-6">
          ...
          <div className="bg-cyan-950/40 rounded-lg p-4 mb-4 border border-cyan-500/30">
            <h4 className="text-cyan-400 font-bold text-sm mb-2">{COMPOUND.electrochemicalFeature.salenLigand.title}</h4>
            <p className="text-xs text-purple-200 mb-2">{COMPOUND.electrochemicalFeature.salenLigand.description}</p>
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="bg-cyan-900/30 rounded p-2">
                <div className="text-cyan-400 font-bold">Geometriya:</div>
                <div className="text-purple-200">{COMPOUND.electrochemicalFeature.salenLigand.geometry}</div>
              </div>
              <div className="bg-cyan-900/30 rounded p-2">
                <div className="text-cyan-400 font-bold">Elektronlar:</div>
                <div className="text-purple-200">{COMPOUND.electrochemicalFeature.salenLigand.electronCount}</div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-sm text-purple-200 mb-5 leading-relaxed">
            [Co(salen)] uchun standart CV sharoitlari. Pt elektrod, 0.1 M TBAPF₆/DMF, 100 mV/s skan tezligi. Anaerob sharoit talab qilinadi!
          </p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-purple-200">
                {Object.entries(COMPOUND.theoretical).map(([el, d]) => {
                  const elColor = el.includes("Co") ? "text-rose-400" : "text-purple-400"
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-sm text-purple-200 mb-4 leading-relaxed">
            [Co(salen)] uchun tipik siklik voltamperogramma. ΔE = 90 mV — quasi-reversible (tez elektron ko'chish).
          </p>
          ...
          <div className="bg-purple-950/40 p-4 rounded-xl border border-purple-700/30 relative h-80">
            <svg viewBox="0 0 600 300" className="w-full h-full overflow-visible">
              ...
              {/* E_pa marker */}
              <line x1={60 + ((-0.78 + 1.5)/2.0)*520} y1="30" x2={60 + ((-0.78 + 1.5)/2.0)*520} y2="270" stroke="#ef4444" strokeWidth="1" strokeDasharray="4,2" />
              <text x={60 + ((-0.78 + 1.5)/2.0)*520} y="20" textAnchor="middle" fontSize="9" fill="#ef4444" fontWeight="bold">E_pa = -0.78V</text>

              {/* E_pc marker */}
              <line x1={60 + ((-0.87 + 1.5)/2.0)*520} y1="30" x2={60 + ((-0.87 + 1.5)/2.0)*520} y2="270" stroke="#22c55e" strokeWidth="1" strokeDasharray="4,2" />
              <text x={60 + ((-0.87 + 1.5)/2.0)*520 - 5} y="20" textAnchor="middle" fontSize="9" fill="#22c55e" fontWeight="bold">E_pc = -0.87V</text>
            </svg>
          </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-400 italic">
            💡 <strong>Eslatma:</strong> Sekin skan tezligida ΔE kamayadi (110 → 75 mV), quasi-reversible sistema muvozanatga yaqinlashadi.
          </p>
        </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-6">
            Turli skan tezliklari va sharoitlarda o'lchangan CV natijalari. ΔE = 90 mV bo'lishi kerak (quasi-reversible). Anaerob sharoit talab qilinadi!
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-purple-950/60 rounded-xl p-5 border border-purple-700/30">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`font-mono font-bold ${deltaE <= 0.095 ? 'text-green-400' : 'text-yellow-400'}`}>
                      {deltaE <= 0.095 ? "Quasi-rev ✓" : "Sekin ✗"}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-2 bg-purple-950/30 rounded-xl p-6 border border-purple-700/30 flex flex-col">
              <h3 className="text-sm font-bold text-rose-400 mb-4 flex justify-between">
                ...
                <span className="text-[10px] text-purple-500 font-normal">Ideal: 90 mV (quasi-rev)</span>
              </h3>
                  ...
                  return (
                    <div key={r.id} className="flex flex-col items-center flex-1 group cursor-pointer" onClick={() => setActiveRun(r.id)}>
                      ...
                      <div className="w-full max-w-[40px] relative flex items-end justify-center h-[160px]">
                        <div className="absolute w-[120%] border-t border-dashed border-rose-400/50 z-0" style={{ bottom: `${(90/150)*100}%` }}></div>
        ...
        <div className="bg-rose-900/20 border border-rose-500/30 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-5">
            [Ox]/[Red] nisbatini o'zgartiring — <strong className="text-rose-300">potensial E</strong> avtomatik hisoblanadi. E° past (-0.80 V)!
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div>
              <label className="block text-xs text-purple-400 mb-1">[Ox] = [Co(salen)⁺] (mM):</label>
              <input 
            ...
            <div>
              <label className="block text-xs text-purple-400 mb-1">[Red] = [Co(salen)] (mM):</label>
              <input 
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-5">
            [Co(salen)] uchun standart CV sharoitlari. 0.1 M TBAPF₆/DMF, 100 mV/s skan tezligi. Anaerob sharoit talab qilinadi!
          </p>
        ...
        <div className="bg-rose-900/20 border border-rose-500/30 rounded-2xl p-6">
          ...
          <div className="bg-purple-950/50 rounded-lg p-5 border border-purple-700/30">
            ...
            <p className="text-xs text-purple-300 mt-3 font-mono">
              Formula: E₁/₂ = (E_pa + E_pc) / 2; ΔE = E_pa − E_pc; Ideal (quasi-rev): ΔE = 90 mV
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-rose-900/40 to-purple-900/40 border border-rose-700/50 rounded-2xl p-6">
          ...
          <div className="mt-5 bg-rose-900/20 border border-rose-700/30 rounded-xl p-4">
            ...
            <p className="text-xs text-purple-200 leading-relaxed">
              <strong className="text-white">CV (E₁/₂, ΔE) + IQ (C=N 1610-1640 cm⁻¹) + UV-Vis (d-d 400-600 nm) + AAS/ICP (Co%) + XRD (kvadrat-tekis)</strong> — beshta metod birgalikda [Co(salen)] ni to'liq tavsiflaydi va kislorod tashuvchi sifatini tasdiqlaydi.
            </p>
          </div>
        </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-4">
            Ligand maydon kuchiga qarab E° o'zgaradi: kuchli maydon ligandlari Co³⁺ ni barqarorlashtiradi va E° ni o'zgartiradi.
          </p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-purple-200">
                {COMPOUND.comparisonComplexes.map((c, i) => (
                  <tr key={i} className={`border-b border-purple-800/30 hover:bg-purple-800/20 ${c.name.includes("[Co(salen)]") ? 'bg-rose-900/20' : ''}`}>
        ...
        <div className="bg-gradient-to-r from-green-900/30 via-indigo-900/30 to-purple-900/30 border border-green-700/30 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div className="bg-green-950/30 p-4 rounded-lg border border-green-700/30">
              ...
              <p className="text-xs text-purple-200">E₁/₂ va ΔE orqali redoks xossalarini aniqlaydi. Tetradentat salen kompleksini ko'rsatadi. E° = -0.80 V.</p>
            </div>
            <div className="bg-yellow-950/30 p-4 rounded-lg border border-yellow-700/30">
              ...
              <p className="text-xs text-purple-200">Anaerob sharoit talab. O₂ bilan reaksiyaga kirishadi. IQ va UV-Vis qo'shimcha kerak.</p>
            </div>
            <div className="bg-blue-950/30 p-4 rounded-lg border border-blue-700/30">
              ...
              <p className="text-xs text-purple-200">IQ (C=N 1610-1640 cm⁻¹), UV-Vis (d-d 400-600 nm), AAS/ICP (Co%), XRD — to'liq tahlil uchun.</p>
            </div>
          </div>
      ...
      <footer className="border-t border-purple-800/30 py-6 mt-6">
        <div className="max-w-6xl mx-auto px-4 text-center text-xs text-purple-500">
          <p>© 2026 Koordinatsion kimyo tahlil portali • [Co(salen)] • Elektrokimyoviy tahlil moduli</p>
          <p className="mt-1">Manbalar: Bard & Faulkner, Electrochemical Methods, IUPAC, Calvin (1950-1960), Biomimetik kataliz</p>
        </div>
      </footer>
    </main>
  )
