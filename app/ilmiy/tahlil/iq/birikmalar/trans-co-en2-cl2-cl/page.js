...
// ═══════════════════════════════════════════════════════════════════════════════
// trans-[Co(en)₂Cl₂]Cl — KONDUKTOMETRIK TAHLIL (PREMIUM)
// Manbalar: Nakamoto, Lever, Cotton, Wilkinson, Werner (1893)
// Xususiyat: Trans-izomer, 1:1 elektrolit, D₂ₕ simmetriya, kinetik inert
// O'ziga xoslik: Λm ≈ 250 (cis bilan deyarli bir xil — konduktometriya cheklovi)
// Muhim: cis izomerning alohida sahifasi bor — aralashtirmaslik!
// ═══════════════════════════════════════════════════════════════════════════════
...
const COMPOUND = {
  ...
  commonName: "Trans-bis(etilendiamin)dixlorokobalt(III) xlorid (yashil)",
  molarMass: 287.97,
  casNumber: "14878-43-8 (trans)",
  color: "yashil (green)",
  structure: "Oktaedr (D₂ₕ simmetriya)",
  metalLigand: "Co-N (en, xelat), Co-Cl",
  spaceGroup: "P2₁/c (monoklinik, trans)",
  ...
  // IQ cho'qqilari
  irPeaks: [
    { freq: 3290, T: 13, absorbance: 0.87, assignment: "νₐₛ(N-H)", assignment_uz: "N-H asimetrik cho'zilish", intensity: "Juda kuchli", bond: "N-H", symmetry: "B₁ᵤ + B₂ᵤ + B₃ᵤ (D₂ₕ)", forceConstant: "6.0 mdyn/Å", theoryNote: "NH₂ ning asimetrik cho'zilishi. D₂ₕ simmetriya tufayli faqat B₁ᵤ, B₂ᵤ, B₃ᵤ modlari IQ faol (alternativa taqiq bor)." },
    { freq: 3190, T: 29, absorbance: 0.71, assignment: "νₛ(N-H)", assignment_uz: "N-H simmetrik cho'zilish", intensity: "Kuchli", bond: "N-H", symmetry: "A_g (Raman)", forceConstant: "5.8 mdyn/Å", theoryNote: "NH₂ ning simmetrik cho'zilishi. A_g mod faqat Raman faol (alternativa taqiq)." },
    { freq: 1585, T: 47, absorbance: 0.53, assignment: "δ(NH₂)", assignment_uz: "NH₂ egilish (scissoring)", intensity: "O'rta", bond: "NH₂", symmetry: "B₁ᵤ + B₂ᵤ", forceConstant: "0.6 mdyn/Å", theoryNote: "NH₂ ning deformatsion tebranishi." },
    { freq: 1048, T: 59, absorbance: 0.41, assignment: "ν(C-N)", assignment_uz: "C-N cho'zilish (en ligand)", intensity: "Kuchli", bond: "C-N", symmetry: "B₁ᵤ + B₂ᵤ", forceConstant: "5.2 mdyn/Å", theoryNote: "en ligandining C-N bog'i. Koordinatsiya ta'sirida biroz kuchaygan." },
    { freq: 665, T: 51, absorbance: 0.49, assignment: "ρ(NH₂)", assignment_uz: "NH₂ rocking (tebranish)", intensity: "O'rta", bond: "NH₂", symmetry: "B₂ᵤ + B₃ᵤ", forceConstant: "0.4 mdyn/Å", theoryNote: "NH₂ ning rocking tebranishi — en ligandining xelat halqasining tebranishi." },
    { freq: 515, T: 39, absorbance: 0.63, assignment: "ν(Co-N)", assignment_uz: "Co-N cho'zilish (NH₂)", intensity: "Kuchli", bond: "Co-N", symmetry: "B₁ᵤ + B₂ᵤ", forceConstant: "1.7 mdyn/Å", theoryNote: "Co-N bog'ining cho'zilishi. Xelat effekti bog'ni biroz mustahkamlaydi." },
    { freq: 325, T: 48, absorbance: 0.52, assignment: "ν(Co-Cl)", assignment_uz: "Co-Cl cho'zilish (trans)", intensity: "Kuchli", bond: "Co-Cl", symmetry: "A₂ᵤ (D₂ₕ)", forceConstant: "1.4 mdyn/Å", theoryNote: "⭐ MUHIM: Trans izomerda Co-Cl cho'zilishi faqat 1 ta cho'qqi (325 cm⁻¹, A₂ᵤ). Cis da 2 ta cho'qqi (330, 310 cm⁻¹). Bu cis/trans farqlashning IQ belgisi!" },
    { freq: 285, T: 69, absorbance: 0.31, assignment: "δ(Cl-Co-N)", assignment_uz: "Cl-Co-N egilish deformatsiya", intensity: "O'rta-zaif", bond: "Cl-Co-N", symmetry: "B₁ᵤ + B₂ᵤ", forceConstant: "0.3 mdyn/Å", theoryNote: "Cl-Co-N burchakning deformatsiyasi. D₂ₕ simmetriya tufayli kam modlar IQ faol." },
    { freq: 240, T: 73, absorbance: 0.27, assignment: "δ(Co-Cl)", assignment_uz: "Co-Cl egilish (skeletal bending)", intensity: "Zaif", bond: "Co-Cl", symmetry: "B₂ᵤ", forceConstant: "0.2 mdyn/Å", theoryNote: "Co-Cl bog'ining egilish tebranishi — past chastotali (far-IR)." },
  ],
  ...
  irSpectrum: [
    ...
    { freq: 325, absorbance: 0.52 }, { freq: 285, absorbance: 0.31 },
  ...
  aquationKinetics: {
    k_25C: 3.5e-5,
    t_half_25C: 5.5, // soat (cis dan tezroq)
    mechanism: "Dissotsiativ (D) yoki dissotsiativ almashinish (Id)",
    product: "trans-[Co(en)₂(H₂O)Cl]²⁺ + Cl⁻",
    colorChange: "yashil → och yashil",
    activationEnergy: "105 kJ/mol (taxminan)"
  },

  // Turli erituvchilarda
  solventData: [
    { solvent: "Suv (H₂O)", dielectric: 78.5, lm: 250, kappa: 0.0250, color: "yashil", note: "Standart erituvchi — 1:1 elektrolit (Cl⁻ tashqi)" },
    ...
    { solvent: "DMF", dielectric: 36.7, lm: 220, kappa: 0.0220, color: "yashil", note: "DMF da ligand almashinish tezroq" },
    { solvent: "Asetonitril", dielectric: 37.5, lm: 225, kappa: 0.0225, color: "yashil", note: "Qutbli organik erituvchi" },
    { solvent: "Aseton", dielectric: 20.7, lm: 155, kappa: 0.0155, color: "yashil", note: "Kam qutbli — juda kam dissotsiatsiya" }
  ],
  ...
  labResults: [
    { id: "LAB-001", date: "2026-10-15", technique: "KBr tabletka", condition: "200 mg KBr + 1 mg trans-izomer", freq_NO2: "—", freq_CoCl: "325", resolution: "4 cm⁻¹", notes: "Trans izomer — Co-Cl faqat 1 ta cho'qqi (325 cm⁻¹, A₂ᵤ). Bu trans izomer belgisi.", quality: "A'lo" },
    { id: "LAB-002", date: "2026-10-15", technique: "KBr tabletka (cis)", condition: "200 mg KBr + 1 mg cis-izomer", freq_NO2: "—", freq_CoCl: "330, 310", resolution: "4 cm⁻¹", notes: "Cis izomer — Co-Cl cho'qqilari 330 va 310 cm⁻¹ da (2 ta cho'qqi). Cis izomer belgisi.", quality: "A'lo" },
    { id: "LAB-003", date: "2026-10-16", technique: "ATR", condition: "To'g'ridan-to'g'ri kristall (trans)", freq_NO2: "—", freq_CoCl: "323", resolution: "2 cm⁻¹", notes: "ATR usuli — cho'qqilar biroz siljigan. Co-Cl cho'qqisi aniq (trans).", quality: "A'lo" },
    { id: "LAB-004", date: "2026-10-16", technique: "Konduktometriya (suvda)", condition: "10⁻³ M, 25°C", freq_NO2: "—", freq_CoCl: "—", resolution: "—", notes: "⚠️ MUHIM: Λm ≈ 250 S·cm²/mol. Bu cis-[Co(en)₂Cl₂]Cl bilan deyarli bir xil! Konduktometriya cis/trans ni farqlay olmaydi.", quality: "Farqlay olmaydi" },
    { id: "LAB-005", date: "2026-10-17", technique: "UV-Vis", condition: "Suvda, 10⁻⁴ M", freq_NO2: "—", freq_CoCl: "—", resolution: "1 nm", notes: "UV-Vis: trans izomer λmax = 575 nm, cis izomer λmax = 535 nm. Bu cis/trans farqlash usuli!", quality: "Farqlash testi" },
    { id: "LAB-006", date: "2026-10-17", technique: "Aquation kinetikasi", condition: "60°C, suvda", freq_NO2: "—", freq_CoCl: "—", resolution: "—", notes: "Trans izomer tezroq aquatsiyalanadi (t₁/₂ ≈ 5.5 soat, 25°C). Cis izomer sekinroq. Bu kinetik farqlash usuli.", quality: "Kinetik test" },
  ],
    ...
    <main className="min-h-screen bg-gradient-to-b from-purple-950 to-blue-950 text-white">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4" role="dialog" aria-modal="true">
          <div className="bg-gradient-to-br from-green-950 to-purple-950 border-2 border-green-500 rounded-2xl p-6 max-w-3xl w-full animate-pulse">
            <h3 className="text-xl font-bold text-green-400 mb-4 flex items-center gap-2">
              <span className="text-3xl">⚠️</span> trans-[Co(en)₂Cl₂]Cl — KONDUKTOMETRIYA CHEKLOVI!
            </h3>
            <p className="text-purple-200 text-sm mb-4">
              <strong className="text-green-300">trans-[Co(en)₂Cl₂]Cl</strong> — trans-bis(etilendiamin)dixlorokobalt(III) xlorid.
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <div className="text-purple-200 mt-2">
                    <strong>ν(Co-Cl):</strong> 325 cm⁻¹ (1 ta cho'qqi)
                  </div>
                </div>
                <div>
                  <div className="text-green-400 font-bold mb-2">🔬 Konduktometriya:</div>
                  <div className="text-purple-200">
            ...
            <div className="bg-green-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-green-300">Muhim cheklov:</strong> cis-[Co(en)₂Cl₂]Cl ning Λm ham ≈ 250 S·cm²/mol.
            ...
            <div className="bg-green-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-green-300">Farqlash usullari:</strong> UV-Vis (λmax cis: 535 nm, trans: 575 nm),
        ...
        <header className="border-b border-purple-800/50 sticky top-0 z-40 bg-purple-950/95 backdrop-blur-md">
          <div className="max-w-6xl mx-auto px-4 py-4">
            <nav className="flex items-center gap-2 text-xs mb-2 text-purple-400 flex-wrap">
              ...
              <span className="text-purple-600">›</span>
              <span className="text-green-400 font-semibold">trans-[Co(en)₂Cl₂]Cl</span>
            </nav>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-4">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  <span className="px-2 py-1 rounded bg-green-900/30 border border-green-700/50 text-green-400 text-[10px] uppercase tracking-wide">Trans izomer</span>
                  ...
                  <span className="px-2 py-1 rounded bg-green-900/30 border border-green-700/50 text-green-400 text-[10px] uppercase tracking-wide">D₂ₕ simmetriya</span>
                </div>
              </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-8 relative overflow-hidden">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            <span className="bg-green-600/20 text-green-400 border border-green-600/30 px-3 py-1 rounded-full text-xs">Trans izomer</span>
          ...
          <p className="text-purple-300 text-lg mb-4">
            trans-bis(etilendiamin)dixlorokobalt(III) xlorid — <span className="text-green-400 italic">&quot;Trans izomer (yashil)&quot;</span>
          </p>
          ...
          <p className="text-purple-200 leading-relaxed mb-6">
            ...
            <strong className="text-green-400"> ν(Co-Cl) 325 cm⁻¹</strong> — 1 ta cho'qqi (trans izomer belgisi);
            <strong className="text-green-400"> ν(Co-N) 515 cm⁻¹</strong> — Co-N bog'i.
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-8 space-y-6">
          ...
          <div className="bg-purple-950/40 p-4 rounded-xl border border-purple-700/30 relative h-96">
            <svg viewBox="0 0 600 280" className="w-full h-full overflow-visible" role="img" aria-label="IQ spektr grafigi">
              <title>IQ spektr grafigi — trans-[Co(en)₂Cl₂]Cl</title>
              ...
              {COMPOUND.irPeaks.map((peak, i) => {
                ...
                const isImportant = peak.freq === 325 || peak.freq === 515
                return (
          ...
          <div className="flex flex-wrap gap-3">
            {COMPOUND.irPeaks.map((p, i) => {
              const isImportant = p.freq === 325 || p.freq === 515
              return (
                <button
                  key={i}
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-8 space-y-6">
                ...
                {COMPOUND.irPeaks.map((p, i) => {
                  ...
                  return (
                    <tr key={i} className={`border-b border-purple-800/30 hover:bg-purple-800/20 ${isImportant ? 'bg-green-900/20' : ''}`}>
                      <td className={`py-3 px-4 font-mono font-bold ${isImportant ? 'text-green-400' : 'text-yellow-400'}`}>
                        {p.freq}
          ...
          <div className="bg-green-600/10 border border-green-500/30 rounded-xl p-5">
            <p className="text-green-300 text-sm">
              <strong>⭐ MUHIM:</strong> ν(Co-Cl) = 325 cm⁻¹ cho'qqisi TRANS izomer belgisi (1 ta cho'qqi, A₂ᵤ).
              Cis izomerda 330 va 310 cm⁻¹ (2 ta cho'qqi). Bu cis/trans farqlashning IQ belgisi!
            </p>
          </div>
        </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-8 space-y-6">
          ...
          <p className="text-purple-200 leading-relaxed mb-6">
            <strong className="text-green-400">Aquation</strong> — Cl⁻ ning H₂O bilan almashinishi.
            Trans izomer tezroq aquatsiyalanadi (t₁/₂ ≈ 5.5 soat, 25°C). Cis izomer sekinroq.
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div>
              ...
              <div className="text-xl font-mono font-bold text-green-400">{kineticsResult.k} s⁻¹</div>
            </div>
            <div>
              <div className="text-xs text-purple-400">Yarim umr (t₁/₂):</div>
              <div className="text-xl font-mono font-bold text-green-400">{kineticsResult.t_half_hours} soat</div>
            </div>
            <div>
              <div className="text-xs text-purple-400">Yarim umr (minut):</div>
              <div className="text-xl font-mono font-bold text-green-400">{kineticsResult.t_half_min} minut</div>
            </div>
          </div>
          ...
          <div className="bg-green-600/10 border border-green-500/30 rounded-xl p-5">
            <p className="text-green-300 text-sm">
              ...
              Mahsulot: trans-[Co(en)₂(H₂O)Cl]²⁺ + Cl⁻. Rang o'zgarishi: yashil → och yashil.
            </p>
          </div>
        </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-8 space-y-6">
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-purple-200">
                {COMPOUND.wernerComparison.map((row, i) => (
                  <tr key={i} className={`border-b border-purple-800/30 hover:bg-purple-800/20 ${row.complex.includes("trans") ? "bg-green-900/20" : ""}`}>
                    <td className="py-3 px-4 font-bold text-green-400">{row.complex}</td>
                    <td className="py-3 px-4">{row.color}</td>
                    <td className="py-3 px-4 font-mono text-green-400">{row.lm_range}</td>
                    <td className="py-3 px-4">{row.ions}</td>
                    <td className="py-3 px-4 text-green-400">{row.type}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="bg-green-600/10 border border-green-500/30 rounded-xl p-5">
            <p className="text-green-300 text-sm">
              <strong>Muhim:</strong> trans-[Co(en)₂Cl₂]Cl ning Λm ≈ 240-260 S·cm²/mol — 1:1 elektrolit (2 ion).
        ...
        <div className="bg-gradient-to-r from-green-600/10 to-purple-600/10 border border-green-500/20 rounded-2xl p-8">
          ...
          <ol className="space-y-2 text-purple-200 list-decimal list-inside">
            <li><strong className="text-green-400">Trans izomer:</strong> D₂ₕ simmetriya, yashil rang, Λm ≈ 250 S·cm²/mol</li>
            <li><strong className="text-green-400">Konduktometriya cheklovi:</strong> cis izomer bilan deyarli bir xil Λm — farqlay olmaydi</li>
            <li><strong className="text-green-400">IR belgisi:</strong> Co-Cl cho'qqisi 325 cm⁻¹ (1 ta cho'qqi, A₂ᵤ)</li>
            <li><strong className="text-green-400">UV-Vis farqlash:</strong> trans λmax = 575 nm, cis = 535 nm</li>
            <li><strong className="text-green-400">Kinetik farqlash:</strong> trans tezroq aquatsiyalanadi (t₁/₂ ≈ 5.5 soat)</li>
            <li><strong className="text-green-400">Xelat effekti:</strong> en ligand barqarorlikni oshiradi</li>
            <li><strong className="text-green-400">Diamagnit:</strong> Co³⁺ d⁶, past spin</li>
          </ol>
        </div>

        <div className="flex justify-between pt-6">
          <Link href="/ilmiy/tahlil/iq/birikmalar/cis-co-en2-cl2-cl" className="px-6 py-3 border border-purple-500 rounded-xl hover:bg-purple-800/50 text-purple-300 transition-all">
            ← cis-[Co(en)₂Cl₂]Cl
          </Link>
          <Link href="/ilmiy/tahlil/iq/birikmalar" className="px-6 py-3 bg-green-600/80 rounded-xl hover:bg-green-500 text-white font-semibold transition-all">
            Birikmalar ro'yxati →
          </Link>
        </div>
      ...
      <footer className="border-t border-purple-800/30 py-6 mt-6">
        <div className="max-w-6xl mx-auto px-4 text-center text-xs text-purple-500">
          <p>© 2026 Koordinatsion kimyo tahlil portali • trans-[Co(en)₂Cl₂]Cl • IQ spektroskopiya moduli</p>
        </div>
      </footer>
    </main>
  )
