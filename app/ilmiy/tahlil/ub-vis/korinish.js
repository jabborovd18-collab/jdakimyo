...
const UBVIS_DATA = {
  ...
  spectrochemicalSeries: [
    ...
    { ligand: "H₂O", relative: 1.00, class: "Standart (Δo₀)", color: "text-amber-400 font-bold", note: "Standart ligand" },
  ...
  nephelauxeticSeries: [
    ...
    { ligand: "H₂O", beta: 1.00, class: "Standart", color: "text-amber-400 font-bold" },
  ...
  isomerDetection: [
    ...
    },
    {
      ...
      isomers: [
        ...
        { type: "[Fe(CN)₆]⁴⁻ LS (d⁶)", color: "text-amber-400 font-bold", symmetry: "Oh", bands: "270 nm (MLCT)", diagnostic: "Sariq — MLCT tufayli" },
      ],
...
export default function UBVisSpektroskopiya() {
  ...
  const currentZone = useMemo(() => {
    ...
    if (l < 280) return { name: "Uzoq UB (Far UV)", desc: "π→π* o'tishlar (aromatik bpy, phen, phen), yuqori intensivlikdagi LMCT tasmalari.", color: "text-[var(--v3-xira)]", bgColor: "bg-purple-400" }
    ...
    if (l < 590) return { name: "Ko'rinuvchi — sariq", desc: "Yutilsa — ko'k. [Cu(H₂O)₆]²⁺ havorangi shu tufayli.", color: "text-amber-400 font-bold", bgColor: "bg-yellow-400" }
  ...
  return (
    <div data-fon={fonKaliti} className="v3 min-h-screen flex flex-col text-[var(--v3-matn)] bg-[var(--v3-fon)] transition-colors duration-200">
      ...
      <header className="border-b border-[var(--v3-chiziq)] sticky top-0 z-40 bg-[var(--v3-fon-2)]/90 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-4 py-3.5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span>16 Ta Birikma Bazasini Ko{"'"}rish</span>
      ...
      <section className="max-w-6xl mx-auto px-4 py-6 space-y-6">
        ...
        <Link
          href="/ilmiy/tahlil/ub-vis/birikmalar"
          className="group block v3-panel-karta p-6 hover:bg-pink-900/60 hover:border-pink-500/60 transition-all transform hover:-translate-y-1 hover:shadow-xl hover:shadow-pink-500/10"
        >
          <div className="flex items-center gap-4">
            <div className="text-5xl group-hover:scale-110 transition-transform duration-300"></div>
            <div className="flex-1">
              <h3 className="text-xl font-bold text-[var(--v3-urgu)] group-hover:text-[var(--v3-urgu)] transition-colors">
                Birikmalarning UB-Vis tahlili
              </h3>
              <p className="text-[var(--v3-matn)] text-sm mt-1 group-hover:text-[var(--v3-matn)] transition-colors">
            ...
            <div className="text-3xl text-[var(--v3-urgu)] group-hover:translate-x-1 transition-transform">→</div>
          </div>
          <div className="flex flex-wrap gap-2 mt-4">
            <span className="bg-pink-600/20 text-[var(--v3-urgu)] border border-pink-600/30 px-3 py-1 rounded-full text-xs">Birikmalar katalogi</span>
            <span className="bg-purple-600/20 text-[var(--v3-xira)] border border-purple-600/30 px-3 py-1 rounded-full text-xs">d–d o'tishlar</span>
            <span className="bg-blue-600/20 text-blue-400 border border-blue-600/30 px-3 py-1 rounded-full text-xs">Δo hisoblash</span>
            <span className="bg-yellow-600/20 text-amber-400 font-bold border border-yellow-600/30 px-3 py-1 rounded-full text-xs">Racah B, β</span>
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Manba: P. Atkins — Physical Chemistry, A. B. P. Lever — Inorganic Electronic Spectroscopy</p>

          <div className="bg-pink-600/10 border border-pink-500/30 rounded-xl p-6 mb-6">
            <p className="text-[var(--v3-matn)] leading-relaxed">
              <strong className="text-amber-400 font-bold">UB-Vis (Ultrabinafsha–ko'rinadigan) spektroskopiya</strong> —
              molekulaning elektron holatlari orasidagi <strong className="text-amber-400 font-bold">kvantlangan energiya
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-5">
              <h3 className="text-[var(--v3-urgu)] font-bold mb-2 text-sm"> Asosiy tenglama</h3>
              <div className="text-amber-300 font-bold text-lg font-mono text-center py-3">E = hν = hc/λ</div>
              <div className="text-xs text-[var(--v3-matn)] space-y-1">
            ...
            <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-5">
              <h3 className="text-[var(--v3-urgu)] font-bold mb-2 text-sm"> Beer-Lambert qonuni</h3>
              <div className="text-amber-300 font-bold text-lg font-mono text-center py-3">A = ε · c · l</div>
              <div className="text-xs text-[var(--v3-matn)] space-y-1">
            ...
            <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-5">
              <h3 className="text-[var(--v3-urgu)] font-bold mb-2 text-sm"> Tanlash qoidalari</h3>
              <div className="text-amber-300 font-bold text-sm font-mono text-center py-3">ΔS = 0<br/>g ↔ u<br/>Δl = ±1</div>
              <div className="text-xs text-[var(--v3-matn)] space-y-1">
          ...
          <div className="bg-blue-950/40 border border-blue-700/30 rounded-xl p-5">
            ...
            <ul className="text-xs text-[var(--v3-matn)] space-y-2 list-disc list-inside">
              <li><strong className="text-amber-300 font-bold">Rang manbai:</strong> Kompleks birikmalarning ranglari aynan UB-Vis sohadagi yutilishlar natijasi</li>
              <li><strong className="text-amber-300 font-bold">Δo (kristall maydon parametri):</strong> Ligand kuchining eng aniq o'lchovi</li>
              <li><strong className="text-amber-300 font-bold">Oksidlanish darajasi:</strong> [Fe(CN)₆]³⁻ (qizil) vs [Fe(CN)₆]⁴⁻ (sariq) — MLCT vs LMCT farqi</li>
              <li><strong className="text-amber-300 font-bold">Spin holati:</strong> HS vs LS ni polosalar soni va energiyasi bo'yicha aniqlash</li>
              <li><strong className="text-amber-300 font-bold">Geometriya:</strong> Oh, Td, D₄ₕ farqlari polosalar tuzilishida namoyon</li>
              <li><strong className="text-amber-300 font-bold">Kimyoviy analitika:</strong> Kalibrash egri chiziqlari yordamida ionlar konsentratsiyasini aniqlash</li>
              <li><strong className="text-amber-300 font-bold">Kinetika:</strong> A(t) egri chiziqlaridan reaksiya tezligi</li>
            </ul>
          </div>
        </div>
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">λ sliderni harakatlantiring — energiya, chastota va rangni ko'ring</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6 text-center">
            <div className="p-4 rounded-lg bg-[var(--v3-yuza-2)] border border-[var(--v3-chiziq)] border border-[var(--v3-chiziq)]">
              <div className="text-[var(--v3-xira)] text-xs mb-1">To'lqin uzunligi (λ)</div>
              <div className="text-amber-300 font-bold text-2xl font-bold font-mono">{lambdaSlider} <span className="text-sm">nm</span></div>
            </div>
            <div className="p-4 rounded-lg bg-[var(--v3-yuza-2)] border border-[var(--v3-chiziq)] border border-[var(--v3-chiziq)]">
              <div className="text-[var(--v3-xira)] text-xs mb-1">To'lqin soni (ν̃)</div>
              <div className="text-cyan-300 text-2xl font-bold font-mono">{wavenumber} <span className="text-sm">cm⁻¹</span></div>
            </div>
            <div className="p-4 rounded-lg bg-[var(--v3-yuza-2)] border border-[var(--v3-chiziq)] border border-[var(--v3-chiziq)]">
              <div className="text-[var(--v3-xira)] text-xs mb-1">Energiya</div>
          ...
          <div className={`mt-6 rounded-xl p-5 border ${currentZone.color.replace('text-', 'border-').replace('-400', '-500/50').replace('-500', '-500/50').replace('-700', '-500/50')} bg-purple-950/40`}>
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-[var(--v3-matn)] text-sm mt-1">{currentZone.desc}</p>
              </div>
            </div>
          </div>
              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="bg-purple-950/60 border-b border-[var(--v3-chiziq)]">
                    <th className="px-3 py-2 text-left text-[var(--v3-xira)]">λ (nm)</th>
                    <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Yutilgan rang</th>
                    <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Ko'rinuvchi rang</th>
                    <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Namuna kompleks</th>
                  </tr>
                </thead>
                <tbody>
                  {UBVIS_DATA.colorWheel.map((row, i) => (
                    <tr key={i} className="border-b border-[var(--v3-chiziq)] hover:bg-purple-900/30">
                      <td className="px-3 py-2 font-mono text-amber-300 font-bold">{row.lambdaRange}</td>
                      <td className="px-3 py-2">
                        <div className="flex items-center gap-2">
                          <div className="w-6 h-6 rounded" style={{background: row.hex}}></div>
                          <span className="text-[var(--v3-matn)]">{row.absorbed}</span>
                        </div>
                      </td>
                      <td className="px-3 py-2">
                        <div className="flex items-center gap-2">
                          <div className="w-6 h-6 rounded" style={{background: row.perceivedHex}}></div>
                          <span className="text-[var(--v3-matn)]">{row.perceived}</span>
                        </div>
                      </td>
                      <td className="px-3 py-2 text-[var(--v3-matn)] italic">{row.example}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">d–d, LMCT, MLCT, LLCT, IL va f–f o'tishlar — kompleks birikmalar spektrining asosi</p>
            ...
            <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                <div className="bg-purple-900/40 rounded-lg p-3 border border-[var(--v3-chiziq)]">
                  <div className="text-xs text-[var(--v3-xira)] mb-1">Energiya</div>
                  <div className="text-sm text-amber-300 font-bold font-mono">{UBVIS_DATA.transitionTypes[activeTransition].energy}</div>
                </div>
                <div className="bg-purple-900/40 rounded-lg p-3 border border-[var(--v3-chiziq)]">
                  <div className="text-xs text-[var(--v3-xira)] mb-1">To'lqin uzunligi</div>
                  <div className="text-sm text-cyan-300 font-mono">{UBVIS_DATA.transitionTypes[activeTransition].lambda}</div>
                </div>
                <div className="bg-purple-900/40 rounded-lg p-3 border border-[var(--v3-chiziq)]">
                  <div className="text-xs text-[var(--v3-xira)] mb-1">Molyar ε</div>
              ...
              <div className="bg-blue-900/20 border border-blue-700/30 rounded-lg p-4 mb-3">
                ...
                <div className="text-sm text-[var(--v3-matn)]">{UBVIS_DATA.transitionTypes[activeTransition].selectionRule}</div>
              </div>

              <div className="bg-yellow-900/20 border border-yellow-700/30 rounded-lg p-4 mb-3">
                <div className="text-xs text-amber-400 font-bold font-bold mb-1">Namuna:</div>
                <div className="text-sm text-[var(--v3-matn)] italic">{UBVIS_DATA.transitionTypes[activeTransition].example}</div>
              </div>

              <div className="bg-purple-900/20 border border-[var(--v3-chiziq)] rounded-lg p-4">
                <div className="text-xs text-[var(--v3-urgu)] font-bold mb-2">🎓 Nazariy izoh:</div>
                <div className="text-sm text-[var(--v3-matn)] leading-relaxed">{UBVIS_DATA.transitionTypes[activeTransition].note}</div>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Manba: H. Bethe (1929), J. H. Van Vleck (1935) — Ligand Field Theory</p>
          ...
          <div className="bg-blue-600/10 border border-blue-500/30 rounded-xl p-6 mb-6">
            <p className="text-[var(--v3-matn)] leading-relaxed text-sm">
              <strong className="text-amber-400 font-bold">Kristall maydon nazariyasi (CFT)</strong> — ligandlarni negativ nuqta zaryadlar
              deb hisoblab, ular hosil qilgan elektrostatik maydonning metall d-orbitallariga ta'sirini o'rganadi.
              Bu maydon <strong className="text-amber-400 font-bold">d-orbitallar yorilishiga</strong> (splitting) olib keladi va
              <strong className="text-amber-400 font-bold"> rangning asosiy manbai</strong> bo'ladi.
            </p>
          </div>
            ...
            <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="bg-purple-900/40 rounded-lg p-4 border border-[var(--v3-chiziq)]">
                  <div className="text-xs text-[var(--v3-xira)] mb-1">Yorilish sxemasi:</div>
                  <div className="text-sm text-amber-300 font-bold font-mono">{UBVIS_DATA.crystalField[activeGeom].splitting}</div>
                </div>
                <div className="bg-purple-900/40 rounded-lg p-4 border border-[var(--v3-chiziq)]">
                  <div className="text-xs text-[var(--v3-xira)] mb-1">Yoriqlanish parametri:</div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-xs">
                  <thead>
                    <tr className="bg-purple-950/60 border-b border-[var(--v3-chiziq)]">
                      <th className="px-3 py-2 text-left text-[var(--v3-xira)]">d-konfiguratsiya</th>
                      <th className="px-3 py-2 text-left text-[var(--v3-xira)]">CFSE</th>
                      <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Spin (S)</th>
                      <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Namuna</th>
                    </tr>
                  </thead>
                  <tbody>
                    {UBVIS_DATA.crystalField[activeGeom].cfseFormulas.map((r, i) => (
                      <tr key={i} className="border-b border-[var(--v3-chiziq)] hover:bg-purple-900/30">
                        <td className="px-3 py-2 text-amber-300 font-bold font-mono">{r.config}</td>
                        <td className="px-3 py-2 text-cyan-300 font-mono">{r.cfse}</td>
                        <td className="px-3 py-2 text-green-300 font-mono">{r.spin}</td>
                        <td className="px-3 py-2 text-[var(--v3-matn)] italic">{r.example}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Manba: F. A. Cotton — Chemical Applications of Group Theory</p>
          ...
          {UBVIS_DATA.selectionRules[activeSelectionRule] && (
            <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-6">
              ...
              <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4 mb-4">
                <div className="text-amber-300 font-bold text-2xl font-mono text-center">
                  {UBVIS_DATA.selectionRules[activeSelectionRule].formula}
                </div>
              </div>
              <p className="text-[var(--v3-matn)] text-sm mb-4">{UBVIS_DATA.selectionRules[activeSelectionRule].description}</p>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="bg-green-900/20 border border-green-700/30 rounded-lg p-4">
                  <div className="text-green-400 font-bold text-xs mb-2"> RUXSAT ETILGAN</div>
                  <div className="text-sm text-[var(--v3-matn)]">{UBVIS_DATA.selectionRules[activeSelectionRule].allowed}</div>
                ...
                <div className="bg-red-900/20 border border-red-700/30 rounded-lg p-4">
                  ...
                  <div className="text-sm text-[var(--v3-matn)]">{UBVIS_DATA.selectionRules[activeSelectionRule].forbidden}</div>
              ...
              <div className="bg-blue-900/20 border border-blue-700/30 rounded-lg p-4">
                ...
                <div className="text-sm text-[var(--v3-matn)]">{UBVIS_DATA.selectionRules[activeSelectionRule].note}</div>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Optik zichlik (A) va transmittans (T%) ni real vaqtda hisoblang</p>

          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-5 mb-6">
            <div className="text-amber-300 font-bold text-2xl font-mono text-center">A = ε · c · l</div>
            <div className="text-[var(--v3-matn)] text-xs text-center mt-2">Beer-Lambert-Bouguer qonuni</div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-5">
              <label className="text-xs text-[var(--v3-xira)] block mb-2">ε (molyar koeffitsient, M⁻¹·sm⁻¹)</label>
              <input
                type="range"
                min="1"
                max="50000"
              ...
              />
              <div className="text-amber-300 font-bold text-2xl font-mono text-center mt-2">{bl_eps.toLocaleString()}</div>
            ...
            <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-5">
              <label className="text-xs text-[var(--v3-xira)] block mb-2">c (konsentratsiya, mol/L)</label>
              <input
                type="range"
                min="0.00001"
                max="0.1"
            ...
            <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-5">
              <label className="text-xs text-[var(--v3-xira)] block mb-2">l (kyuveta, sm)</label>
              <input
                type="range"
                min="0.1"
                max="10"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gradient-to-br from-pink-900/40 to-purple-900/40 border-2 border-pink-500/50 rounded-xl p-6 text-center">
              <div className="text-xs text-[var(--v3-urgu)] mb-2">Optik zichlik (Absorbance)</div>
            ...
            <div className="space-y-2">
              {UBVIS_DATA.beerLambert.limitations.map((lim, i) => (
                <div key={i} className="grid grid-cols-1 md:grid-cols-3 gap-2 text-xs bg-red-950/20 rounded p-3">
                  ...
                  <div className="text-[var(--v3-matn)]">{lim.issue}</div>
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Ligandning maydon kuchini o'lchash tartibi — Tsuchida (1938) ilk taklif qilgan</p>
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 mb-6">
            ...
            <div className="text-[var(--v3-matn)] text-xs text-center mt-2">Chapdan o'ngga — Δo qiymati o'sadi</div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {UBVIS_DATA.spectrochemicalSeries.map((l, i) => (
              <div key={i} className={`bg-purple-950/40 rounded-lg p-3 border ${l.color ? l.color.replace('text-', 'border-').replace('-400', '-500/50').replace('-500', '-500/50') : 'border-[var(--v3-chiziq)]'} flex items-center justify-between`}>
                <div>
                  <div className={`text-sm font-bold ${l.color || 'text-[var(--v3-matn)]'}`}>{l.ligand}</div>
                  <div className="text-xs text-[var(--v3-xira)]">{l.class}</div>
                  {l.note && <div className="text-xs text-amber-300 font-bold italic mt-1">{l.note}</div>}
                </div>
                <div className="text-right">
                  <div className="text-xs text-[var(--v3-xira)]">Δo/Δo(H₂O)</div>
          ...
          <div className="mt-6 bg-blue-900/20 border border-blue-700/30 rounded-xl p-5">
            ...
            <ul className="text-xs text-[var(--v3-matn)] space-y-1 list-disc list-inside">
              <li><strong className="text-red-300">Zaif maydon</strong> (I⁻, Br⁻, Cl⁻): π-donor ligandlar → HS (yuqori spin) beradi</li>
              <li><strong className="text-amber-300 font-bold">O'rta maydon</strong> (H₂O, NH₃): standart σ-donor</li>
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Manba: C. K. Jørgensen — β = B(kompleks)/B₀(erkin ion)</p>

          <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-xl p-5 mb-6">
            <p className="text-[var(--v3-matn)] text-sm leading-relaxed">
              <strong className="text-amber-300 font-bold">Nefelauksetik samara</strong> (nephelauxetic — «bulut kengaytiruvchi») —
              koordinatsiya natijasida d-elektronlar bulutining kengayishi va Racah <strong>B</strong> parametrining
              pasayishi. Bu <strong className="text-amber-300 font-bold">metall-ligand bog'ining kovalentlik</strong> darajasini
              ko'rsatadi: β qanchalik kichik bo'lsa, bog' shunchalik kovalent.
            </p>
            <div className="text-amber-300 font-bold text-xl font-mono text-center mt-3">β = B(kompleks) / B(erkin ion)</div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {UBVIS_DATA.nephelauxeticSeries.map((l, i) => (
              <div key={i} className="bg-purple-950/40 rounded-lg p-3 border border-[var(--v3-chiziq)] flex items-center justify-between">
                ...
                <div className="text-right">
                  <div className="text-xs text-[var(--v3-xira)]">β</div>
                  <div className={`font-mono text-lg ${l.beta < 0.7 ? 'text-red-400' : l.beta < 0.85 ? 'text-amber-300 font-bold' : 'text-green-300'}`}>
                    {l.beta.toFixed(2)}
                  </div>
                </div>
              </div>
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Yerdagi holat va qo'zg'algan holatlar — Russell-Saunders terminlar</p>
          ...
          {UBVIS_DATA.keyTransitions[activeKeyTransition] && (
            <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-6">
              <div className="flex flex-wrap items-center gap-3 mb-4">
                <h3 className="text-xl font-bold text-amber-300 font-bold font-mono">
                ...
                <span className="px-3 py-1 rounded-full bg-purple-900/40 border border-[var(--v3-chiziq)] text-[var(--v3-matn)] text-xs font-mono">
                  Yer holati: {UBVIS_DATA.keyTransitions[activeKeyTransition].groundTerm}
                </span>
                <span className="px-3 py-1 rounded-full bg-pink-900/40 border border-pink-700/50 text-[var(--v3-urgu)] text-xs">
              ...
              <div className="overflow-x-auto mb-4">
                <table className="w-full text-xs">
                  <thead>
                    <tr className="bg-purple-950/60 border-b border-[var(--v3-chiziq)]">
                      <th className="px-3 py-2 text-left text-[var(--v3-xira)]">O'tish</th>
                      <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Energiya (cm⁻¹)</th>
                      <th className="px-3 py-2 text-left text-[var(--v3-xira)]">λ (nm)</th>
                      <th className="px-3 py-2 text-left text-[var(--v3-xira)]">ε (M⁻¹·sm⁻¹)</th>
                      <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Izoh</th>
                    </tr>
                  </thead>
                  <tbody>
                    {UBVIS_DATA.keyTransitions[activeKeyTransition].transitions.map((t, i) => (
                      <tr key={i} className="border-b border-[var(--v3-chiziq)] hover:bg-purple-900/30">
                        <td className="px-3 py-2 text-amber-300 font-bold font-mono">{t.symbol}</td>
                        ...
                        <td className="px-3 py-2 text-[var(--v3-matn)] italic">{t.note || "—"}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                ...
                <div className="bg-pink-900/20 border border-pink-700/30 rounded-lg p-3">
                  <div className="text-xs text-[var(--v3-urgu)] mb-1">Rang</div>
                  <div className="text-[var(--v3-urgu)]">{UBVIS_DATA.keyTransitions[activeKeyTransition].color}</div>
                </div>
              </div>

              {UBVIS_DATA.keyTransitions[activeKeyTransition].note && (
                <div className="bg-yellow-900/20 border border-yellow-700/30 rounded-lg p-4">
                  <div className="text-xs text-amber-400 font-bold font-bold mb-1">📝 Ilmiy izoh:</div>
                  <div className="text-sm text-[var(--v3-matn)]">{UBVIS_DATA.keyTransitions[activeKeyTransition].note}</div>
                </div>
              )}
            </div>
          )}
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">sis/trans, HS/LS, geometrik izomerlar — spektral farqlar</p>
          ...
          {UBVIS_DATA.isomerDetection[activeIsomer] && (
            <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-6">
                  ...
                  <div key={i} className={`bg-purple-900/30 border ${iso.color.replace('text-', 'border-').replace('-400', '-500/50')} rounded-lg p-4`}>
                    ...
                    <div className="text-xs text-[var(--v3-matn)] space-y-1">
                      ...
                      <div className="mt-2 pt-2 border-t border-[var(--v3-chiziq)]">
                        <strong className="text-amber-300 font-bold">Diagnostika:</strong> {iso.diagnostic}
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="bg-blue-900/20 border border-blue-700/30 rounded-lg p-4 mb-3">
                ...
                <div className="text-sm text-[var(--v3-matn)]">{UBVIS_DATA.isomerDetection[activeIsomer].groupTheory}</div>
              </div>

              <div className="bg-green-900/20 border border-green-700/30 rounded-lg p-4">
                <div className="text-xs text-green-400 font-bold mb-1"> Amaliy ahamiyat:</div>
                <div className="text-sm text-[var(--v3-matn)]">{UBVIS_DATA.isomerDetection[activeIsomer].biologicalNote}</div>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Manba: G. Racah — Phys. Rev. (1943)</p>

          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-purple-950/60 border-b border-[var(--v3-chiziq)]">
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Belgi</th>
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Nomi</th>
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Ta'rifi</th>
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Qiymati</th>
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Izoh</th>
                </tr>
              </thead>
              <tbody>
                {UBVIS_DATA.racahParameters.map((r, i) => (
                  <tr key={i} className="border-b border-[var(--v3-chiziq)] hover:bg-purple-900/30">
                    <td className="px-3 py-2 text-amber-300 font-bold font-mono font-bold">{r.term}</td>
                    <td className="px-3 py-2 text-white">{r.name}</td>
                    <td className="px-3 py-2 text-[var(--v3-matn)]">{r.desc}</td>
                    <td className="px-3 py-2 text-cyan-300 font-mono">{r.value}</td>
                    <td className="px-3 py-2 text-[var(--v3-matn)] italic">{r.note}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="mt-6 bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div>
                <div className="text-amber-300 font-bold font-mono mb-2">²ˢ⁺¹L<sub>J</sub></div>
                <ul className="text-[var(--v3-matn)] space-y-1 list-disc list-inside">
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Manba: Y. Tanabe, S. Sugano — J. Phys. Soc. Japan (1954)</p>

          <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-5 mb-6">
            <p className="text-[var(--v3-matn)] text-sm leading-relaxed">
              <strong className="text-amber-300 font-bold">Tanabe-Sugano diagrammalari</strong> — kompleks birikmalarning
              elektron holatlari energiyasini (E/B) ligand maydon kuchi (Δo/B) ga nisbatan chizmasi. Bu diagrammalar
              yordamida <strong className="text-amber-300 font-bold">Δo, B va spin holatini</strong> aynan aniqlash mumkin.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-5">
              <h4 className="text-[var(--v3-urgu)] font-bold mb-3 text-sm"> Diagramma tuzilishi</h4>
              <ul className="text-xs text-[var(--v3-matn)] space-y-2 list-disc list-inside">
            ...
            <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-5">
              <h4 className="text-[var(--v3-urgu)] font-bold mb-3 text-sm"> Ishlatish tartibi</h4>
              <ol className="text-xs text-[var(--v3-matn)] space-y-2 list-decimal list-inside">
          ...
          <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-5">
            ...
            <p className="text-xs text-[var(--v3-xira)] mt-3 italic text-center">
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Amaliy o'lchov usullari va asboblar</p>
            ...
            <div className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-green-900/20 border border-green-700/30 rounded-lg p-3">
                  ...
                  <div className="text-sm text-[var(--v3-matn)]">{UBVIS_DATA.instrumentTypes[activeInstrument].pros}</div>
                </div>
                <div className="bg-red-900/20 border border-red-700/30 rounded-lg p-3">
                  <div className="text-xs text-red-400 font-bold mb-1">❌ Kamchiliklari:</div>
                  <div className="text-sm text-[var(--v3-matn)]">{UBVIS_DATA.instrumentTypes[activeInstrument].cons}</div>
                </div>
                <div className="bg-blue-900/20 border border-blue-700/30 rounded-lg p-3">
                  <div className="text-xs text-blue-400 font-bold mb-1"> Ish diapazoni:</div>
                  <div className="text-sm text-[var(--v3-matn)]">{UBVIS_DATA.instrumentTypes[activeInstrument].freq}</div>
                </div>
                <div className="bg-yellow-900/20 border border-yellow-700/30 rounded-lg p-3">
                  <div className="text-xs text-amber-400 font-bold font-bold mb-1"> Optimal qo'llanilishi:</div>
                  <div className="text-sm text-[var(--v3-matn)]">{UBVIS_DATA.instrumentTypes[activeInstrument].best}</div>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Har bir erituvchining UB cutoff qiymati va qo'llanilish sohasi</p>

          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-purple-950/60 border-b border-[var(--v3-chiziq)]">
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Usul</th>
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Erituvchi</th>
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">UB cutoff</th>
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Afzalliklari</th>
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Kamchiliklari</th>
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Optimal</th>
                </tr>
              </thead>
              <tbody>
                {UBVIS_DATA.samplePreparation.map((s, i) => (
                  <tr key={i} className="border-b border-[var(--v3-chiziq)] hover:bg-purple-900/30">
                    <td className="px-3 py-2 text-amber-300 font-bold font-semibold">{s.name}</td>
                    <td className="px-3 py-2 text-cyan-300 font-mono">{s.solvent}</td>
                    <td className="px-3 py-2 text-green-300 font-mono">{s.cutoff}</td>
                    <td className="px-3 py-2 text-[var(--v3-matn)]">{s.pros}</td>
                    <td className="px-3 py-2 text-red-300">{s.cons}</td>
                    <td className="px-3 py-2 text-[var(--v3-matn)] italic">{s.best}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Spektrdan rang manbaigacha — bosqichma-bosqich yondashuv</p>
          ...
          <div className="space-y-3">
            {UBVIS_DATA.colorAnalysis.map((step, i) => (
              <div key={i} className="bg-purple-950/60 border border-[var(--v3-chiziq)] rounded-xl p-4 flex gap-4 items-start">
                ...
                <div className="flex-1">
                  <div className="text-amber-300 font-bold font-bold text-sm mb-1">{step.task}</div>
                  <div className="text-xs text-[var(--v3-matn)] mb-2"><strong>Usul:</strong> {step.method}</div>
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Nazariyaning shakllanish bosqichlari</p>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="bg-purple-950/40 border border-[var(--v3-chiziq)] rounded-lg p-3 flex gap-4 items-center">
                <div className="text-amber-300 font-bold font-mono font-bold text-sm w-16">{h.year}</div>
                <div className="text-[var(--v3-urgu)] font-semibold text-sm w-32 md:w-40">{h.who}</div>
        ...
        <div className="v3-panel-karta p-8">
          <h2 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
            <span className="text-3xl"></span> 17. UB-Vis vs boshqa spektroskopik usullar
          </h2>
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Qaysi usul qanday holatda eng informativ?</p>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-purple-950/60 border-b border-[var(--v3-chiziq)]">
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Usul</th>
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">O'lchagani</th>
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Diapazon</th>
                  <th className="px-3 py-2 text-left text-[var(--v3-xira)]">Ma'lumot</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-[var(--v3-chiziq)] bg-pink-900/10">
                  <td className="px-3 py-2 text-[var(--v3-urgu)] font-bold">UB-Vis</td>
                  <td className="px-3 py-2 text-[var(--v3-matn)]">Elektron o'tishlar</td>
                  <td className="px-3 py-2 text-cyan-300 font-mono">200–780 nm</td>
                  <td className="px-3 py-2 text-[var(--v3-matn)]">Δo, spin, oksidlanish darajasi, CT</td>
                </tr>
                <tr className="border-b border-[var(--v3-chiziq)]">
                  <td className="px-3 py-2 text-blue-300 font-bold">IQ (IR)</td>
                  <td className="px-3 py-2 text-[var(--v3-matn)]">Tebranish o'tishlari</td>
                  <td className="px-3 py-2 text-cyan-300 font-mono">4000–200 cm⁻¹</td>
                  <td className="px-3 py-2 text-[var(--v3-matn)]">Bog' turlari, ligand denticity, geometriya</td>
                </tr>
                <tr className="border-b border-[var(--v3-chiziq)]">
                  <td className="px-3 py-2 text-green-300 font-bold">Raman</td>
                  <td className="px-3 py-2 text-[var(--v3-matn)]">Qutblanuvchanlik o'zgarishi</td>
                  <td className="px-3 py-2 text-cyan-300 font-mono">4000–50 cm⁻¹</td>
                  <td className="px-3 py-2 text-[var(--v3-matn)]">IQ ga to'ldiruvchi, simmetrik modalar</td>
                </tr>
                <tr className="border-b border-[var(--v3-chiziq)]">
                  <td className="px-3 py-2 text-amber-300 font-bold font-bold">NMR</td>
                  <td className="px-3 py-2 text-[var(--v3-matn)]">Yadro spin holatlari</td>
                  <td className="px-3 py-2 text-cyan-300 font-mono">Radio to'lqin</td>
                  <td className="px-3 py-2 text-[var(--v3-matn)]">Ligandlar strukturasi, dinamika</td>
                </tr>
                <tr className="border-b border-[var(--v3-chiziq)]">
                  <td className="px-3 py-2 text-red-300 font-bold">EPR/ESR</td>
                  <td className="px-3 py-2 text-[var(--v3-matn)]">Toq elektron</td>
                  <td className="px-3 py-2 text-cyan-300 font-mono">Mikroto'lqin</td>
                  <td className="px-3 py-2 text-[var(--v3-matn)]">Paramagnit ionlar, radikal, g-tenzor</td>
                </tr>
                <tr className="border-b border-[var(--v3-chiziq)]">
                  <td className="px-3 py-2 text-orange-300 font-bold">CD</td>
                  <td className="px-3 py-2 text-[var(--v3-matn)]">Chiral yutilish</td>
                  <td className="px-3 py-2 text-cyan-300 font-mono">200–700 nm</td>
                  <td className="px-3 py-2 text-[var(--v3-matn)]">Enantiomerlar (Δ/Λ), sekundar struktura</td>
                </tr>
                <tr className="border-b border-[var(--v3-chiziq)]">
                  <td className="px-3 py-2 text-cyan-300 font-bold">XRD</td>
                  <td className="px-3 py-2 text-[var(--v3-matn)]">Kristall panjara</td>
                  <td className="px-3 py-2 text-cyan-300 font-mono">Rentgen</td>
                  <td className="px-3 py-2 text-[var(--v3-matn)]">Aniq bog' uzunligi, burchak, geometriya</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="v3-panel-karta p-8">
          ...
          <p className="text-[var(--v3-xira)] text-xs mb-6 italic">Bu sahifa quyidagi klassik va zamonaviy manbalarga asoslangan</p>
            ...
            {[
              ...
              <div key={i} className="bg-purple-950/40 border border-[var(--v3-chiziq)] rounded-lg p-4">
                <div className="flex items-start justify-between mb-2">
                  <div className="text-amber-300 font-bold font-bold text-sm">{ref.author}</div>
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-pink-900/40 border border-pink-700/50 text-[var(--v3-urgu)]">{ref.tag}</span>
                </div>
                <div className="text-[var(--v3-matn)] text-xs italic mb-1">{ref.title}</div>
                <div className="text-[var(--v3-xira)] text-xs">
        ...
        >
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              <div className="text-xs text-[var(--v3-urgu)] uppercase tracking-wider mb-2">Keyingi qadam</div>
              <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-[var(--v3-urgu)] transition-colors">
            ...
            <div className="text-4xl text-[var(--v3-urgu)] group-hover:translate-x-2 transition-transform">→</div>
          </div>
        </Link>
