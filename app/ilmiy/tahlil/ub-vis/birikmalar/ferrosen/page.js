    ...
    <div data-fon={fonKaliti} className="v3 min-h-screen flex flex-col text-[var(--v3-matn)] bg-[var(--v3-fon)] transition-colors duration-200">
      ...
      <header className="flex items-center gap-4 px-6 py-4 border-b border-[var(--v3-chiziq)]">
        ...
        <div>
          ...
          <p className="text-[var(--v3-xira)] text-sm">ferrosen • bis(siklopentadienil)temir(II) • Sendvich kompleks • d-d + MLCT</p>
        </div>
      </header>
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="v3-panel-karta p-8 relative overflow-hidden">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            <span className="bg-purple-600/20 text-[var(--v3-xira)] border border-purple-600/30 px-3 py-1 rounded-full text-xs">Sendvich (D<sub>5d</sub>)</span>
            ...
            <span className="bg-yellow-600/20 text-amber-400 font-bold border border-yellow-600/30 px-3 py-1 rounded-full text-xs">d-d + MLCT</span>
          </div>
          ...
          <div className="flex items-baseline gap-4 mb-4">
            ...
            <span className="text-[var(--v3-xira)] text-lg">186.04 g/mol</span>
          </div>
          ...
          <p className="text-[var(--v3-matn)] leading-relaxed mb-6">
            <strong className="text-amber-400 font-bold">UB-Vis spektri</strong>da <strong>ikkita asosiy polosa</strong> kuzatiladi:
            <strong className="text-amber-400 font-bold"> 440 nm (d-d, ε≈90)</strong> — ko'rinadigan sohada, to'q sariq rangga sabab;
            <strong className="text-amber-400 font-bold"> 325 nm (MLCT, ε≈50)</strong> — Fe²⁺ dan Cp halqasiga zaryad ko'chishi.
            Fe²⁺ (d⁶) + 2Cp⁻ (12e⁻) = <strong className="text-amber-400 font-bold">18 valent elektron</strong> — maksimal barqarorlik.
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <div className="p-4 rounded-xl bg-[var(--v3-yuza)] border border-[var(--v3-chiziq)] text-center border border-[var(--v3-chiziq)]">
              <div className="text-[var(--v3-xira)] text-xs mb-1">λ<sub>max</sub> (MLCT)</div>
            ...
            <div className="p-4 rounded-xl bg-[var(--v3-yuza)] border border-[var(--v3-chiziq)] text-center border border-[var(--v3-chiziq)]">
              <div className="text-[var(--v3-xira)] text-xs mb-1">Valent e⁻</div>
              <div className="text-white font-bold">18 ta</div>
            </div>
            <div className="p-4 rounded-xl bg-[var(--v3-yuza)] border border-[var(--v3-chiziq)] text-center border border-[var(--v3-chiziq)]">
              <div className="text-[var(--v3-xira)] text-xs mb-1">Fe−C masofa</div>
              <div className="text-white font-bold">2.04 Å</div>
            </div>
            <div className="p-4 rounded-xl bg-[var(--v3-yuza)] border border-[var(--v3-chiziq)] text-center border border-[var(--v3-chiziq)]">
              <div className="text-[var(--v3-xira)] text-xs mb-1">Oksidlanish</div>
        ...
        <div className="bg-purple-800/20 border border-[var(--v3-chiziq)] rounded-xl p-4">
          <div className="flex flex-wrap gap-4 text-xs text-[var(--v3-xira)]">
            <span><strong className="text-[var(--v3-matn)]">Erituvchi:</strong> Etanol yoki geksan</span>
        ...
        {activeTab === "rang" && (
          <div className="v3-panel-karta p-8 space-y-6">
            ...
            <p className="text-[var(--v3-matn)] leading-relaxed">
              Ferrosen <strong className="text-amber-400 font-bold">ko'k-binafsha nurni yutadi</strong> (~440 nm).
            ...
            <div className="p-5 rounded-xl bg-[var(--v3-yuza)] border border-[var(--v3-chiziq)] border border-[var(--v3-chiziq)]">
              <h3 className="text-amber-400 font-bold font-bold mb-2">Konsentratsiyaga bog'liqlik</h3>
        ...
        {activeTab === "electron18" && (
          <div className="v3-panel-karta p-8 space-y-6">
            ...
            <p className="text-[var(--v3-matn)] leading-relaxed">
              Ferrosen — <strong className="text-amber-400 font-bold">18-elektron qoidasining klassik namunasi</strong>.
            ...
            <div className="bg-yellow-600/10 border border-yellow-500/30 rounded-xl p-5 text-center">
              <p className="text-amber-400 font-bold font-bold text-2xl">Fe²⁺ (d⁶) + 2 × Cp⁻ (6e⁻) = 18 valent elektron</p>
            </div>
        ...
        {activeTab === "oksidlanish" && (
          <div className="v3-panel-karta p-8 space-y-6">
            ...
            <p className="text-[var(--v3-matn)] leading-relaxed">
              Ferrosen oson va qaytar oksidlanadi: <strong className="text-amber-400 font-bold">[Fe(C₅H₅)₂] → [Fe(C₅H₅)₂]⁺ + e⁻</strong> (E° = +0.40 V).
        ...
        <div className="bg-gradient-to-r from-orange-600/10 to-purple-600/10 border border-orange-500/20 rounded-2xl p-8">
          ...
          <ol className="space-y-2 text-[var(--v3-matn)] list-decimal list-inside">
            <li><strong className="text-amber-400 font-bold">d-d (440 nm, ε≈90)</strong> + <strong className="text-amber-400 font-bold">MLCT (325 nm, ε≈50)</strong></li>
            <li><strong className="text-amber-400 font-bold">18-elektron qoidasi</strong> — maksimal barqarorlik, aniq spektr</li>
            <li><strong className="text-amber-400 font-bold">To'q sariq rang</strong> — ko'k-binafsha nur yutilishi hisobiga</li>
            <li><strong className="text-amber-400 font-bold">Oksidlanish:</strong> Ferrosen→Ferroseniy — yangi LMCT polosa (620 nm)</li>
          </ol>
        </div>

        {/* ── NAVIGATSIYA ── */}
        <div className="flex justify-between pt-6">
          <Link href="/ilmiy/tahlil/ub-vis/birikmalar/sisplatin" className="px-6 py-3 border border-purple-500 rounded-xl hover:bg-purple-800/50 text-[var(--v3-matn)] transition-all">
            ← Sisplatin
          </Link>
