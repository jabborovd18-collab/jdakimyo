  ...
  return (
    <div className="flex items-center gap-4 p-5 bg-purple-800/30 rounded-xl border border-[var(--v3-chiziq)]">
      <div className="flex-1 text-center">
        <div className="text-[var(--v3-xira)] text-xs mb-2">Kuchli yutilish sohasi</div>
        ...
        <div className="text-[var(--v3-xira)] text-xs">{engYaqin.rang}</div>
      </div>
      <div className="text-2xl text-[var(--v3-xira)]">→</div>
      <div className="flex-1 text-center">
        <div className="text-[var(--v3-xira)] text-xs mb-2">Ko'rinadigan rang</div>
        ...
        <div className="text-[var(--v3-xira)] text-xs">komplementar</div>
      </div>
    </div>
  )
}
  ...
  return (
    <div className="grid grid-cols-3 gap-3">
      <div className="bg-red-600/10 border border-red-500/30 rounded-xl p-4 text-center">
        ...
        <div className="text-[var(--v3-matn)] text-xs">ΔS = 0</div>
        <div className="text-[var(--v3-xira)] text-xs mt-1">d⁵(QS): RUXSAT</div>
      </div>
      <div className="bg-orange-600/10 border border-orange-500/30 rounded-xl p-4 text-center">
        ...
        <div className="text-[var(--v3-matn)] text-xs">g→g TA'QIQ</div>
        <div className="text-[var(--v3-xira)] text-xs mt-1">O<sub>h</sub>: d-d TA'QIQ</div>
      </div>
      <div className="bg-green-600/10 border border-green-500/30 rounded-xl p-4 text-center">
        ...
        <div className="text-[var(--v3-matn)] text-xs">g→u RUXSAT</div>
        <div className="text-[var(--v3-xira)] text-xs mt-1">LMCT: ε katta!</div>
      </div>
    </div>
  )
}
    ...
    <div data-fon={fonKaliti} className="v3 min-h-screen flex flex-col text-[var(--v3-matn)] bg-[var(--v3-fon)] transition-colors duration-200">
      ...
      <header className="flex items-center gap-4 px-6 py-4 border-b border-[var(--v3-chiziq)]">
        ...
        <div>
          ...
          <p className="text-[var(--v3-xira)] text-sm">kaliy geksasiyanoferrat(III) • Qizil qon tuzi • LMCT dominant • ε≈1000</p>
        </div>
      </header>
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="v3-panel-karta p-8 relative overflow-hidden">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            <span className="bg-purple-600/20 text-[var(--v3-xira)] border border-purple-600/30 px-3 py-1 rounded-full text-xs">Oktaedrik O<sub>h</sub></span>
            ...
            <span className="bg-yellow-600/20 text-amber-400 font-bold border border-yellow-600/30 px-3 py-1 rounded-full text-xs">LMCT dominant</span>
          ...
          <div className="flex items-baseline gap-4 mb-4">
            ...
            <span className="text-[var(--v3-xira)] text-lg">329.24 g/mol</span>
          </div>
          ...
          <p className="text-[var(--v3-matn)] leading-relaxed mb-6">
            <strong className="text-amber-400 font-bold">UB-Vis spektri</strong>da 420 nm atrofidagi kuchli polosa 
            <strong className="text-amber-400 font-bold"> LMCT (Ligand→Metal Charge Transfer)</strong> xarakteriga ega:
            CN⁻ π orbitallaridan Fe³⁺ t₂g orbitallariga zaryad ko'chishi. Bu o'tish 
            <strong className="text-amber-400 font-bold"> Laporte va spin ruxsat etilgan</strong> — ε ≈ 1000 L·mol⁻¹·cm⁻¹.
            d⁵ quyi spin (t₂g⁵) konfiguratsiyada d-d o'tishlar <strong>spin-ruxsat etilgan</strong> (doublet→doublet), 
            lekin <strong className="text-amber-400 font-bold">Laporte-taqiqlangan</strong> (O<sub>h</sub> simmetriya, g→g) 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="p-4 rounded-xl bg-[var(--v3-yuza)] border border-[var(--v3-chiziq)] text-center border border-[var(--v3-chiziq)]">
              <div className="text-[var(--v3-xira)] text-xs mb-1">λ<sub>max</sub> (asosiy)</div>
            ...
            <div className="p-4 rounded-xl bg-[var(--v3-yuza)] border border-[var(--v3-chiziq)] text-center border border-[var(--v3-chiziq)]">
              <div className="text-[var(--v3-xira)] text-xs mb-1">Eritma rangi</div>
              <div className="text-white font-bold">Sariq-qizg'ish</div>
            </div>
            <div className="p-4 rounded-xl bg-[var(--v3-yuza)] border border-[var(--v3-chiziq)] text-center border border-[var(--v3-chiziq)]">
              <div className="text-[var(--v3-xira)] text-xs mb-1">Kristall rangi</div>
              <div className="text-red-400 font-bold">To'q qizil</div>
            </div>
            <div className="p-4 rounded-xl bg-[var(--v3-yuza)] border border-[var(--v3-chiziq)] text-center border border-[var(--v3-chiziq)]">
              <div className="text-[var(--v3-xira)] text-xs mb-1">d-d o'tish</div>
        ...
        <div className="bg-purple-800/20 border border-[var(--v3-chiziq)] rounded-xl p-4">
          <div className="flex flex-wrap gap-4 text-xs text-[var(--v3-xira)]">
            <span><strong className="text-[var(--v3-matn)]">Erituvchi:</strong> H₂O (distillangan)</span>
            ...
            <span><strong className="text-[var(--v3-matn)]">Eslatma:</strong> Yangi tayyorlangan eritma, yorug'likdan himoya qilingan</span>
          </div>
        </div>
          ...
          <div className="v3-panel-karta p-8 space-y-6">
            ...
            <div className="bg-red-600/10 border border-red-500/30 rounded-xl p-5">
              <p className="text-[var(--v3-matn)] text-sm">
                <strong className="text-amber-400 font-bold">Eng muhim xususiyat:</strong> 420 nm dagi kuchli LMCT polosa.
        ...
        {activeTab === "jadval" && (
          <div className="v3-panel-karta p-8 space-y-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead><tr className="border-b border-[var(--v3-chiziq)]">
                  <th className="py-3 px-4 text-[var(--v3-matn)]">λ (nm)</th><th className="py-3 px-4 text-[var(--v3-matn)]">To'lqin soni (cm⁻¹)</th><th className="py-3 px-4 text-[var(--v3-matn)]">O'tish turi</th><th className="py-3 px-4 text-[var(--v3-matn)]">Intensivlik</th><th className="py-3 px-4 text-[var(--v3-matn)]">Tavsif</th>
                </tr></thead>
                <tbody className="text-[var(--v3-matn)]">
                  {[
                    ...
                    <tr key={i} className="border-b border-[var(--v3-chiziq)] hover:bg-purple-800/20">
                      ...
                      <td className="py-3 px-4 font-mono text-sm text-[var(--v3-xira)]">{r[1]}</td>
                      <td className="py-3 px-4 text-sm">{r[2]}</td>
                      <td className="py-3 px-4">{i === 0 ? <span className="text-red-400 font-bold">Juda kuchli</span> : <span className="text-amber-400 font-bold">O'rtacha</span>}</td>
            ...
            <div className="bg-purple-600/10 border border-purple-500/30 rounded-xl p-5">
              <p className="text-[var(--v3-matn)] text-sm">
                <strong className="text-amber-400 font-bold">Eslatma:</strong> d-d o'tishlar (²T₂g → ²T₁g, ²T₂g → ²T₂u) 
        ...
        {activeTab === "rang" && (
          <div className="v3-panel-karta p-8 space-y-6">
            ...
            <p className="text-[var(--v3-matn)] leading-relaxed">
              Ferrisiyanid 420 nm atrofida <strong className="text-amber-400 font-bold">binafsha-ko'k sohaga yaqin nurni 
              kuchli yutadi</strong>. Komplementar rang — sariq-to'q sariq. 
              <strong className="text-amber-400 font-bold">Eritma ko'rinishi sariq-qizg'ish</strong> tuslarda namoyon bo'ladi.
            ...
            <div className="p-5 rounded-xl bg-[var(--v3-yuza)] border border-[var(--v3-chiziq)] border border-[var(--v3-chiziq)] space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[var(--v3-matn)] text-sm">Spin ruxsat (ΔS=0) + Laporte ruxsat (u→g) → ε ≈ 1000</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[var(--v3-matn)] text-sm">Spin ruxsat (ΔS=0, doublet→doublet), lekin Laporte TA'QIQ (g→g) → ε &lt; 1, deyarli ko'rinmaydi</p>
                </div>
              </div>
            </div>
        ...
        {activeTab === "lmct" && (
          <div className="v3-panel-karta p-8 space-y-6">
            ...
            <p className="text-[var(--v3-matn)] leading-relaxed">
              <strong className="text-amber-400 font-bold">LMCT (Ligand to Metal Charge Transfer)</strong> — 
            ...
            <div className="bg-yellow-600/10 border border-yellow-500/30 rounded-xl p-5 text-center">
              <p className="text-amber-400 font-bold font-bold text-lg">CN⁻ (π, to'lgan) → Fe³⁺ (t₂g⁵, 1 ta "teshik")</p>
              <p className="text-[var(--v3-matn)] text-sm mt-2">
        ...
        {activeTab === "energetika" && (
          <div className="v3-panel-karta p-8 space-y-6">
            ...
            <p className="text-[var(--v3-matn)] leading-relaxed">
              Fe³⁺ erkin ioni (d⁵) — <strong className="text-amber-400 font-bold">²D asosiy term</strong> (L=2, S=½).
            ...
            <div className="p-5 rounded-xl bg-[var(--v3-yuza)] border border-[var(--v3-chiziq)] border border-[var(--v3-chiziq)]">
              <h3 className="text-amber-400 font-bold font-bold mb-3">Soddalashtirilgan energetik sathlar:</h3>
              <div className="space-y-2 text-sm font-mono">
                <div className="flex items-center gap-3">
                  <span className="text-[var(--v3-xira)] w-24">↑ Energiya</span>
                  <span className="text-red-400">— LMCT holatlar (CN⁻ π → Fe³⁺)</span>
                </div>
                <div className="flex items-center gap-3 ml-6">
                  <span className="text-amber-400 font-bold">— ²T₂u (d-d, Laporte-taqiq)</span>
                </div>
                <div className="flex items-center gap-3 ml-6">
                  <span className="text-amber-400 font-bold">— ²T₁g (d-d, Laporte-taqiq)</span>
                </div>
                <div className="flex items-center gap-3 ml-6">
            ...
            <div className="bg-purple-600/10 border border-purple-500/30 rounded-xl p-5">
              <p className="text-[var(--v3-matn)] text-sm">
                ...
                • <span className="text-amber-400 font-bold">d-d:</span> ²T₂g → ²T₁g, ²T₂u (kuchsiz, Laporte-taqiq, ε&lt;1)<br/>
        ...
        {activeTab === "taqqos" && (
          <div className="v3-panel-karta p-8 space-y-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead><tr className="border-b border-[var(--v3-chiziq)]">
                  <th className="py-3 px-4 text-[var(--v3-matn)]">Parametr</th><th className="py-3 px-4 text-[var(--v3-matn)]">K₃[Fe(CN)₆]</th><th className="py-3 px-4 text-[var(--v3-matn)]">K₄[Fe(CN)₆]</th>
                </tr></thead>
                <tbody className="text-[var(--v3-matn)]">
                  {[
                    ...
                    <tr key={i} className="border-b border-[var(--v3-chiziq)] hover:bg-purple-800/20">
                      <td className="py-3 px-4 font-bold text-amber-400 font-bold" dangerouslySetInnerHTML={{ __html: r[0] }} />
                      <td className="py-3 px-4 text-red-300" dangerouslySetInnerHTML={{ __html: r[1] }} />
                      <td className="py-3 px-4 text-amber-300 font-bold" dangerouslySetInnerHTML={{ __html: r[2] }} />
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <div className="bg-gradient-to-r from-red-600/10 to-purple-600/10 border border-red-500/20 rounded-2xl p-8">
          ...
          <ol className="space-y-2 text-[var(--v3-matn)] list-decimal list-inside">
            <li><strong className="text-amber-400 font-bold">LMCT dominant:</strong> CN⁻(π) → Fe³⁺(t₂g), λ=420 nm, ε≈1000</li>
            <li><strong className="text-amber-400 font-bold">d⁵ quyi spin (²T₂g):</strong> d-d o'tishlar spin-ruxsat, lekin <strong>Laporte-taqiqlangan</strong></li>
            <li><strong className="text-amber-400 font-bold">Eritma rangi:</strong> sariq-qizg'ish. Kristall: to'q qizil. Rang konsentratsiyaga bog'liq</li>
