...
// ═══════════════════════════════════════════════════════════════════════════════
// [Co(NH₃)₅Cl]Cl₂ (Purpureo tuzi) — ICP-OES / ICP-MS MAHSUS SAHIFASI
// Manbalar: Vogel's Quantitative Chemical Analysis, NIST Isotope Data
// Xususiyat: Werner kompleksi, ichki/tashqi sfera Cl farqi, purpureo
// O'ziga xoslik: ICP ichki/tashqi sferani farqlay OLMAYDI!
...
const COMPOUND = {
  ...
  commonName: "Purpureo-kobalt xlorid (binafsha kristallar)",
  molarMass: 250.44,
  casNumber: "14970-14-0",
  color: "binafsha-qizil kristallar (purpureo)",
  stability: "havoda barqaror, inert Co³⁺ kompleksi, suvda sekin eriydi",
  
  historicalFact: {
    title: "Werner nazariyasi — ichki va tashqi sfera farqi",
    text: "[Co(NH₃)₅Cl]Cl₂ — Werner koordinatsion nazariyasining klassik namunasi. 1893-yilda Alfred Werner taklif qilgan: bitta Cl⁻ ichki sferada (Co³⁺ ga bevosita bog'langan), 2 ta Cl⁻ tashqi sferada (ion sifatida). Bu purpureo (binafsha-qizil) tuzi deb nomlanadi. Taqqoslash uchun: [Co(NH₃)₆]Cl₃ (luteo, sariq) — barcha 3 ta Cl⁻ tashqi sferada. Werner tajribasida AgNO₃ bilan titrlashda: purpureo da faqat 2 ta Cl⁻ cho'kadi (AgCl), luteo da barcha 3 ta cho'kadi. Bu ichki va tashqi sfera farqini isbotladi! ICP tahlilida muhim: ICP <strong>ichki va tashqi sferani farqlay OLMAYDI</strong> — ikkalasi ham bir xil Co signalini beradi.",
    year: "1893-yil"
  },

  uniqueICPFeature: {
    title: "[Co(NH₃)₅Cl]Cl₂ — ICP ichki/tashqi sferani farqlay OLMAYDI!",
    description: "Bu birikma ICP ning eng muhim cheklovini ko'rsatadi — ichki va tashqi sfera Cl⁻ ni farqlay olmaydi. ICP faqat umumiy Co miqdorini o'lchaydi.",
    problem: {
      title: "Ichki/Tashqi sfera farqlanmaydi",
      description: "ICP faqat elementlar miqdorini o'lchaydi — strukturani ko'rmaydi. [Co(NH₃)₅Cl]²⁺ ichki sferada 1 ta Cl⁻ va 2 ta Cl⁻ tashqi sferada — ikkalasi ham bir xil Co signalini beradi!",
      impact: "Purpureo va luteo tuzlarini ICP bilan farqlab bo'lmaydi — AgNO₃ titrlash kerak"
    },
    solution: {
      title: "AgNO₃ titrlash va XRD",
      description: "AgNO₃ bilan titrlashda: purpureo da faqat 2 ta Cl⁻ cho'kadi, luteo da barcha 3 ta cho'kadi. XRD (X-ray diffraction) ham kristall strukturani ko'rsatadi.",
      mechanism: "AgNO₃ + [Co(NH₃)₅Cl]Cl₂ → 2AgCl↓ + [Co(NH₃)₅Cl]²⁺ (faqat tashqi Cl⁻ cho'kadi). ICP buni ko'rmaydi, faqat umumiy Co ni o'lchaydi."
    }
  },
  ...
  icpMS: {
    ...
    collisionCell: "Standart rejim — Co uchun interferensiya kam",
    parameters: {
      Co: {
        mz_primary: 59,
  ...
  theoretical: {
    ...
    Cl:  { mass: 106.350, percent: 39.760, source: "1×Cl (ichki) + 2×Cl (tashqi)", icpSignal: "ICP da ko'rinmaydi (IC kerak)" },
    N:   { mass: 70.035,  percent: 26.228, source: "5×NH₃ (5×N)", icpSignal: "ICP da ko'rinmaydi (EA kerak)" },
    H:   { mass: 15.120,  percent: 5.685,  source: "5×NH₃ (15×H)", icpSignal: "ICP da ko'rinmaydi (EA kerak)" }
  },
  ...
  internalStandards: {
    ...
    standards: [
      ...
      },
      {
        ...
        reason: "Ge massasi (72) Co (59) dan uzoq, lekin matritsa effektlarini yaxshi tuzatadi",
  ...
  experimentalRuns: [
    { id: "ICP-24-1101", date: "2025-12-20", mode: "ICP-MS (Co)", conc_mgL: 55.0, intensity: 264500, percent: 22.00, rsd: 0.8, note: "To'g'ri natija — purpureo [Co(NH₃)₅Cl]Cl₂" },
    { id: "ICP-24-1102", date: "2025-12-20", mode: "ICP-MS (Co)", conc_mgL: 55.2, intensity: 265400, percent: 22.08, rsd: 0.7, note: "Ikkinchi parallel" },
    { id: "ICP-24-1103", date: "2025-12-20", mode: "ICP-OES (Co)", conc_mgL: 55.1, intensity: 264800, percent: 22.04, rsd: 1.2, note: "ICP-OES (228.6 nm)" },
    { id: "ICP-24-1104", date: "2025-12-21", mode: "ICP-MS (Co)", conc_mgL: 55.0, intensity: 264500, percent: 22.00, rsd: 0.8, note: "[Co(NH₃)₆]Cl₃ (luteo) — ICP farqlamaydi!" },
    { id: "ICP-24-1105", date: "2025-12-21", mode: "ICP-MS (Co)", conc_mgL: 55.0, intensity: 264500, percent: 22.00, rsd: 0.8, note: "⚠ ICP purpureo/luteo farqlamaydi!" },
    { id: "ICP-24-1106", date: "2025-12-21", mode: "ICP-MS (Co)", conc_mgL: 44.0, intensity: 211200, percent: 17.60, rsd: 8.5, note: "⚠ Namuna qisman parchalangan (NH₃ yo'qotgan)" },
    { id: "BLANK-12",   date: "2025-12-20", mode: "ICP-MS", conc_mgL: 0.1, intensity: 480, percent: 0.04, rsd: 0.0, note: "Blank (2% HNO₃)" },
    { id: "STD-Co-50",  date: "2025-12-20", mode: "ICP-MS", conc_mgL: 50.0, intensity: 240000, percent: 0.00, rsd: 0.5, note: "NIST Co standarti (50 μg/L)" }
  ],

  samplePrepSteps: [
    { step: 1, title: "Namuna tortish", desc: "Analitik tarozida 50.0 ± 0.1 mg [Co(NH₃)₅Cl]Cl₂ tortiladi. Binafsha-qizil kristallar — purpureo belgisi.", time: "2 daq", critical: true },
    { step: 2, title: "Eritish (HNO₃ da)", desc: "100 mL hajmli kolbaga solib, 10 mL 2% HNO₃ qo'shiladi. Co³⁺ inert — sekin eriydi.", time: "15 daq", critical: true },
    ...
    { step: 8, title: "Natijalarni hisoblash", desc: "%Co hisoblanadi. Nazariy: 22.03%. EHTIYOT: ICP purpureo/luteo farqlamaydi!", time: "1 daq", critical: false }
  ],

  matrixEffects: {
    title: "Matritsa effekti — yuqori tuz konsentratsiyasi muammosi",
    description: "[Co(NH₃)₅Cl]Cl₂ yuqori tuz konsentratsiyasiga ega (39.8% Cl). Bu ICP uchun matritsa effekti yaratadi.",
    problems: [
      {
        problem: "Konus tiqilib qolishi",
        description: "Yuqori tuz konsentratsiyasi (39.8% Cl) sampler va skimmer konuslarida cho'kma hosil qiladi — signal vaqt o'tishi bilan kamayadi (drift).",
        solution: "Namunani 10× yoki 100× suyuqlantirish. Ichki standart qo'shish (drift tuzatish)."
      },
      {
        problem: "Ichki/Tashqi sfera farqi",
        description: "ICP ichki sferadagi Cl⁻ va tashqi sferadagi Cl⁻ ni farqlay olmaydi — ikkalasi ham bir xil Co signalini beradi.",
        solution: "AgNO₃ titrlash kerak — purpureo da faqat 2 ta Cl⁻ cho'kadi, luteo da barcha 3 ta."
      },
      {
  ...
  aasComparison: {
    title: "ICP vs AAS — [Co(NH₃)₅Cl]Cl₂ uchun",
    comparison: [
      ...
      { feature: "Interferensiya", ICP: "⁵⁹Co mononuklid — kam", AAS: "Kam" },
  ...
  relatedMethods: [
    {
      name: "AgNO₃ titrlash",
      role: "Ichki/tashqi sfera Cl⁻ ni farqlaydi — purpureo da 2 ta cho'kadi",
      icpAdvantage: "AgNO₃ titrlash ichki/tashqi farqini ko'rsatadi",
      icpDisadvantage: "ICP farqlay olmaydi!",
      complementarity: "98%"
    },
    {
      name: "XRD (X-ray diffraction)",
      role: "Kristall strukturani ko'rsatadi — purpureo va luteo farqlanadi",
    ...
    },
    {
      ...
      role: "N (26.23%), H (5.69%) — organik qismni tasdiqlaydi",
    ...
    },
    {
      ...
      role: "Co³⁺ ning d-d o'tishlari — purpureo va luteo farqlanadi",
      icpAdvantage: "UV-Vis izomerlarni farqlaydi",
...
export default function CoNH35ClCl2Page() {
  const [activeRun, setActiveRun] = useState("ICP-24-1101")
  ...
  const [showWernerModal, setShowWernerModal] = useState(true)
    ...
    <main className="min-h-screen bg-gradient-to-b from-purple-950 via-pink-950/20 to-blue-950 text-white">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4">
          <div className="bg-gradient-to-br from-pink-950 to-purple-950 border-2 border-pink-500 rounded-2xl p-6 max-w-2xl w-full animate-pulse">
            <h3 className="text-xl font-bold text-pink-400 mb-4 flex items-center gap-2">
              <span className="text-3xl">⚠️</span> WERNER NAZARIYASI — ICHKI/TASHQI SFERA FARQI!
            </h3>
            <p className="text-purple-200 text-sm mb-4">
              <strong className="text-pink-300">[Co(NH₃)₅Cl]Cl₂</strong> da <strong className="text-pink-300">1 ta Cl⁻ ichki sferada</strong> (Co³⁺ ga bevosita bog'langan), <strong className="text-pink-300">2 ta Cl⁻ tashqi sferada</strong> (ion sifatida).
            </p>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <div className="text-purple-200">
                    ICP <strong className="text-pink-300">ichki va tashqi sferani farqlay OLMAYDI</strong> — ikkalasi ham bir xil Co signalini beradi! Purpureo va luteo tuzlarini ICP bilan farqlab bo'lmaydi.
                  </div>
                </div>
                <div>
                  <div className="text-green-400 font-bold mb-2">Yechim:</div>
                  <div className="text-purple-200">
                    <strong className="text-green-300">AgNO₃ titrlash</strong> — purpureo da faqat 2 ta Cl⁻ cho'kadi, luteo da barcha 3 ta cho'kadi. <strong className="text-green-300">XRD</strong> ham farqlaydi.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-pink-900/30 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-pink-300">Werner tajribasi:</strong> AgNO₃ + [Co(NH₃)₅Cl]Cl₂ → 2AgCl↓ + [Co(NH₃)₅Cl]²⁺ (faqat tashqi Cl⁻ cho'kadi). ICP buni ko'rmaydi!
              </p>
            </div>

            <button 
              onClick={() => setShowWernerModal(false)}
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-4">
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                ...
                <span className="px-2 py-1 rounded bg-pink-900/30 border border-pink-700/50 text-pink-400 text-[10px] uppercase tracking-wide">Purpureo</span>
      ...
      <section className="max-w-6xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-purple-200">
            <div className="space-y-3">
              <p className="leading-relaxed">
                <strong className="text-white">[Co(NH₃)₅Cl]Cl₂</strong> — kobalt(III) ning pentaamminkloro kompleksi, Werner nazariyasining klassik namunasi. ICP tahlilida <strong className="text-pink-300">muhim namuna</strong>, chunki:
              </p>
              <ul className="list-disc list-inside space-y-2 marker:text-pink-500 text-xs md:text-sm">
                <li><strong className="text-white">1 ta Cl⁻ ichki sferada</strong>, 2 ta Cl⁻ tashqi sferada</li>
                <li><strong className="text-red-300">ICP ichki/tashqi sferani farqlay OLMAYDI!</strong></li>
                <li>Co³⁺ <strong className="text-pink-300">inert</strong> — plazmada to'liq atomlanadi</li>
                <li>⁵⁹Co <strong className="text-pink-300">100% mononuklid</strong> — ideal signal</li>
        ...
        <div className="bg-gradient-to-r from-pink-900/40 to-red-900/40 border-2 border-pink-700/70 rounded-2xl p-6">
            ...
            <div className="bg-green-950/40 rounded-xl p-5 border-2 border-green-500/50">
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="bg-green-900/30 rounded p-2">
                  <div className="text-green-300 font-bold">AgNO₃ titrlash:</div>
          ...
          <button
            onClick={() => setShowWernerModal(true)}
            className="w-full bg-pink-600 hover:bg-pink-500 text-white py-3 rounded-lg transition-colors text-sm font-bold"
          >
            ⚠️ Werner tajribasi haqida batafsil →
          </button>
        </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-sm text-purple-200 mb-5 leading-relaxed">
            ICP-MS — mass-spektrometriya. ⁵⁹Co <strong className="text-pink-300">100% mononuklid</strong> — hech qanday aralashma yo'q! Interferensiya deyarli yo'q.
          </p>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-4">
            ICP <strong className="text-pink-300">faqat Co</strong> ni o'lchaydi (ICP-OES). Cl, N, H ICP da ko'rinmaydi — ularni EA/IC bilan tekshirish kerak.
          </p>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-sm text-purple-200 mb-4 leading-relaxed">
            ICP-MS har bir izotopni <strong className="text-cyan-300">alohida detektlaydi</strong>. Co ning <strong className="text-pink-300">1 ta tabiiy izotopi</strong> bor — ⁵⁹Co (100%). Hech qanday aralashma yo'q!
          </p>
          ...
          <div className="bg-purple-950/40 p-4 rounded-xl border border-purple-700/30 relative h-72">
            <svg viewBox="0 0 600 260" className="w-full h-full overflow-visible">
              ...
              {COMPOUND.isotopeProfile.Co.isotopes.map((iso, i) => {
                const barWidth = 200
                const gap = 20
                const totalBars = COMPOUND.isotopeProfile.Co.isotopes.length
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <div className="bg-purple-950/40 p-4 rounded-xl border border-purple-700/30 relative h-72">
            <svg viewBox="0 0 600 260" className="w-full h-full overflow-visible">
              ...
              <text x="510" y="48" textAnchor="middle" fontSize="10" fill="#f9a8d4" fontWeight="bold">
                R² = 0.9999
              </text>
            </svg>
          </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          <h2 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
            <span>🔬</span> ICP yugurishlari — Co tahlili (purpureo/luteo farqlanmaydi!)
          </h2>
          <p className="text-xs text-purple-300 mb-6">
            Co <strong className="text-pink-300">standart rejim</strong> bilan o'lchanadi (⁵⁹Co mononuklid). EHTIYOT: ICP purpureo/luteo farqlamaydi!
          </p>

          <div className="flex flex-wrap gap-2 mb-4">
            {COMPOUND.experimentalRuns.map(r => {
              const isOES = r.mode.includes("ICP-OES")
              const isLuteo = r.id === "ICP-24-1104"
              const isNoDifference = r.id === "ICP-24-1105"
              const isDecomposed = r.id === "ICP-24-1106"
              ...
              if (isActive) {
                ...
                else if (isLuteo || isNoDifference) btnClass = "px-3 py-1.5 rounded-lg text-xs font-mono transition-all border bg-pink-600 border-pink-500 text-white shadow-lg shadow-pink-500/20"
                ...
                else btnClass = "px-3 py-1.5 rounded-lg text-xs font-mono transition-all border bg-pink-600 border-pink-500 text-white shadow-lg shadow-pink-500/20"
              } else {
                ...
                else if (isLuteo || isNoDifference) btnClass = "px-3 py-1.5 rounded-lg text-xs font-mono transition-all border bg-pink-900/30 border-pink-700/30 text-pink-300 hover:border-pink-500"
              ...
              return (
                <button 
                  ...
                  className={btnClass}
                >
                  {r.id.split('-').pop()} {isOES && "OES"} {(isLuteo || isNoDifference) && "⚠"} {isDecomposed && "⚠"}
                </button>
              )
            })}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-purple-950/30 rounded-xl p-6 border border-purple-700/30 flex flex-col">
              <h3 className="text-sm font-bold text-pink-400 mb-4 flex justify-between">
                <span>%Co Qiymatlari (purpureo/luteo bir xil!)</span>
              ...
              <div className="flex-1 flex items-end justify-between gap-2 min-h-[180px] pb-2 border-b border-purple-800/50">
                {COMPOUND.experimentalRuns.map((r) => {
                  ...
                  if (isActive) {
                    ...
                    else if (isLuteo || isNoDifference) barClass = "w-full rounded-t transition-all duration-500 z-10 bg-pink-500 shadow-[0_0_15px_rgba(236,72,153,0.4)]"
                    ...
                    else if (isLuteo || isNoDifference) barClass = "w-full rounded-t transition-all duration-500 z-10 bg-pink-700/40"
                  ...
                  return (
                    <div key={r.id} className="flex flex-col items-center flex-1 group cursor-pointer" onClick={() => setActiveRun(r.id)}>
                      ...
                      <div className={`mt-3 text-[9px] font-mono text-center truncate w-full px-1 ${isActive ? (isOES ? 'text-cyan-400' : isLuteo || isNoDifference ? 'text-pink-400' : isDecomposed ? 'text-red-400' : 'text-pink-400') : 'text-purple-600'} font-bold`}>
                        {r.id.split('-').pop()}
                      </div>
                    </div>
                  )
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-5">
            [Co(NH₃)₅Cl]Cl₂ uchun <strong className="text-pink-300">2% HNO₃</strong> ishlatiladi. EHTIYOT: ICP purpureo/luteo farqlamaydi! Ichki standart (Sc) har bir namunaga qo'shiladi.
          </p>
        ...
        <div className="bg-gradient-to-r from-pink-900/40 to-purple-900/40 border border-pink-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-5">
            [Co(NH₃)₅Cl]Cl₂ uchun ICP ni qo'shimcha usullar bilan birgalikda ishlatish — <strong className="text-pink-300">ichki/tashqi sferani farqlash</strong> uchun muhim. <strong className="text-pink-300">AgNO₃ titrlash</strong> va <strong className="text-pink-300">XRD</strong> eng kuchli qo'shimcha metodlar.
          </p>
          ...
          <div className="mt-5 bg-pink-900/20 border border-pink-700/30 rounded-xl p-4">
            ...
            <p className="text-xs text-purple-200 leading-relaxed">
              <strong className="text-white">ICP-MS (Co) + AgNO₃ titrlash (ichki/tashqi Cl) + XRD (purpureo/luteo) + EA (N, H) + UV-Vis (d-d)</strong> — beshta metod birgalikda [Co(NH₃)₅Cl]Cl₂ ni to'liq tasdiqlaydi va ichki/tashqi sferani farqlaydi.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-red-900/20 to-purple-900/40 border border-red-700/30 rounded-2xl p-6">
          <h2 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
            <span>💡</span> ICP ning [Co(NH₃)₅Cl]Cl₂ uchun cheklovlari
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
            <div className="space-y-3 text-purple-200">
              <p className="leading-relaxed">
                ICP [Co(NH₃)₅Cl]Cl₂ ni tahlil qilishda kuchli, lekin quyidagi cheklovlarga ega:
              </p>
              <ul className="list-disc list-inside space-y-2 marker:text-red-500 text-xs">
                <li><strong className="text-red-300">Ichki/tashqi sferani farqlay olmaydi</strong> — AgNO₃ titrlash kerak</li>
                <li><strong className="text-red-300">Faqat Co ni o'lchaydi</strong> — N, H, Cl uchun EA/IC kerak</li>
                <li><strong className="text-red-300">Yuqori tuz konsentratsiyasi</strong> — suyuqlantirish kerak</li>
              ...
              <p className="text-xs text-red-200 italic mt-2">
                Shuning uchun <strong>[Co(NH₃)₅Cl]Cl₂ ni to'liq tasdiqlash</strong> uchun kamida 5 ta metodni birlashtirish kerak.
              </p>
            </div>
            ...
            <div className="bg-purple-950/50 rounded-xl p-5 border border-purple-700/30">
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-purple-300">2. AgNO₃ titrlash</span>
                  <span className="text-pink-400 font-mono">2 ta Cl⁻ cho'kadi</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-purple-300">3. XRD (purpureo)</span>
                  <span className="text-pink-400 font-mono">kristall struktura</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-purple-300">4. EA (N, H)</span>
                  <span className="text-pink-400 font-mono">26.23%, 5.69%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-purple-300">5. UV-Vis (d-d)</span>
                  <span className="text-pink-400 font-mono">binafsha rang</span>
                </div>
              </div>
              <div className="mt-4 p-2 bg-green-900/20 rounded border border-green-700/30 text-green-200 text-[10px]">
                ✓ 5 ta metod birgalikda [Co(NH₃)₅Cl]Cl₂ ni to'liq tasdiqlaydi va ichki/tashqi sferani farqlaydi
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-900/30 via-indigo-900/30 to-purple-900/30 border border-green-700/30 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div className="bg-green-950/30 p-4 rounded-lg border border-green-700/30">
              ...
              <p className="text-xs text-purple-200"><strong className="text-pink-300">Co ni</strong> ppb darajasida o'lchaydi. ⁵⁹Co 100% mononuklid — ideal signal. Inert kompleks tufayli tayyorlash oson.</p>
            </div>
            <div className="bg-yellow-950/30 p-4 rounded-lg border border-yellow-700/30">
              ...
              <p className="text-xs text-purple-200"><strong className="text-pink-300">Ichki/tashqi sferani farqlay olmaydi!</strong> AgNO₃ titrlash kerak. N, H, Cl ko'rinmaydi.</p>
            </div>
            <div className="bg-blue-950/30 p-4 rounded-lg border border-blue-700/30">
              ...
              <p className="text-xs text-purple-200">AgNO₃ titrlash (ichki/tashqi Cl), XRD (purpureo/luteo), EA (N, H), UV-Vis (d-d) — Werner nazariyasini isbotlash.</p>
            </div>
          </div>
      ...
      <footer className="border-t border-purple-800/30 py-6 mt-6">
        <div className="max-w-6xl mx-auto px-4 text-center text-xs text-purple-500">
          <p>© 2026 Koordinatsion kimyo tahlil portali • [Co(NH₃)₅Cl]Cl₂ • ICP moduli</p>
