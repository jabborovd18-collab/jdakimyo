...
// ═══════════════════════════════════════════════════════════════════════════════
// K₄[Fe(CN)₆]·3H₂O — ICP-OES / ICP-MS MAHSUS SAHIFASI
// Manbalar: Vogel's Quantitative Chemical Analysis, NIST Isotope Data
// Xususiyat: Ko'p elementli (Fe²⁺ + K⁺), ArO⁺ interferensiyasi
// O'ziga xoslik: Collision Cell (He KED), Ichki standart (Sc, Ge)
...
const COMPOUND = {
  ...
  stability: "havoda barqaror, yorug'likda sekin oksidlanadi, suvda yaxshi eriydi",
  
  historicalFact: {
    title: "Sariq qon tuzi — Berlin ko'kining onasi",
    text: "K₄[Fe(CN)₆]·3H₂O — tarixiy jihatdan eng muhim kompleks birikmalardan biri. 1752-yilda Pierre Macquer uni birinchi marta ilmiy jihatdan tavsifladi. 1704-yilda Diesbach tasodifan Berlin ko'ki (Prussian Blue, Fe₄[Fe(CN)₆]₃) ni kashf etganida, bu kashfiyotning asosiy prekursori aynan sariq qon tuzi edi. Qiziq tarixiy fakt: nomi 'qon tuzi' — birinchi sintezida hayvon qoni, potash va temir ishlatilganidan kelib chiqqan. Bugungi kunda bu birikma oziq-ovqat qo'shimchasi (E536) sifatida yiliga 50,000 tonnadan ortiq ishlab chiqariladi. ICP tahlilida bu birikma alohida qiziq: ikkita metall (Fe va K) bir vaqtda o'lchanadi, lekin ⁴⁰Ar¹⁶O⁺ poliatomik interferensiyasi Fe tahlilini qiyinlashtiradi — He collision cell majburiy!",
    year: "1752-yil"
  },

  // ICP ning o'ziga xos xususiyati — ArO⁺ interferensiyasi
  uniqueICPFeature: {
    title: "K₄[Fe(CN)₆]·3H₂O — ArO⁺ interferensiyasining klassik namunasi",
    description: "Bu birikma ICP-MS tahlilida eng keng tarqalgan muammo — poliatomik interferensiyaning klassik namunasidir.",
    problem: {
      title: "⁴⁰Ar¹⁶O⁺ → m/z = 56",
      description: "Argon plazmasida Ar⁺ va O atomlari birlashib, ⁴⁰Ar¹⁶O⁺ poliatomik ionini hosil qiladi. Bu ionning mass/zaryad nisbati (m/z = 56) Fe ning eng ko'p tarqalgan izotopi ⁵⁶Fe (91.7% tabiiy) bilan bir xil!",
      impact: "Soxta signal — Fe miqdori haqiqatdan 2-10× yuqori ko'rinadi"
    },
    solution: {
      title: "He Collision Cell (KED rejimi)",
      description: "Collision cell ichiga He gazi kiritiladi. ArO⁺ kabi katta poliatomik ionlar He atomlari bilan to'qnashganda kinetik energiyasini yo'qotadi va mass analizatorga yetib bormaydi. Fe⁺ kabi kichik monoatomik ionlar esa to'siqdan o'tadi.",
      mechanism: "KED — Kinetic Energy Discrimination. Katta ionlar sekinlashadi → diskriminatsiya → faqat Fe⁺ detektlanadi."
    }
  },

  // ICP-OES va ICP-MS parametrlari
  icpOES: {
  ...
  theoretical: {
    Fe:  { mass: 55.845,  percent: 13.223, source: "Markaziy Fe²⁺ atomi", icpSignal: "ICP-OES 238.2 nm / ICP-MS m/z=56" },
    K:   { mass: 156.392, percent: 37.025, source: "4×K⁺ (tashqi sfera)", icpSignal: "ICP-OES 766.5 nm / ICP-MS m/z=39" },
    C:   { mass: 72.066,  percent: 17.064, source: "6×CN⁻ (6×C)", icpSignal: "ICP da ko'rinmaydi (EA kerak)" },
    N:   { mass: 84.042,  percent: 19.898, source: "6×CN⁻ (6×N)", icpSignal: "ICP da ko'rinmaydi (EA kerak)" },
    O:   { mass: 47.997,  percent: 11.363, source: "3×H₂O (3×O)", icpSignal: "ICP da ko'rinmaydi (EA kerak)" },
    H:   { mass: 6.048,   percent: 1.432,  source: "3×H₂O (6×H)", icpSignal: "ICP da ko'rinmaydi (EA kerak)" }
  },
  ...
  // TUZATILDI: standardards → standards
  internalStandards: {
  ...
  experimentalRuns_Fe: [
    { id: "ICP-24-001", date: "2025-05-10", mode: "Standard (He KED yo'q)", conc_mgL: 185.0, intensity: 925000, percent: 43.82, rsd: 8.5, note: "⚠ ArO⁺ interferensiyasi — Fe 3.3× ortiqcha!" },
    { id: "ICP-24-002", date: "2025-05-10", mode: "He KED rejimi", conc_mgL: 55.8, intensity: 279000, percent: 13.23, rsd: 1.2, note: "✓ To'g'ri natija — KED bilan ArO⁺ bartaraf etildi" },
    { id: "ICP-24-003", date: "2025-05-10", mode: "He KED rejimi", conc_mgL: 55.7, intensity: 278500, percent: 13.21, rsd: 1.3, note: "Ikkinchi parallel (KED)" },
    { id: "ICP-24-004", date: "2025-05-10", mode: "He KED rejimi", conc_mgL: 55.9, intensity: 279500, percent: 13.26, rsd: 1.1, note: "Uchinchi parallel (KED)" },
    { id: "ICP-24-005", date: "2025-05-10", mode: "He KED rejimi", conc_mgL: 55.6, intensity: 278000, percent: 13.19, rsd: 1.4, note: "To'rtinchi parallel (KED)" },
    { id: "ICP-24-006", date: "2025-05-11", mode: "H₂ reaktiv rejim", conc_mgL: 56.0, intensity: 280000, percent: 13.28, rsd: 1.5, note: "H₂ rejimi ham ishlaydi (ArO⁺ + H₂ → Ar + H₂O)" },
    { id: "BLANK-01",   date: "2025-05-10", mode: "He KED", conc_mgL: 0.1, intensity: 500, percent: 0.02, rsd: 0.0, note: "Blank (2% HNO₃)" },
  ...
  experimentalRuns_K: [
    { id: "ICP-24-101", date: "2025-05-10", mode: "Standard", conc_mgL: 156.2, intensity: 125000, percent: 37.00, rsd: 1.8, note: "K tahlili (standart rejim — interferensiya yo'q)" },
    { id: "ICP-24-102", date: "2025-05-10", mode: "Standard", conc_mgL: 156.5, intensity: 125240, percent: 37.07, rsd: 1.9, note: "Ikkinchi parallel" },
    { id: "ICP-24-103", date: "2025-05-10", mode: "Standard", conc_mgL: 155.9, intensity: 124720, percent: 36.93, rsd: 1.7, note: "Uchinchi parallel" },
    { id: "ICP-24-104", date: "2025-05-10", mode: "Standard", conc_mgL: 156.3, intensity: 125040, percent: 37.02, rsd: 1.8, note: "To'rtinchi parallel" },
    { id: "ICP-24-105", date: "2025-05-10", mode: "Standard", conc_mgL: 156.0, intensity: 124800, percent: 36.95, rsd: 1.8, note: "Beshinchi parallel" },
    { id: "BLANK-02",   date: "2025-05-10", mode: "Standard", conc_mgL: 0.5, intensity: 400, percent: 0.12, rsd: 0.0, note: "Blank" },
  ...
  samplePrepSteps: [
    { step: 1, title: "Namuna tortish", desc: "Analitik tarozida 50.0 ± 0.1 mg K₄[Fe(CN)₆]·3H₂O tortiladi. Oq-sariq kristallar — Fe²⁺ belgisi.", time: "2 daq", critical: true },
    ...
    { step: 3, title: "Hajmni to'ldirish", desc: "2% HNO₃ bilan 100 mL gacha to'ldiriladi. Konsentratsiya: ~500 mg/L K₄[Fe(CN)₆] ≈ 66 mg/L Fe, 185 mg/L K.", time: "1 daq", critical: false },
    ...
    { step: 8, title: "Natijalarni hisoblash", desc: "%Fe va %K alohida hisoblanadi. Ichki standart orqali drift tuzatiladi. Jami: ~50.25% (nazariy: 50.25%).", time: "1 daq", critical: false }
  ],

  matrixEffects: {
    title: "Matritsa effekti — yuqori tuz konsentratsiyasi muammosi",
    description: "K₄[Fe(CN)₆]·3H₂O yuqori K konsentratsiyasiga ega (37% K, ~185 mg/L). Bu ICP uchun matritsa effekti yaratadi.",
    problems: [
      {
  ...
  aasComparison: {
    title: "ICP vs AAS — K₄[Fe(CN)₆]·3H₂O uchun",
    comparison: [
  ...
  relatedMethods: [
    {
      ...
      role: "C (17.06%), H (1.43%), N (19.90%) — organik qismni tasdiqlaydi",
...
export default function K4FeCN6Page() {
  ...
  const [customConc_K, setCustomConc_K] = useState(156.2)
    ...
    <main className="min-h-screen bg-gradient-to-b from-purple-950 via-cyan-950/20 to-blue-950 text-white">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4">
          <div className="bg-gradient-to-br from-orange-950 to-red-950 border-2 border-orange-500 rounded-2xl p-6 max-w-2xl w-full">
            <h3 className="text-xl font-bold text-orange-400 mb-4 flex items-center gap-2">
              <span className="text-3xl">⚠️</span> ArO⁺ Interferensiyasi — ICP-MS ning klassik muammosi
            </h3>
            <p className="text-purple-200 text-sm mb-4">
              K₄[Fe(CN)₆]·3H₂O tahlilida eng katta muammo — <strong className="text-orange-300">⁴⁰Ar¹⁶O⁺ poliatomik interferensiyasi</strong>.
            </p>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <div className="space-y-1 text-purple-200">
                    <div>⁴⁰Ar⁺ + ¹⁶O → <strong className="text-orange-300">⁴⁰Ar¹⁶O⁺</strong></div>
                    <div>m/z = 40 + 16 = <strong className="text-orange-300">56</strong></div>
                    <div>⁵⁶Fe ning m/z = <strong className="text-orange-300">56</strong></div>
                    <div className="text-red-400 font-bold">→ Soxta signal!</div>
                  </div>
                </div>
                <div>
                  <div className="text-green-400 font-bold mb-2">Yechim (He KED):</div>
                  <div className="space-y-1 text-purple-200">
                    <div>Collision cell ga <strong className="text-green-300">He gazi</strong> kiritiladi</div>
                    <div>Katta ArO⁺ ionlari <strong className="text-green-300">sekinlashadi</strong></div>
                    <div>Kichik Fe⁺ ionlari <strong className="text-green-300">o'tadi</strong></div>
            ...
            <div className="bg-red-900/20 rounded-lg p-3 mb-4">
              <p className="text-xs text-purple-200">
                <strong className="text-orange-300">Ta'sir:</strong> He KED ishlatmasangiz, Fe miqdori <strong>2-10× ortiqcha</strong> ko'rinadi! 
                ICP-24-001 natijasini ko'ring: 43.82% Fe (haqiqat: 13.23%).
              </p>
            </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-purple-200">
            <div className="space-y-3">
              <p className="leading-relaxed">
                <strong className="text-white">K₄[Fe(CN)₆]·3H₂O</strong> — temir(II) ning geksatsianoferrat kompleksi, klassik koordinatsion birikma. ICP tahlilida <strong className="text-yellow-300">alohida o'ringa ega</strong>, chunki:
              </p>
              <ul className="list-disc list-inside space-y-2 marker:text-yellow-500 text-xs md:text-sm">
                ...
                <li>ICP <strong className="text-orange-300">Fe²⁺ va Fe³⁺ ni farqlay olmaydi</strong> — UV-Vis kerak</li>
                <li>C, N, H, O <strong className="text-white">ICP da ko'rinmaydi</strong> — EA kerak</li>
        ...
        <div className="bg-gradient-to-r from-orange-900/40 to-red-900/40 border-2 border-orange-700/70 rounded-2xl p-6">
            ...
            <div className="bg-green-950/40 rounded-xl p-5 border-2 border-green-500/50">
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="bg-green-900/30 rounded p-2">
                  <div className="text-green-300 font-bold">KED:</div>
          ...
          <button
            ...
            className="w-full bg-orange-600 hover:bg-orange-500 text-white py-3 rounded-lg transition-colors text-sm font-bold"
          >
            📖 ArO⁺ interferensiyasi haqida batafsil →
          </button>
        </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-sm text-purple-200 mb-5 leading-relaxed">
            ICP-OES — atom emissiya spektroskopiya. Har bir element <strong className="text-yellow-300">o'ziga xos to'lqin uzunligida</strong> nurlanadi. Fe va K ni bir vaqtda o'lchash mumkin.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="bg-yellow-950/40 rounded-xl p-4 border border-yellow-700/30">
              <h4 className="text-yellow-400 font-bold text-sm mb-3">Fe (Temir) parametrlari:</h4>
              <div className="space-y-2 text-xs">
                <div className="flex justify-between bg-purple-950/60 rounded p-2">
                  <span className="text-purple-400">λ (asosiy):</span>
                  <span className="font-mono text-yellow-400 font-bold">{COMPOUND.icpOES.parameters.Fe.lambda_primary}</span>
                </div>
                <div className="flex justify-between bg-purple-950/60 rounded p-2">
                  <span className="text-purple-400">λ (alternativ):</span>
                  <span className="font-mono text-yellow-400">{COMPOUND.icpOES.parameters.Fe.lambda_secondary}</span>
                </div>
                <div className="flex justify-between bg-purple-950/60 rounded p-2">
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="bg-yellow-950/40 rounded-xl p-4 border-2 border-yellow-500/50">
              <h4 className="text-yellow-400 font-bold text-sm mb-3">Fe (Temir) — He KED rejimi:</h4>
              <div className="space-y-2 text-xs">
                <div className="flex justify-between bg-purple-950/60 rounded p-2">
                  <span className="text-purple-400">m/z (asosiy):</span>
                  <span className="font-mono text-yellow-400 font-bold">{COMPOUND.icpMS.parameters.Fe.mz_primary}</span>
                </div>
                <div className="flex justify-between bg-purple-950/60 rounded p-2">
                  <span className="text-purple-400">Asosiy izotop:</span>
                  <span className="font-mono text-yellow-400">{COMPOUND.icpMS.parameters.Fe.isotope_primary}</span>
                </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-4">
            ICP <strong className="text-yellow-300">faqat Fe va K</strong> ni o'lchaydi. C, N, H, O ICP da ko'rinmaydi — ularni EA bilan tekshirish kerak.
          </p>
              ...
              <tbody className="text-purple-200">
                {Object.entries(COMPOUND.theoretical).map(([el, d]) => (
                  <tr key={el} className={`border-b border-purple-800/30 hover:bg-purple-800/20 transition-colors ${
                    ...
                    <td className={`py-3 pl-2 font-bold ${el === "Fe" ? "text-yellow-400" : el === "K" ? "text-orange-400" : "text-purple-400"}`}>{el}</td>
                ...
                <tr className="bg-yellow-900/20 font-bold border-t border-yellow-500/30">
                  ...
                  <td colSpan={2} className="py-3 text-[10px] text-yellow-300">ICP: Fe (13.22%) + K (37.03%) = 50.25%</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${
                  activeMetal === "Fe" ? "bg-yellow-600 text-white" : "bg-purple-900/50 text-purple-300"
                }`}
              >
                Fe izotoplari
              </button>
          ...
          <div className="mt-3 p-3 bg-orange-900/20 rounded-lg border border-orange-700/30">
            <p className="text-xs text-purple-200">
              <strong className={activeMetal === "Fe" ? "text-yellow-300" : "text-orange-300"}>📝 {
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-sm text-purple-200 mb-4 leading-relaxed">
            {activeMetal === "Fe" ? "Fe" : "K"} standartlari (2% HNO₃ + ichki standart) yordamida kalibrlash egri chizig'i qurilgan. <strong className={activeMetal === "Fe" ? "text-yellow-300" : "text-orange-300"}>R² = 0.9999</strong> — deyarli mukammal chiziqli bog'liqliq.
          </p>
          ...
          <div className="bg-purple-950/40 p-4 rounded-xl border border-purple-700/30 relative h-72">
            <svg viewBox="0 0 600 260" className="w-full h-full overflow-visible">
              ...
              {(activeMetal === "Fe" ? COMPOUND.calibrationCurve_Fe : COMPOUND.calibrationCurve_K).map((p, i) => {
                ...
                return (
                  <g key={i}>
                    <circle cx={x} cy={y} r="5" fill={activeMetal === "Fe" ? "#eab308" : "#f97316"} stroke="#fff" strokeWidth="1" />
                    {i > 0 && (
                      <text x={x} y={y-10} textAnchor="middle" fontSize="8" fill={activeMetal === "Fe" ? "#fde047" : "#fb923c"}>
                ...
                return (
                  <g>
                    ...
                    <text x={x+10} y={y-5} fontSize="9" fill="#22c55e" fontWeight="bold">
                      Namuna ({activeMetal === "Fe" ? "55.8 μg/L" : "156.2 mg/L"})
                    </text>
                  </g>
                )
              })()}

              <rect x="450" y="30" width="120" height="30" rx="4" fill="#1e1b4b" stroke={activeMetal === "Fe" ? "#eab308" : "#f97316"} strokeWidth="1" />
              <text x="510" y="48" textAnchor="middle" fontSize="10" fill={activeMetal === "Fe" ? "#fde047" : "#fb923c"} fontWeight="bold">
                R² = 0.9999
              </text>
            </svg>
          </div>
          ...
          <div className="mt-3 flex flex-wrap gap-3 text-[10px] text-purple-400">
            <span className="flex items-center gap-1"><span className={`w-3 h-3 rounded-full ${activeMetal === "Fe" ? "bg-yellow-500" : "bg-orange-500"}`}></span> Standart nuqta</span>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-6">
            Fe va K <strong className="text-yellow-300">alohida</strong> o'lchanadi. Fe uchun <strong className="text-red-300">He KED rejimi</strong> majburiy (ArO⁺ muammosi tufayli). K uchun standart rejim yetarli.
          </p>

          {/* Fe natijalari */}
          <div className="mb-8">
            <h3 className="text-md font-bold text-yellow-400 mb-4 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 bg-purple-950/30 rounded-xl p-6 border border-purple-700/30 flex flex-col">
                <h3 className="text-sm font-bold text-yellow-400 mb-4 flex justify-between">
                  ...
                  <span className="text-[10px] text-purple-500 font-normal">Nazariy: 13.22%</span>
                </h3>
                    ...
                    return (
                      <div key={r.id} className="flex flex-col items-center flex-1 group cursor-pointer" onClick={() => setActiveRun_Fe(r.id)}>
                        ...
                        <div className="w-full max-w-[40px] relative flex items-end justify-center h-[160px]">
                          <div className="absolute w-[120%] border-t border-dashed border-yellow-400/50 z-0" style={{ bottom: `${(13.223/50)*100}%` }}></div>
                        ...
                        <div className={`mt-3 text-[9px] font-mono text-center truncate w-full px-1 ${isActive ? (isBad ? 'text-red-400' : 'text-yellow-400') : 'text-purple-600'} font-bold`}>
                          {r.id.split('-').pop()}
                        </div>
                      </div>
                    )
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 bg-purple-950/30 rounded-xl p-6 border border-purple-700/30 flex flex-col">
                <h3 className="text-sm font-bold text-orange-400 mb-4 flex justify-between">
                  ...
                  <span className="text-[10px] text-purple-500 font-normal">Nazariy: 37.03%</span>
                </h3>
                  ...
                  {COMPOUND.experimentalRuns_K.map((r) => {
                    ...
                    return (
                      <div key={r.id} className="flex flex-col items-center flex-1 group cursor-pointer" onClick={() => setActiveRun_K(r.id)}>
                        ...
                        <div className="w-full max-w-[40px] relative flex items-end justify-center h-[160px]">
                          <div className="absolute w-[120%] border-t border-dashed border-orange-400/50 z-0" style={{ bottom: `${(37.025/40)*100}%` }}></div>
        ...
        {showCalibrationModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4" onClick={() => setShowCalibrationModal(false)}>
            <div className="bg-purple-950 border border-purple-700 rounded-2xl p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
              ...
              <h4 className="text-yellow-400 font-bold text-sm mb-2">Fe (ICP-MS, He KED):</h4>
              ...
              <div className="mt-4 p-3 bg-yellow-900/20 rounded-lg border border-yellow-700/30 text-xs text-purple-200">
                <strong className="text-yellow-300">Fe regressiyasi:</strong> I = 5020 × C + 0, R² = 0.9999 (He KED bilan)
              </div>
        ...
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-5">
            K₄[Fe(CN)₆]·3H₂O uchun <strong className="text-yellow-300">2% HNO₃</strong> ishlatiladi. Ichki standart (Sc, Ge) har bir namunaga qo'shiladi.
          </p>
        ...
        <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-5">
            Ikkala metall uchun alohida konsentratsiya kiriting — <strong className="text-yellow-300">%Fe</strong> va <strong className="text-orange-300">%K</strong> avtomatik hisoblanadi.
          </p>
          ...
          <div className="bg-purple-950/50 rounded-lg p-5 border border-purple-700/30">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                ...
                <div className="text-xl font-mono font-bold text-yellow-400">{calcResult_Fe.Fe_mass}</div>
              </div>
              <div>
                <div className="text-xs text-purple-400">%Fe:</div>
                <div className={`text-xl font-mono font-bold ${Math.abs(calcResult_Fe.Fe_percent - 13.22) <= 0.5 ? 'text-green-400' : 'text-red-400'}`}>
              ...
              <div>
                ...
                <div className={`text-xl font-mono font-bold ${Math.abs(calcResult_K.K_percent - 37.03) <= 0.5 ? 'text-green-400' : 'text-red-400'}`}>
            ...
            <div className="mt-4 p-3 bg-green-900/20 rounded border border-green-700/30">
              <div className="text-xs text-green-300">
                <strong>Jami (Fe + K):</strong> {(calcResult_Fe.Fe_percent + calcResult_K.K_percent).toFixed(2)}% (nazariy: 50.25%)
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-yellow-900/40 to-purple-900/40 border border-yellow-700/50 rounded-2xl p-6">
          ...
          <p className="text-xs text-purple-300 mb-5">
            K₄[Fe(CN)₆]·3H₂O uchun ICP ni qo'shimcha usullar bilan birgalikda ishlatish — <strong className="text-yellow-300">to'liq formula validatsiyasi</strong> uchun muhim. <strong className="text-amber-300">EA</strong> va <strong className="text-purple-300">Mössbauer</strong> eng kuchli qo'shimcha metodlar.
          </p>
          ...
          <div className="mt-5 bg-yellow-900/20 border border-yellow-700/30 rounded-xl p-4">
            <h4 className="text-sm font-bold text-yellow-300 mb-2">💡 To'liq formula validatsiyasi uchun eng yaxshi kombinatsiya:</h4>
            <p className="text-xs text-purple-200 leading-relaxed">
              <strong className="text-white">ICP-OES/MS (Fe, K) + EA (C, H, N) + Mössbauer (Fe²⁺) + UV-Vis (420 nm) + IQ (CN⁻ 2040-2120 cm⁻¹)</strong> — beshta metod birgalikda K₄[Fe(CN)₆]·3H₂O ni to'liq tasdiqlaydi va uning sofligini nazorat qiladi.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-red-900/20 to-purple-900/40 border border-red-700/30 rounded-2xl p-6">
          <h2 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
            <span>💡</span> ICP ning K₄[Fe(CN)₆]·3H₂O uchun cheklovlari
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
            <div className="space-y-3 text-purple-200">
              <p className="leading-relaxed">
                ICP K₄[Fe(CN)₆]·3H₂O ni tahlil qilishda kuchli, lekin quyidagi cheklovlarga ega:
              </p>
              <ul className="list-disc list-inside space-y-2 marker:text-red-500 text-xs">
                ...
                <li><strong className="text-red-300">Faqat Fe va K ni o'lchaydi</strong> — C, N, H, O uchun EA kerak</li>
              ...
              <p className="text-xs text-red-200 italic mt-2">
                Shuning uchun <strong>K₄[Fe(CN)₆]·3H₂O ni to'liq tasdiqlash</strong> uchun kamida 5 ta metodni birlashtirish kerak.
              </p>
            </div>
            ...
            <div className="bg-purple-950/50 rounded-xl p-5 border border-purple-700/30">
              ...
              <div className="space-y-2 text-xs">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-yellow-400 font-mono">13.22%, 37.03%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-purple-300">2. EA (C, H, N)</span>
                  <span className="text-yellow-400 font-mono">17.06%, 1.43%, 19.90%</span>
                </div>
                <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-yellow-400 font-mono">2040-2120 cm⁻¹</span>
                </div>
              </div>
              <div className="mt-4 p-2 bg-green-900/20 rounded border border-green-700/30 text-green-200 text-[10px]">
                ✓ 5 ta metod birgalikda K₄[Fe(CN)₆]·3H₂O ni to'liq tasdiqlaydi
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-900/30 via-indigo-900/30 to-purple-900/30 border border-green-700/30 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div className="bg-green-950/30 p-4 rounded-lg border border-green-700/30">
              ...
              <p className="text-xs text-purple-200"><strong className="text-yellow-300">Ikkala metalni ham</strong> bir vaqtda o'lchaydi (Fe va K). ppb darajasida sezgirlik. Izotop profili ko'rinadi.</p>
            </div>
            <div className="bg-yellow-950/30 p-4 rounded-lg border border-yellow-700/30">
              ...
              <p className="text-xs text-purple-200"><strong className="text-red-300">⁴⁰Ar¹⁶O⁺ interferensiyasi!</strong> He KED majburiy. Fe²⁺/Fe³⁺ farqlanmaydi. C, N, H, O ko'rinmaydi.</p>
            </div>
            <div className="bg-blue-950/30 p-4 rounded-lg border border-blue-700/30">
              ...
              <p className="text-xs text-purple-200">EA (C, H, N), Mössbauer (Fe²⁺), UV-Vis (420 nm), IQ (CN⁻) — to'liq formula validatsiyasi uchun.</p>
            </div>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-purple-700/30 flex flex-col md:flex-row justify-between gap-3">
            ...
            <Link href="/ilmiy/tahlil/icp/birikmalar" className="text-sm bg-cyan-600 hover:bg-cyan-500 px-4 py-2 rounded-lg text-white transition-colors text-center">
      ...
      <footer className="border-t border-purple-800/30 py-6 mt-6">
        <div className="max-w-6xl mx-auto px-4 text-center text-xs text-purple-500">
          <p>© 2026 Koordinatsion kimyo tahlil portali • K₄[Fe(CN)₆]·3H₂O • ICP moduli</p>
          <p className="mt-1">Manbalar: Vogel's Quantitative Chemical Analysis, IUPAC, NIST Isotope Data, Macquer (1752)</p>
        </div>
      </footer>
    </main>
  )
