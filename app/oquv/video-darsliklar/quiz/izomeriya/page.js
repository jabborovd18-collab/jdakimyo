// app/oquv/video-darsliklar/quiz/izomeriya/page.js
"use client"
    ...
    return (
      <main className="min-h-screen bg-gradient-to-b from-purple-950 via-blue-950/20 to-slate-950 flex items-center justify-center p-4">
        <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-8 max-w-2xl w-full text-center">
          <h1 className="text-4xl font-bold text-purple-300 mb-6">Izomeriya Quiz</h1>
          ...
          <div className="bg-purple-950/50 rounded-xl p-6 mb-8 text-left">
            ...
            <ul className="space-y-3 text-purple-200">
              <li className="flex items-start">
                ...
                <span>Strukturaviy izomeriya (ionlanish, gidrat, linkage, koordinatsion)</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-400 mr-2">✓</span>
                <span>Geometrik izomeriya (cis/trans, fac/mer)</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-400 mr-2">✓</span>
                <span>Optik izomeriya (enantiomerlar, Δ/Λ)</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-400 mr-2">✓</span>
                <span>Izomerlar sonini hisoblash</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-400 mr-2">✓</span>
                <span>Izomerni aniqlash</span>
              </li>
            </ul>
          </div>
          <button
