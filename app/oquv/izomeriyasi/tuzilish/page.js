...
export default function TuzilishIzomeriyasi() {
  const turlar = [
    ...
    },
    {
      ...
      desc: "Ligand izomeriyasi — orto, meta, para diaminobenzol",
      badge: "Kam uchraydigan",
      badgeColor: "bg-amber-600/20 text-amber-400 border-amber-600/30",
      has3D: true,
      gradient: "from-amber-600/20 to-amber-900/40",
      borderColor: "border-amber-500/30",
      examples: "Ligandning o'rinbosar guruhlari har xil joylashadi"
    },
    {
      href: "/oquv/izomeriyasi/tuzilish/konformatsion",
      icon: "🌀",
      title: "Konformatsion izomeriyasi",
      desc: "Etilendiamin xelat halqasining δ va λ konformatsiyalari",
      badge: "Kam uchraydigan",
      badgeColor: "bg-amber-600/20 text-amber-400 border-amber-600/30",
      has3D: true,
      gradient: "from-pink-600/20 to-pink-900/40",
      borderColor: "border-pink-500/30",
      examples: "Ligand konformatsiyasi farqi (aylanish izomeriyasi)"
    },
    {
      href: "/oquv/izomeriyasi/tuzilish/holat",
      icon: "🎯",
      title: "Holat izomeriyasi",
      desc: "Yuqori va quyi spinli Fe²⁺ komplekslari",
      badge: "Kam uchraydigan",
      badgeColor: "bg-amber-600/20 text-amber-400 border-amber-600/30",
      has3D: true,
      gradient: "from-cyan-600/20 to-cyan-900/40",
      borderColor: "border-cyan-500/30",
      examples: "Spin holati yoki oksidlanish darajasi farqi"
    },
    {
      href: "/oquv/izomeriyasi/tuzilish/elektron",
      icon: "⚛️",
      title: "Elektron izomeriyasi",
      desc: "Co³⁺-NO₂⁻ va Co²⁺-NO₂ holatlari",
      badge: "Kam uchraydigan",
      badgeColor: "bg-amber-600/20 text-amber-400 border-amber-600/30",
      has3D: true,
      gradient: "from-emerald-600/20 to-emerald-900/40",
      borderColor: "border-emerald-500/30",
      examples: "Redoks izomeriya — elektron taqsimlanishi farqi"
    },
    {
      href: "/oquv/izomeriyasi/tuzilish/transformatsion",
      icon: "✨",
      title: "Transformatsion izomeriyasi",
      desc: "Nitrito → Nitro qayta tuzilishi",
      badge: "Kam uchraydigan",
      badgeColor: "bg-amber-600/20 text-amber-400 border-amber-600/30",
      has3D: true,
      gradient: "from-orange-600/20 to-orange-900/40",
      borderColor: "border-orange-500/30",
      examples: "Yorug'lik ta'sirida ligand shakli o'zgaradi"
    },
    {
      href: "/oquv/izomeriyasi/tuzilish/formal",
      icon: "📋",
      title: "Formal izomeriyasi",
      desc: "Umumiy tushuncha — har xil kimyoviy bog'lanish strukturasi",
      badge: "Kam uchraydigan",
      badgeColor: "bg-amber-600/20 text-amber-400 border-amber-600/30",
      has3D: true,
      gradient: "from-indigo-600/20 to-indigo-900/40",
      borderColor: "border-indigo-500/30",
      examples: "Bir xil tarkibli, lekin har xil strukturali moddalar"
    },
  ]
  return (
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-3 gap-4 max-w-2xl">
              ...
              <div className="bg-purple-950/50 border border-purple-700/30 rounded-xl p-4 text-center">
                ...
                <div className="text-xs text-purple-400 mt-1">Kam uchraydigan</div>
              </div>
              <div className="bg-purple-950/50 border border-purple-700/30 rounded-xl p-4 text-center">
                <div className="text-3xl mb-2">🧬</div>
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2 flex-wrap">
                        <span className="text-xs text-purple-500 font-bold">{String(i+1).padStart(2, '0')}</span>
        ...
        <div className="bg-gradient-to-r from-yellow-600/20 via-orange-600/20 to-red-600/20 border border-yellow-500/30 rounded-3xl p-8 md:p-10 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-purple-200 mb-8 max-w-2xl mx-auto">
              Har bir tur batafsil tahlil, amaliy misollar va <strong>3D modellari</strong> bilan taqdim etilgan.
            </p>
          </div>
        </div>
        {/* NAVIGATION */}
