    ...
    <main className="min-h-screen bg-gradient-to-b from-purple-950 to-blue-950 text-white">
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="text-center">
          <Link href="/oquv/fazoviy/trigonal-bipiramida/3d" className="inline-flex items-center gap-4 bg-gradient-to-r from-orange-600 to-yellow-600 hover:from-orange-500 hover:to-yellow-500 text-white px-10 py-6 rounded-2xl text-xl font-bold transition-all transform hover:scale-105 shadow-2xl shadow-orange-600/30">
