// app/laboratoriya/3d/components/YordamModal.jsx
//
// [H] Boshqaruv va klaviatura qo'llanmasi modali. Jadval
// `lib/kirish-usuli.js` dagi ro'yxatdan yasaladi; sensorli qurilmada
// bajarib bo'lmaydigan amallar ochiq aytiladi.
//
// BRIF-05 (2-bosqich): `korinish.js` dan JSX AYNAN ko'chirildi.
// Ochish sharti (`yordamOchilgan && ...`) chaqiruvchida qoldi —
// asl xatti-harakat bilan bir xil.
...
export default function YordamModal({ setYordamOchilgan, sensorli, ISH }) {
  return (
        <div
