...
const YOLLAR = {
  ...
  yordam: (
    <>
      <circle cx="12" cy="12" r="9" />
      <path d="M9.5 9a2.6 2.6 0 1 1 4.2 2.1c-1 .7-1.7 1.2-1.7 2.7" />
      <path d="M12 17.5h.01" />
    </>
  ),
  formula: (
    <>
      ...
      <path d="m7 8 3 4-3 4M17 8l-3 4 3 4" />
      <path d="M11 12h2" />
    </>
  ),
  kuzatuv: (
  ...
  nizom: (
    <>
      <path d="M12 3v18M5 7h14M7 7l-3 6h6L7 7M17 7l-3 6h6l-3-6M7 21h10" />
    </>
  ),
  ustoz: (
    <>
